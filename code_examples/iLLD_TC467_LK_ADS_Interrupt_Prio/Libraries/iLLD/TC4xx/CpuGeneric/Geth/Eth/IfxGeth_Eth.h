 ...
 * \param geth GETH driver Handle
 * \return 64 bit cross time stamp Sync Ptp value
 */
 ...
 * \param geth GETH driver Handle
 * \return 64 bit cross time stamp Local Ptp value
 */
IFX_EXTERN uint64 IfxGeth_Eth_getCrossTimestampLocalPtp(IfxGeth_Eth *geth);

/** \brief Wrapper API for MDIO Clause45 single read
 * \param geth GETH driver Handle
 * \param config structure for initializing Cross Time Stamp
 * \return none
 */
 ...
 * \param geth GETH driver Handle
 * \param identifier S/w defined ID used to identify the corresponding cross timestamp snapshot using the XTIMESTAMP_STATUS.SW_TRIGID bit-field. Range: 1 to 15
 * \return none
 */
 ...
 * \param geth GETH driver Handle
 * \return 4 bit fill level (Range: 0 - Empty, 0xF - Full)
 */
IFX_EXTERN uint8 IfxGeth_Eth_getCrossTimeStampFillLevelStatus(IfxGeth_Eth *geth);

/** \brief Returns Cross TimeStamp Trigger Id Status
 * \param geth GETH driver Handle
 * \return 2 bit Trigger ID (0 : Software trigger via SW_TRIG bit-field, 1 : GETH0_P1_PPS0, 2 : PORTS_GETH0_P1_AUX[0], 3 : SCU_GETH0_P1_AUX[1])
 */
 ...
 * \param geth GETH driver Handle
 * \return When XTIMESTAMP_STATUS.TRIG_ID = 0, this bit-field shows the user-defined identifier of the corresponding snapshot due to Software trigger as defined by XTIMESTAMP_CTRL.SW_TRIGID. When XTIMESTAMP_STATUS.TL0=1, this bit-field shows the user-defined identifier of the corresponding Software trigger which is lost as defined by XTIMESTAMP_CTRL.SW_TRIGID.
 */
 ...
 * \param geth GETH driver Handle
 * \return This bit-field is set to 1 to indicate if the capture request from a trigger input 0 is lost due to FIFO full condition. Software write with 1 clears this bit-field.
 */
 ...
 * \param geth GETH driver Handle
 * \return This bit-field is set to 1 to indicate if the capture request from a trigger input 1 is lost due to FIFO full condition. Software write with 1 clears this bit-field.
 */
 ...
 * \param geth GETH driver Handle
 * \return This bit-field is set to 1 to indicate if the capture request from a trigger input 2 is lost due to FIFO full condition. Software write with 1 clears this bit-field.
 */
 ...
 * \param geth GETH driver Handle
 * \return This bit-field is set to 1 to indicate if the capture request from a trigger input 3 is lost due to FIFO full condition. Software write with 1 clears this bit-field.
 */
