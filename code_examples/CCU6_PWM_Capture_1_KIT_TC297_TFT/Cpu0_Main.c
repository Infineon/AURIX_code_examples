 ...
 *
 * \name CCU6_PWM_Capture_1_KIT_TC297_TFT
 * \version V1.0.0
 * \board APPLICATION KIT TC2X7 V1.1, KIT_AURIX_TC297_TFT_BC-Step, TC29xTA/TX_BC-step
 * \keywords AURIX, CCU6, CCU6_PWM_Capture_1, PWM, signal capture, timer
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_CCU6_PWM_Capture_1_KIT_TC297_TFT-TR-v01_00_00-EN.pdf
...
int core0_main(void)
{
    ...
    /* Initialization of the CCU6 module and the port pin used for PWM generation */
    init_CCU6_ICU();
    init_PWM_signal_generation();

    while(1)
    {
        generate_PWM_signal(); /* Toggle the port pin to generate a simple PWM signal */
    }
