 ...
 * \description QSPI1 is configured in master mode and used to send five bytes to QSPI2 configured in slave mode. The received data is read by the CPU and
 *              compared against the transmitted data. Port pin P22.7, to which an LED is connected, indicates the successful transfer.
 *
 * \name iLLD_TC497_LK_ADS_SPI_CPU
 * \version V1.0.0
 * \board AURIC TC497 lite Kit, KIT_A3G_TC497_LITE, TC497PP_A-Step_MS_STD
