...
#ifndef IFXGTM_CFG_TC49XN_H
#define IFXGTM_CFG_TC49XN_H 1
 ...
 */
#define IFXGTM_NUM_ATOM_OBJECTS         (10)

/** \brief Number of Cluster Configuration Modules
 */
#define IFXGTM_NUM_CCM_OBJECTS          (10)
...
/** \brief CLS0 FIFO Memory RAM Address
 */
#define GTM_CLS0_FIFO_MEMORY_RAM      ((void *)0xF4006000u)

/** \brief CLS0 FIFO Memory RAM size
 */
#define GTM_CLS0_FIFO_MEMORY_RAM_SIZE (0x1000u)

/** \brief CLS1 FIFO Memory RAM Address
 */
#define GTM_CLS1_FIFO_MEMORY_RAM      ((void *)0xF4026000u)

/** \brief CLS1 FIFO Memory RAM size
 */
#define GTM_CLS1_FIFO_MEMORY_RAM_SIZE (0x1000u)

/** \brief CLS0 DPLL RR2 RAM Address
 */
#define GTM_CLS0_DPLL_RR2_RAM ((void*)0xF400C000u)

/** \brief CLS0 DPLL RR2 RAM size
 */
#define GTM_CLS0_DPLL_RR2_RAM_SIZE (0x4000u)

/** \brief CLS0 MCS MEM0 RAM Address
*/
#define GTM_CLS0_MCS_MEM0_RAM ((void*)0xF4010000u)

/** \brief CLS0 MCS MEM0 RAM size
*/
#define GTM_CLS0_MCS_MEM0_RAM_SIZE (0x4000u)

/** \brief CLS0 MCS MEM1 RAM Address
*/
#define GTM_CLS0_MCS_MEM1_RAM ((void*)0xF4014000u)

/** \brief CLS0 MCS MEM1 RAM size
*/
#define GTM_CLS0_MCS_MEM1_RAM_SIZE (0x2000u)

/** \brief CLS1 MCS MEM0 RAM Address
*/
#define GTM_CLS1_MCS_MEM0_RAM ((void*)0xF4030000u)

/** \brief CLS1 MCS MEM0 RAM size
*/
#define GTM_CLS1_MCS_MEM0_RAM_SIZE (0x4000u)

/** \brief CLS1 MCS MEM1 RAM Address
*/
#define GTM_CLS1_MCS_MEM1_RAM ((void*)0xF4034000u)

/** \brief CLS1 MCS MEM1 RAM size
*/
#define GTM_CLS1_MCS_MEM1_RAM_SIZE (0x2000u)

/** \brief CLS2 MCS MEM0 RAM Address
*/
#define GTM_CLS2_MCS_MEM0_RAM ((void*)0xF4050000u)

/** \brief CLS2 MCS MEM0 RAM size
*/
#define GTM_CLS2_MCS_MEM0_RAM_SIZE (0x4000u)

/** \brief CLS2 MCS MEM1 RAM Address
*/
#define GTM_CLS2_MCS_MEM1_RAM ((void*)0xF4054000u)

/** \brief CLS2 MCS MEM1 RAM size
*/
#define GTM_CLS2_MCS_MEM1_RAM_SIZE (0x2000u)

/** \brief CLS3 MCS MEM0 RAM Address
*/
#define GTM_CLS3_MCS_MEM0_RAM ((void*)0xF4070000u)

/** \brief CLS3 MCS MEM0 RAM size
*/
#define GTM_CLS3_MCS_MEM0_RAM_SIZE (0x4000u)

/** \brief CLS3 MCS MEM1 RAM Address
*/
#define GTM_CLS3_MCS_MEM1_RAM ((void*)0xF4074000u)

/** \brief CLS3 MCS MEM1 RAM size
*/
#define GTM_CLS3_MCS_MEM1_RAM_SIZE (0x2000u)

/** \brief CLS4 MCS MEM0 RAM Address
*/
#define GTM_CLS4_MCS_MEM0_RAM ((void*)0xF4090000u)

/** \brief CLS4 MCS MEM0 RAM size
*/
#define GTM_CLS4_MCS_MEM0_RAM_SIZE (0x4000u)

/** \brief CLS4 MCS MEM1 RAM Address
*/
#define GTM_CLS4_MCS_MEM1_RAM ((void*)0xF4094000u)

/** \brief CLS4 MCS MEM1 RAM size
*/
#define GTM_CLS4_MCS_MEM1_RAM_SIZE (0x2000u)

/** \brief CLS5 MCS MEM0 RAM Address
*/
#define GTM_CLS5_MCS_MEM0_RAM ((void*)0xF40B0000u)

/** \brief CLS5 MCS MEM0 RAM size
*/
#define GTM_CLS5_MCS_MEM0_RAM_SIZE (0x4000u)

/** \brief CLS5 MCS MEM1 RAM Address
*/
#define GTM_CLS5_MCS_MEM1_RAM ((void*)0xF40B4000u)

/** \brief CLS5 MCS MEM1 RAM size
*/
#define GTM_CLS5_MCS_MEM1_RAM_SIZE (0x2000u)

/** \brief CLS6 MCS MEM0 RAM Address
*/
#define GTM_CLS6_MCS_MEM0_RAM ((void*)0xF40D0000u)

/** \brief CLS6 MCS MEM0 RAM size
*/
#define GTM_CLS6_MCS_MEM0_RAM_SIZE (0x4000u)

/** \brief CLS6 MCS MEM1 RAM Address
*/
#define GTM_CLS6_MCS_MEM1_RAM ((void*)0xF40D4000u)

/** \brief CLS6 MCS MEM1 RAM size
*/
#define GTM_CLS6_MCS_MEM1_RAM_SIZE (0x2000u)
...
#define IFXGTM_CFG_ADCSEL20to21_NUMVALUES (8)
...
#define IFXGTM_CFG_NUMADCTRIGGERSIGNALS   (46)
...
IFX_EXTERN uint16  IfxGtm_Cfg_AdcTriggerSel20to21[IFXGTM_CFG_ADCSEL20to21_NUMVALUES + 1];
...
#define IFXGTM_CFG_SENTSEL8_NUMVALUES    (8)
...
#define IFXGTM_CFG_NUM_CLUSTER_OBJECTS   (10)
...
#define IFXGTM_CFG_MSCSET7_NUMVALUES (8)

#define IFXGTM_CFG_MSCSET8_NUMVALUES (16)
...
#define IFXGTM_CFG_NUM_ADC_TIM_INPUT_SIGNALS   (60)

#define IFXGTM_CFG_NUM_PMS_TIM_INPUT_SIGNALS   (5)

#define IFXGTM_CFG_NUM_SCU_TIM_INPUT_SIGNALS   (21)

#define IFXGTM_CFG_NUM_CAN_TIM_INPUT_SIGNALS   (37)

#define IFXGTM_CFG_NUM_GPT12_TIM_INPUT_SIGNALS (8)

#define IFXGTM_CFG_NUM_LETH_TIM_INPUT_SIGNALS  (8)

#define IFXGTM_CFG_NUM_ERAY_TIM_INPUT_SIGNALS  (5)

#define IFXGTM_CFG_NUM_CANXL_TIM_INPUT_SIGNALS (13)
...
typedef enum
{
    IfxGtm_LethTimInput_LETH0PPS0,
    IfxGtm_LethTimInput_LETH0PPS1,
    IfxGtm_LethTimInput_LETH0PPS2,
    IfxGtm_LethTimInput_LETH0PPS3,
...
#define IFXGTM_CFG_NUM_CDTM_OBJECTS             (7)
