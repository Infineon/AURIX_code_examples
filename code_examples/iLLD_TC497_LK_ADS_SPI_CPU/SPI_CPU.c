...
void initQSPI1Master(void)
{
    ...
    const IfxQspi_SpiMaster_Pins qspi0MasterPins = {
        &IfxQspi1_SCLK_F_P10_2_OUT, IfxPort_OutputMode_pushPull,       /* SCLK Pin                       (CLK)     */
        &IfxQspi1_MTSR_F_P10_4_OUT, IfxPort_OutputMode_pushPull,       /* MasterTransmitSlaveReceive pin (MOSI)    */
        &IfxQspi1_MRSTA_F_P10_1_IN, IfxPort_InputMode_pullDown,        /* MasterReceiveSlaveTransmit pin (MISO)    */
...
void initQSPI1MasterChannel(void)
{
    ...
    const IfxQspi_SpiMaster_Output qspi0SlaveSelect = {                 /* QSPI0 Master selects the QSPI2 Slave     */
        &IfxQspi1_SLSO10_F_P10_0_OUT, IfxPort_OutputMode_pushPull,       /* Slave Select port pin (CS)               */
