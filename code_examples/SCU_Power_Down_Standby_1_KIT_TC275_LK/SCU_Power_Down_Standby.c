...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define LED2                                &MODULE_P00,6   /* LED that signals the start of the application        */
#define LED1                                &MODULE_P00,5   /* LED that signals the entering in Standby mode        */
...
void initLEDs(void)
{
    /* Set Port Pin 00.6 and 00.5 to output mode */
...
{
    IfxPort_setPinLow(LED2);                                              /* Set Port Pin 00.6 to high - LED2 on    */
    IfxPort_setPinHigh(LED1);                                             /* Set Port Pin 00.5 to high - LED1 off   */

    for(uint32 i = 4 * TICKS_TO_WAIT; i > 0; i--);                        /* Wait for ~4s                           */

    IfxPort_setPinLow(LED1);                                              /* Set Port Pin 00.5 to high - LED1 on    */
