...
#define LED                     &MODULE_P13, 1               /* LED which is turned on in Interrupt Service Routine  */

/*********************************************************************************************************************/
/*---------------------------------------------Function Implementations----------------------------------------------*/
/*********************************************************************************************************************/
/* Macro to define Interrupt Service Routine */
IFX_INTERRUPT(ISR_SMU_Alarm, 2, ISR_PRIORITY_SMU_INT0);

/* Interrupt Service Routine of SMU, gets triggered when the SMU Software Alarm 0 is triggered */
void ISR_SMU_Alarm(void)
{
    IfxSmu_clearAlarmStatus(IfxSmu_Alarm_LMU_Buslevel_MpuError);              /* Clear alarm status flag                  */
...
void SMU_configuration(void)
{
     ...
     */
    IfxSmu_setAlarmAction(IfxSmu_Alarm_LMU_Buslevel_MpuError, IfxSmu_InternalAlarmAction_igcs0);
