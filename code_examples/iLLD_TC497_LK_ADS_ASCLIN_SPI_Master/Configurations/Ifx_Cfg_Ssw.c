...
void hardware_init_hook(void)
{
	...
	{
		IfxSsw_clearSram(&MODULE_VMT0, 19); /*LMU0*/
		IfxSsw_clearSram(&MODULE_VMT0, 20); /*LMU1*/
		IfxSsw_clearSram(&MODULE_VMT0, 21); /*LMU2*/
		IfxSsw_clearSram(&MODULE_VMT1, 0);  /*LMU3*/
		IfxSsw_clearSram(&MODULE_VMT1, 1);  /*LMU4*/
		IfxSsw_clearSram(&MODULE_VMT1, 2);  /*LMU5*/
	}
}
