...
#define AN0_CHID        1                                      /* Channel ID for pin AN0                            */
...
float32 g_resultVADC = 0.0;                      /* Variable to store the calculated voltage value               */
...
void readEVADC(void)
{
    ...
    g_resultVADC = g_result.B.RESULT*(ANALOG_FULL_SCALE)/4096;
