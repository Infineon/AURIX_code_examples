 ...
 *
 * \name OneEye_UART_Oscilloscope_1_KIT_TC397_TFT
 * \version V1.0.0
 * \board APPLICATION KIT TC3X7 V2.0, KIT_A2G_TC397_5V_TFT, TC39xXX_B-Step
 * \keywords OneEye, UART, USB, Oscilloscope, AURIX
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_OneEye_UART_Oscilloscope_1_KIT_TC397_TFT-TR-v01_00_00-EN.pdf
...
void core0_main(void)
{
    ...
    initOscilloscope(bb, UPDATE_INTERVAL);
    ...
    while (1)
    {
        /* Update the Uart and sync protocol */
        processUart();
