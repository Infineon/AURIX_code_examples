 ...
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_CCU_Clock_1_KIT_TC397_TFT-TR-v01_00_01-EN.pdf
...
void core0_main(void)
{
    ...
    initCcuClock(); /* Call the initialization function for the CCU clock */
