...
#if defined(DEVICE_TC48X) || defined(DEVICE_TC46X) || defined(DEVICE_TC44X) || defined(DEVICE_TC4ZX) || defined(DEVICE_TC4EX)	
/** \brief 100 micro seconds wait time after LCK lock bit set
 */
#ifndef IFXCLOCK_CCUSTAT_LCKLOCK_WAITTIME
#define IFXCLOCK_CCUSTAT_LCKLOCK_WAITTIME            (0.0001f)
#endif
#endif /* #if defined(DEVICE_TC48X) || defined(DEVICE_TC46X) || defined(DEVICE_TC44X) || defined(DEVICE_TC4ZX) || defined(DEVICE_TC4EX) */
...
#if defined(DEVICE_TC46X) || defined(DEVICE_TC4EX)	
...
#if defined(IFX_CFG_CLOCK_PPUPLL_FREQUENCY)	|| defined(DEVICE_TC4EX)	
...
#endif /* #if IFXCLOCK_IS_EXTCLK_AUDIO_AVAILABLE */
#if defined(DEVICE_TC49XN) || defined(DEVICE_TC45X) || defined(DEVICE_TC4EX)
