...
/* This function configures the standby settings (wake timer, transition timer, current threshold) */
void STANDBYConfig(tlf35584 *tlfDevice)
{
    ...
    tlfDevice->DEVCFG0.B.WKTIMCYC = Enable;  /* wake timer period: 10ms */
    tlfDevice->DEVCFG0.B.WKTIMEN = Disable; /* wake timer is disable */
    tlfDevice->DEVCFG0.B.TREDL = 0x9;
    tlfDevice->DEVCFG2.B.CMONEN = Enable;
    tlfDevice->DEVCFG2.B.CTHR = 0x3;    /* QUC threshold value */
    tlfDevice->WKTIMCFG0.B.TIMVALL = 0xF4; /* if enable wake timer last 5s */
...
void initTLF35584(tlf35584 *tlfDevice)
{
    ...
    STANDBYConfig(&g_tlfDevice); /* mandatory */
