...
__sfr __at (ADDR_SCR_EXICON0) SCR_EXICON0;
__sfr __at (ADDR_SCR_EXICON1) SCR_EXICON1;
__sfr __at (ADDR_SCR_EXICON2) SCR_EXICON2;
__sfr __at (ADDR_SCR_EXICON3) SCR_EXICON3;

__sfr __at (ADDR_SCR_MODPISEL2) SCR_MODPISEL2;
