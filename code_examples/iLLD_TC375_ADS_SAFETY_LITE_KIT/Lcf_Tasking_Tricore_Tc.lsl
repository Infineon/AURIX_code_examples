        ...
        group
        {
            ...
            group
            {
                group code_psram0 (ordered, attributes=rwx, copy, run_addr=mem:psram0)
                {
                    ...
                    select "(.text.Slk_Pflash_Programming.*)";
                }
    ...
    section_layout :vtc:linear
    {
        ...
        {    
            ...
            group
            {
                ...
                group sbst (ordered, contiguous, run_addr=0x801e0000)
                {
                    "__SBST_CPU_DSPR_BASE_ADDR" = 0xd0000000;
                    "__SBST_CPU_PSPR_BASE_ADDR" = 0xc0000000;
                    "SBST_CPU_Enter_Callback" = 0;
                    "SBST_CPU_Exit_Callback" = 0;
                    select ".text.ifx_sbst0"; 
                    select ".text.ifx_sbst1"; 
                    select ".text.ifx_sbst2";
                    select ".text.ifx_sbst3";
                    select ".text.ifx_sbst4";
                    select ".text.ifx_sbst5";
                    select ".text.ifx_sbst6";
                }
            }
        }
