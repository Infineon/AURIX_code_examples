...
SmuStatusType configSMUFSPcore(ConfigStructFSPSMU configFSPSMU)
{
    ...
    switch (configFSPSMU.fspMode)
    {
        ...
        case IfxSmu_FspMode_TimeSwitchingProtocol:
            ...
            if ((g_SlkStatus.resetCode.resetType == SlkResetType_system) ||
                (g_SlkStatus.resetCode.resetType == SlkResetType_application))
            {
...
/*
 * configures the SMU_AGx_FSP registers according to the alarms that are present in the alarmStdbySMUReactionEnabledFSP
 ...
 * */
void enableFSPcoreSMU(IfxSmu_FspMode fspMode, IfxSmu_FspPrescalar1 prescalar1, IfxSmu_FspPrescalar2 prescalar2)
{
    if (nbrAlarmsThatTriggerFSP != 0)
    {
        ...
        g_SlkStatus.smuStatus.smuCoreFSPConfigSts = result;
