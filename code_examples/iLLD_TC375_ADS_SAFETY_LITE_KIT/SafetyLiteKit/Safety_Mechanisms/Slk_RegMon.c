...
const IfxMtu_MbistSel slkRegMonSet[] =
{
    /* Group 0: */
...
/*-------------------------------------------------Global variables--------------------------------------------------*/
/*********************************************************************************************************************/
const int slkRegMonSetSize = sizeof(slkRegMonSet) / sizeof (uint8); /* size of array */

/*********************************************************************************************************************/
/*------------------------------------------------Function Prototypes------------------------------------------------*/
/*********************************************************************************************************************/
boolean slkRunSshRegMonitorTest(uint32 sshReg);

/*********************************************************************************************************************/
/*---------------------------------------------Function Implementations----------------------------------------------*/
/*********************************************************************************************************************/
/*
 * SM:FB.FSB:REG_MONITOR_TEST
 * */
void slkRunRegMonitorTest(void)
{
    g_SlkStatus.regMonitorTestAllFB = NA;
    boolean regMonitorTestPassed = TRUE;

    for(int i = 0; i < slkRegMonSetSize; i++)
    {
        IfxMtu_MbistSel regToCheck = slkRegMonSet[i];

        /* register monitor test if each SSH */
        regMonitorTestPassed &= slkRunSshRegMonitorTest(regToCheck);
    }

    if(regMonitorTestPassed == TRUE)
    {
        g_SlkStatus.regMonitorTestAllFB = pass;
    }
    else
    {
        g_SlkStatus.regMonitorTestAllFB = fail;
    }
}
