/**********************************************************************************************************************
 * \file Slk_Master_QSPI_Safe_Communication.c
...
IFX_INTERRUPT(masterQSPI1TxISR, CPU0_RUNNING_TASK, ISR_PRIORITY_MASTER_TX_QSPI_SAFE);
IFX_INTERRUPT(masterQSPI1RxISR, CPU0_RUNNING_TASK, ISR_PRIORITY_MASTER_RX_QSPI_SAFE);
IFX_INTERRUPT(masterQSPI1ErISR, CPU0_RUNNING_TASK, ISR_PRIORITY_MASTER_ER_QSPI_SAFE);
...
void masterTransmitDataSafeCommQSPI()
{
    ...
    IfxQspi_SpiMaster_exchange(&g_qspiMasterSafe.spiSafeComMasterChannel,
            &g_qspiMasterSafe.qspiMasterTx.data[0], NULL_PTR, FRAME_SIZE);
}
