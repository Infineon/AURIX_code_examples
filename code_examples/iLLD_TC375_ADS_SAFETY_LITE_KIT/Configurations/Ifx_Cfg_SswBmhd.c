...
{
#if SLK_CFG_SSW_ENABLE_LBIST_BOOT
    0x017E,         /* 0x000: .bmi: Boot Mode Index (BMI)                                               */
    0xB359,         /* 0x002: .bmhdid: Boot Mode Header ID (CODE) = B359H                               */
    0xA0000000,     /* 0x004: .stad: User Code start address                                            */
    0x4BC33647,     /* 0x008: .crc: Check Result for the BMI Header (offset 000H - 007H)                */
    0xB43CC9B8,     /* 0x00C: .crcInv: Inverted Check Result for the BMI Header (offset 000H - 007H)    */
#else
