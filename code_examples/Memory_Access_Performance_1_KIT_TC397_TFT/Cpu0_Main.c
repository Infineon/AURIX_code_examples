 ...
 * IN THE SOFTWARE.
 *********************************************************************************************************************/
 /*\title Memory access performance
 ...
 *
 * \name Memory_Access_Performance_1_KIT_TC397_TFT
 * \version V1.0.0
 * \board APPLICATION KIT TC3X7 V2.0, KIT_AURIX_TC397_5V_TFT, TC39xXX_B-Step
 * \keywords access, counter, performance, ram, AURIX, Memory_Access_Performance_1
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_Memory_Access_Performance_1_KIT_TC397_TFT-TR-v01_00_00-EN.pdf
...
void core0_main(void)
{
    ...
    /* Start the performance measurements:
     * the On-Chip Debug System (OCDS) must be enabled in order to use the performance counters
     */
    measurePerformance();
