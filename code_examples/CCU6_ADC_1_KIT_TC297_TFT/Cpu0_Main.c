 ...
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_CCU6_ADC_1_KIT_TC297_TFT-TR-v01_00_03-EN.pdf
...
int core0_main(void)
{
    ...
    init_vadc();    /* Initialization of the analog to digital converter    */
