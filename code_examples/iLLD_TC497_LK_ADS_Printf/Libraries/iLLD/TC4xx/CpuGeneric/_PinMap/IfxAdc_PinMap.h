...
#if defined(DEVICE_TC4DX) || defined(DEVICE_TC49XN) || defined(DEVICE_TC46X) || defined(DEVICE_TC44X) || defined(DEVICE_TC4EX)
/** \brief   
*/
...
#if defined(DEVICE_TC4DX) || defined(DEVICE_TC49XN) || defined(DEVICE_TC46X) || defined(DEVICE_TC4EX)
/** \brief
 */
typedef const struct
{
...
#if defined(DEVICE_TC4DX) || defined(DEVICE_TC49XN) || defined(DEVICE_TC48X) || defined(DEVICE_TC46X) || defined(DEVICE_TC4EX)
/** \brief
 */
typedef const struct
{
...
#endif /* #if defined(DEVICE_TC4DX) || defined(DEVICE_TC49XN) || defined(DEVICE_TC48X) || defined(DEVICE_TC46X) || defined(DEVICE_TC4EX) */
...
#if !defined(DEVICE_TC45X) || !defined(DEVICE_TC4ZX) || defined(DEVICE_TC4EX)
/** \brief
 */
typedef const struct
{
