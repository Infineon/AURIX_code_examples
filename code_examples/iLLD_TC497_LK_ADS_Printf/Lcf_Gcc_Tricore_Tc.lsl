...
LCF_STARTPTR_NC_CPU4 = 0xA1000000;
...
MEMORY
{
    ...
    cpu3_dlmu (w!xp): org = 0x90180000, len = 128K
    cpu3_dlmu_nc (w!xp): org = 0xb0180000, len = 128K

    cpu4_dlmu (w!xp): org = 0x901a0000, len = 128K
    cpu4_dlmu_nc (w!xp): org = 0xb01a0000, len = 128K

    lmuram (w!xp): org = 0x90400000, len = 3M
    lmuram_nc (w!xp): org = 0xb0400000, len = 3M
