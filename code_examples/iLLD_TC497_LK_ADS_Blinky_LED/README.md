...
## Hardware setup  
This code example has been developed for the board KIT_TC497N Lite KIT (AURIX&trade; TC497N Lite KIT Board)
...
## Run and Test   
After code compilation and flashing the device, observe the LED P22.8 which is blinking at a frequency of approximately 1 Hz.
