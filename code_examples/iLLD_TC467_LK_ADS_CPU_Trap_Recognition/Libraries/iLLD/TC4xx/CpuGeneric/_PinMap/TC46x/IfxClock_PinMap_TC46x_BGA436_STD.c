/**
 * \file IfxClock_PinMap_TC46x_BGA436_STD.c
 * \brief CLOCK  details
 *
...
#include "IfxClock_PinMap_TC46x_BGA436_STD.h"
...
IfxClock_Extclk_Out IfxClock_EXTCLK1_P11_14_OUT = {&MODULE_CLOCK, 1, {&MODULE_P11, 14}, IfxPort_OutputIdx_alt7};
