...
#if defined(DEVICE_TC4DX) || defined(DEVICE_TC49XN) || defined(DEVICE_TC44X) || defined(DEVICE_TC46X) || defined(DEVICE_TC48X) || defined(DEVICE_TC4ZX) || defined(DEVICE_TC4EX)
...
#if defined(DEVICE_TC4DX) || defined(DEVICE_TC44X) || defined(DEVICE_TC48X) || defined(DEVICE_TC4ZX)	
...
#if defined(DEVICE_TC49XN) || defined(DEVICE_TC44X) || defined(DEVICE_TC46X) || defined(DEVICE_TC48X) || defined(DEVICE_TC4EX)	
...
#if defined(DEVICE_TC4DX) || defined(DEVICE_TC44X) || defined(DEVICE_TC45X) || defined(DEVICE_TC48X) || defined(DEVICE_TC4ZX)	
...
#endif
#if defined(DEVICE_TC4DX) || defined(DEVICE_TC49XN) || defined(DEVICE_TC48X) || defined(DEVICE_TC4ZX)	
...
#endif
#if defined(DEVICE_TC4DX) || defined(DEVICE_TC49XN) || defined(DEVICE_TC46X) || defined(DEVICE_TC48X) || defined(DEVICE_TC4ZX)		
...
#if defined(DEVICE_TC48X) || defined(DEVICE_TC4ZX)
...
{
    /* Enable the PORT 16 LDO for the complete IP */
    port->LDOCTRL[0].ENCONF_RDDIAG.B.ENABLE = 1U;

    /* Enable Timer configuration for Short Detection */
...
#if defined(DEVICE_TC46X) || defined(DEVICE_TC48X)
void IfxPort_configureLDO(Ifx_P *port, IfxPort_BlankingTimerConfig timerConfig)
{
    /* Enable the PORT n LDO for the complete IP */
...
#endif /* #if defined(DEVICE_TC46X) || defined(DEVICE_TC48X) */
