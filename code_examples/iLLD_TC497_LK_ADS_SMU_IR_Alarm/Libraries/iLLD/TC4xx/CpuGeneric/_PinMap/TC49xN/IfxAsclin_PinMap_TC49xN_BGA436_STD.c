/**
 * \file IfxAsclin_PinMap_TC49xN_BGA436_STD.c
...
#include "IfxAsclin_PinMap_TC49xN_BGA436_STD.h"
...
IfxAsclin_Rts_Out  IfxAsclin2_RTS_F_P10_13_OUT = {&MODULE_ASCLIN2, {&MODULE_P10, 13}, IfxPort_OutputIdx_alt6};
