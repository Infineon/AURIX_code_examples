...
# iLLD_TC497_LK_ADS_SMU_IR_Alarm
...
## Hardware setup  
This code example has been developed for the board  AURIX&trade; TC497 lite Kit (KIT_A3G_TC497_LITE). A debugger is needed to step through the code and see when the software alarm is triggered.
