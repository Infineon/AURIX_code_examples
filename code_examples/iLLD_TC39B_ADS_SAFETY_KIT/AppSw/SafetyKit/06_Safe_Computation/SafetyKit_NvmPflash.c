...
#define PFLASH0_START_ADDRESS_IC      0xA0100000
/* Cached address where the user want to store the safety data i.e. Bank Pf1 */
#define PFLASH1_START_ADDRESS_UC      0xA0400000
#define PFLASH1_DBE_ADDRESS           0xA0400020        /* address where double bit error is injected */
