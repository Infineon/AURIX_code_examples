...
#if SAFETYKIT_CFG_SSW_ENABLE_MONBIST == 0U
    /* MONBIST Tests and evaluation */
    IFX_CFG_SSW_CALLOUT_MONBIST();
#endif /* SAFETYKIT_CFG_SSW_ENABLE_MONBIST == 0U */
...
#if SAFETYKIT_CFG_SSW_ENABLE_MBIST == 0U
    /* MBIST Tests and evaluation */
    IFX_CFG_SSW_CALLOUT_MBIST();
#endif /* SAFETYKIT_CFG_SSW_ENABLE_MBIST == 0U */
...
#pragma noclear
#endif
IfxCpu_syncEvent cpuSyncEvent IFX_ALIGN(4) __attribute__ ((section(".bss_noclear")));
#if defined(__TASKING__)
#pragma clear
#endif
static void __StartUpSoftware_Phase6(void)
{
    /* before we start other cpu's we set the cpuSyncEvent to 0 */
    /* this variable should not initialized by c init, set to farnoclear */
    *(&cpuSyncEvent) = 0;
