...
#if (IFX_CFG_SSW_ENABLE_MONBIST == 1U || SAFETYKIT_CFG_SSW_ENABLE_MONBIST == 1U)
...
void Ifx_Ssw_Monbist(void)
{
...
#if IFX_CFG_SSW_ENABLE_MONBIST == 1U && SAFETYKIT_CFG_SSW_ENABLE_MONBIST == 0U
    Ifx_Ssw_jumpToFunction(&Ifx_Ssw_MonbistCheck);
#else /* IFX_CFG_SSW_ENABLE_MONBIST == 1U && SAFETYKIT_CFG_SSW_ENABLE_MONBIST == 0U */
    Ifx_Ssw_MonbistCheck();
    ...
    IFX_CFG_SSW_SET_SAFETY_ENDINIT();
#endif /* IFX_CFG_SSW_ENABLE_MONBIST == 1U && SAFETYKIT_CFG_SSW_ENABLE_MONBIST == 0U */
}
