...
/** \brief Length for Ifx_P_ENCONF_RDDIAG_Bits.ENABLE */
#define IFX_P_ENCONF_RDDIAG_ENABLE_LEN (1u)

/** \brief Mask for Ifx_P_ENCONF_RDDIAG_Bits.ENABLE */
#define IFX_P_ENCONF_RDDIAG_ENABLE_MSK (0x1u)

/** \brief Offset for Ifx_P_ENCONF_RDDIAG_Bits.ENABLE */
#define IFX_P_ENCONF_RDDIAG_ENABLE_OFF (0u)

/** \brief Length for Ifx_P_ENCONF_RDDIAG_Bits.SHORT_TIMER */
#define IFX_P_ENCONF_RDDIAG_SHORT_TIMER_LEN (2u)

/** \brief Mask for Ifx_P_ENCONF_RDDIAG_Bits.SHORT_TIMER */
#define IFX_P_ENCONF_RDDIAG_SHORT_TIMER_MSK (0x3u)

/** \brief Offset for Ifx_P_ENCONF_RDDIAG_Bits.SHORT_TIMER */
#define IFX_P_ENCONF_RDDIAG_SHORT_TIMER_OFF (1u)

/** \brief Length for Ifx_P_ENCONF_RDDIAG_Bits.SHHEN */
#define IFX_P_ENCONF_RDDIAG_SHHEN_LEN (1u)

/** \brief Mask for Ifx_P_ENCONF_RDDIAG_Bits.SHHEN */
#define IFX_P_ENCONF_RDDIAG_SHHEN_MSK (0x1u)

/** \brief Offset for Ifx_P_ENCONF_RDDIAG_Bits.SHHEN */
#define IFX_P_ENCONF_RDDIAG_SHHEN_OFF (3u)

/** \brief Length for Ifx_P_ENCONF_RDDIAG_Bits.SH_LDO_OFF_EN */
#define IFX_P_ENCONF_RDDIAG_SH_LDO_OFF_EN_LEN (1u)

/** \brief Mask for Ifx_P_ENCONF_RDDIAG_Bits.SH_LDO_OFF_EN */
#define IFX_P_ENCONF_RDDIAG_SH_LDO_OFF_EN_MSK (0x1u)

/** \brief Offset for Ifx_P_ENCONF_RDDIAG_Bits.SH_LDO_OFF_EN */
#define IFX_P_ENCONF_RDDIAG_SH_LDO_OFF_EN_OFF (4u)

/** \brief Length for Ifx_P_ENCONF_RDDIAG_Bits.SHOFF_PMS */
#define IFX_P_ENCONF_RDDIAG_SHOFF_PMS_LEN (1u)

/** \brief Mask for Ifx_P_ENCONF_RDDIAG_Bits.SHOFF_PMS */
#define IFX_P_ENCONF_RDDIAG_SHOFF_PMS_MSK (0x1u)

/** \brief Offset for Ifx_P_ENCONF_RDDIAG_Bits.SHOFF_PMS */
#define IFX_P_ENCONF_RDDIAG_SHOFF_PMS_OFF (5u)

/** \brief Length for Ifx_P_ENCONF_RDDIAG_Bits.SH_VDD */
#define IFX_P_ENCONF_RDDIAG_SH_VDD_LEN (1u)

/** \brief Mask for Ifx_P_ENCONF_RDDIAG_Bits.SH_VDD */
#define IFX_P_ENCONF_RDDIAG_SH_VDD_MSK (0x1u)

/** \brief Offset for Ifx_P_ENCONF_RDDIAG_Bits.SH_VDD */
#define IFX_P_ENCONF_RDDIAG_SH_VDD_OFF (6u)

/** \brief Length for Ifx_P_TRIMCONF_PROT_Bits.TRIM */
#define IFX_P_TRIMCONF_PROT_TRIM_LEN (6u)

/** \brief Mask for Ifx_P_TRIMCONF_PROT_Bits.TRIM */
#define IFX_P_TRIMCONF_PROT_TRIM_MSK (0x3fu)

/** \brief Offset for Ifx_P_TRIMCONF_PROT_Bits.TRIM */
#define IFX_P_TRIMCONF_PROT_TRIM_OFF (0u)
