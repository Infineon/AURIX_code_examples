...
/** \brief Length for Ifx_CPU_EXEVT_Bits.EN */
#define IFX_CPU_EXEVT_EN_LEN (1u)

/** \brief Mask for Ifx_CPU_EXEVT_Bits.EN */
#define IFX_CPU_EXEVT_EN_MSK (0x1u)

/** \brief Offset for Ifx_CPU_EXEVT_Bits.EN */
#define IFX_CPU_EXEVT_EN_OFF (0u)
...
/** \brief Length for Ifx_CPU_CREVT_Bits.EN */
#define IFX_CPU_CREVT_EN_LEN (1u)

/** \brief Mask for Ifx_CPU_CREVT_Bits.EN */
#define IFX_CPU_CREVT_EN_MSK (0x1u)

/** \brief Offset for Ifx_CPU_CREVT_Bits.EN */
#define IFX_CPU_CREVT_EN_OFF (0u)
...
/** \brief Length for Ifx_CPU_SWEVT_Bits.EN */
#define IFX_CPU_SWEVT_EN_LEN (1u)

/** \brief Mask for Ifx_CPU_SWEVT_Bits.EN */
#define IFX_CPU_SWEVT_EN_MSK (0x1u)

/** \brief Offset for Ifx_CPU_SWEVT_Bits.EN */
#define IFX_CPU_SWEVT_EN_OFF (0u)
