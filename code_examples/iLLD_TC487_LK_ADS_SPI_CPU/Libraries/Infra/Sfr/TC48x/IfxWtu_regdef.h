...
/** \brief CPU0 WDT write access enable register A */
typedef struct _Ifx_WTU_WDTCPU_ACCEN_WRA_Bits
{
    __IO Ifx_UReg_32Bit EN00:1;            /**< \brief [0:0] Write access enable for TAG-ID q - ENq (rw) */
    __IO Ifx_UReg_32Bit EN01:1;            /**< \brief [1:1] Write access enable for TAG-ID q - ENq (rw) */
    __I  Ifx_UReg_32Bit EN02:1;            /**< \brief [2:2] Write access enable for TAG-ID q - ENq (r) */
...
typedef union
{
    __IO Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_WTU_WDTCPU_ACCEN_WRA_Bits B;       /**< \brief Bitfield access */
} Ifx_WTU_WDTCPU_ACCEN_WRA;
...
{
       __IO Ifx_WTU_WDTCPU_ACCEN_WRA            WRA;                    /**< \brief 0, CPU0 WDT write access enable register A*/
...
typedef volatile struct _Ifx_WTU
{
       ...
       __IO Ifx_WTU_WDTCPU                      WDTCPU[4];              /**< \brief 18, */
       __I  Ifx_UReg_8Bit                       reserved_D8[120];       /**< \brief D8, \internal Reserved */
