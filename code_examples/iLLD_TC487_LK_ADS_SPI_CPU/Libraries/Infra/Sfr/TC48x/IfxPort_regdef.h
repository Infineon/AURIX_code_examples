...
/** \brief Port n LDO Configuration and control register */
typedef struct _Ifx_P_ENCONF_RDDIAG_Bits
{
    __IO Ifx_UReg_32Bit ENABLE:1;          /**< \brief [0:0] Main Enable for complete IP (rwh) */
    __IO Ifx_UReg_32Bit SHORT_TIMER:2;     /**< \brief [2:1] Blanking Timer configuration for Short Detection (rw) */
...
} Ifx_P_ENCONF_RDDIAG_Bits;

/** \brief Port n HWSEL status Register */
...
/** \brief Port n Pad Access Control Register for pad0 */
...
/** \brief Port n Pad configuration Control Register for pad0 */
typedef struct _Ifx_P_PADCFG_DRVCFG_Bits
{
    ...
    __IO Ifx_UReg_32Bit PD:3;              /**< \brief [10:8] Pad drive mode selection (rwh) */
    ...
    __IO Ifx_UReg_32Bit MODEX:2;           /**< \brief [17:16] Configuration of output driver for HS_Fast pad (1.8V and 3.3V) (rwh) */
    __I  Ifx_UReg_32Bit :14;               /**< \brief [31:18] \internal Reserved */
} Ifx_P_PADCFG_DRVCFG_Bits;

/** \brief Port n GPIO Control Register for pin 0 */
...
/** \brief Port n Pad Safety and Security Control Register for pad0 */
...
/** \brief Selection Register for Module x Port n Control */
...
/** \brief Port n LDO Trimming register */
typedef struct _Ifx_P_TRIMCONF_PROT_Bits
{
    __IO Ifx_UReg_32Bit TRIM:6;            /**< \brief [5:0] LDO Trimming (rw) */
    __I  Ifx_UReg_32Bit :26;               /**< \brief [31:6] \internal Reserved */
} Ifx_P_TRIMCONF_PROT_Bits;

/** \brief Port n Wake Enable Register */
...
/** \brief Port n Wake Enable Status Register */
...
/** \brief Port n Wake Status Clear Register */
...
/** \brief Port n Wake Status Register */
...
typedef union
{
    __IO Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_P_ENCONF_RDDIAG_Bits B;            /**< \brief Bitfield access */
} Ifx_P_ENCONF_RDDIAG;
...
typedef union
{
    __IO Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_P_TRIMCONF_PROT_Bits B;            /**< \brief Bitfield access */
} Ifx_P_TRIMCONF_PROT;
...
{
       __IO Ifx_P_PADCFG_GPIO                   GPIO;                   /**< \brief 0, Port n GPIO Control Register for pin 0*/
       __IO Ifx_P_PADCFG_DRVCFG                 DRVCFG;                 /**< \brief 4, Port n Pad configuration Control Register for pad0*/
       __IO Ifx_P_PADCFG_ACCEN                  ACCEN;                  /**< \brief 8, Port n Pad Access Control Register for pad0*/
       __IO Ifx_P_PADCFG_SAFSEC                 SAFSEC;                 /**< \brief C, Port n Pad Safety and Security Control Register for pad0*/
} Ifx_P_PADCFG;
...
typedef volatile struct _Ifx_P
{
       ...
       __IO Ifx_P_WKEN                          WKEN;                   /**< \brief 10, Port n Wake Enable Register*/
       __I  Ifx_P_WKSTS                         WKSTS;                  /**< \brief 14, Port n Wake Status Register*/
       __I  Ifx_P_WKENSTS                       WKENSTS;                /**< \brief 18, Port n Wake Enable Status Register*/
       __O  Ifx_P_WKENSTSCLR                    WKENSTSCLR;             /**< \brief 1C, Port n Wake Status Clear Register*/
       __IO Ifx_P_OUT                           OUT;                    /**< \brief 20, Port n Output Register*/
       __I  Ifx_P_IN                            IN;                     /**< \brief 24, Port n Input Register*/
       __I  Ifx_P_HWSELSTAT                     HWSELSTAT;              /**< \brief 28, Port n HWSEL status Register*/
       ...
       __IO Ifx_P_PCSRSEL                       PCSRSEL;                /**< \brief 34, Selection Register for Module x Port n Control*/
       ...
       __O  Ifx_P_OMCR                          OMCR;                   /**< \brief 40, Port n Output Modification Clear Register*/
       __O  Ifx_P_OMSR                          OMSR;                   /**< \brief 44, Port n Output Modification Set Register*/
       ...
       __IO Ifx_P_ENCONF_RDDIAG                 ENCONF_RDDIAG;          /**< \brief 190, Port n LDO Configuration and control register*/
       __I  Ifx_UReg_8Bit                       reserved_194[8];        /**< \brief 194, \internal Reserved */
       __IO Ifx_P_TRIMCONF_PROT                 TRIMCONF_PROT;          /**< \brief 19C, Port n LDO Trimming register*/
