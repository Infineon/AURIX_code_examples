...
/** \brief FGAC Lookup Table RAM register 0 */
...
/** \brief Trace memory Write Pointer */
typedef struct _Ifx_MCDS4P2P_FIFONOW_Bits
{
    __I  Ifx_Strict_32Bit :5;              /**< \brief [4:0] \internal Reserved */
    __I  Ifx_Strict_32Bit NOW:26;          /**< \brief [30:5] Trace memory current Write Pointer - NOW (rh) */
    __I  Ifx_Strict_32Bit :1;              /**< \brief [31:31] \internal Reserved */
...
typedef struct _Ifx_MCDS4P2P_MUXTCRC_Bits
{
    ...
    __IO Ifx_Strict_32Bit SPUMUX:3;        /**< \brief [11:9] SPUMUX Trace Source Select (rw) */
    __I  Ifx_Strict_32Bit :3;              /**< \brief [14:12] \internal Reserved */
...
typedef volatile struct _Ifx_MCDS4P2P
{
       ...
       __I  Ifx_MCDS4P2P_FIFONOW                FIFONOW;                /**< \brief 200, Trace memory Write Pointer*/
       ...
       __IO Ifx_MCDS4P2P_FGACLUT                FGACLUT[2048];          /**< \brief C000, FGAC Lookup Table RAM register 0*/
