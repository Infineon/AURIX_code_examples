...
/** \brief CPUx PFI buffer disable */
typedef struct _Ifx_CPUCFI_PFIBUFDIS_Bits
{
    __IO Ifx_Strict_32Bit DISR:1;          /**< \brief [0:0] Prefetch and data read line buffers disable request bit (rw) */
    __I  Ifx_Strict_32Bit DISS:1;          /**< \brief [1:1] Prefetch and data read line buffers disable status bit (rh) */
    __I  Ifx_Strict_32Bit :30;             /**< \brief [31:2] \internal Reserved */
} Ifx_CPUCFI_PFIBUFDIS_Bits;
...
typedef union
{
    __IO Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_CPUCFI_PFIBUFDIS_Bits B;           /**< \brief Bitfield access */
} Ifx_CPUCFI_PFIBUFDIS;
...
typedef volatile struct _Ifx_CPUCFI
{
       ...
       __I  Ifx_UReg_8Bit                       reserved_258[200];      /**< \brief 258, \internal Reserved */
       __IO Ifx_CPUCFI_PFIBUFDIS                PFIBUFDIS;              /**< \brief 320, CPUx PFI buffer disable*/
       __I  Ifx_UReg_8Bit                       reserved_324[64732];    /**< \brief 324, \internal Reserved */
} Ifx_CPUCFI;
