...
#if !defined(DEVICE_TC48XAA) && !defined(DEVICE_TC45X) && !defined(DEVICE_TC4EX) && !defined(DEVICE_TC4PX)
...
#endif /* #if !defined(DEVICE_TC48XAA) && !defined(DEVICE_TC45X) && !defined(DEVICE_TC4EX) */
