/**
 * \file IfxGeth_PinMap_TC48x_BGA292_STD.c
 * \brief GETH  details
 *
...
#include "IfxGeth_PinMap_TC48x_BGA292_STD.h"
...
IfxGeth_Mdc_Out    IfxGeth0_P1_MDC_P12_0_OUT = {&MODULE_GETH0, (IfxGeth_PortIndex)1, {&MODULE_P12, 0}, IfxPort_OutputIdx_alt7};
...
IfxGeth_Mdio_In    IfxGeth0_PX_MDIOC_P12_1_IN = {&MODULE_GETH0, {&MODULE_P12, 1}, Ifx_RxSel_c};
...
IFX_CONST IfxGeth_Mdio_In    *IfxGeth_Mdio_In_pinTable[IFXGETH_PINMAP_NUM_MODULES][IFXGETH_PINMAP_MDIO_IN_NUM_ITEMS] = {
    {
        NULL_PTR,
        NULL_PTR,
        &IfxGeth0_PX_MDIOC_P12_1_IN,
    },
};
