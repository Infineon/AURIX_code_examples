...
#if defined(DEVICE_TC45X) || defined(DEVICE_TC46X) || defined(DEVICE_TC48XAA) || defined(DEVICE_TC48X) || defined(DEVICE_TC4ZX) || defined(DEVICE_TC44X) || defined(DEVICE_TC4EX) || defined(DEVICE_TC4PX)
...
#endif /* #if defined(DEVICE_TC45X) || defined(DEVICE_TC46X) || defined(DEVICE_TC48XAA) || defined(DEVICE_TC48X) || defined(DEVICE_TC4ZX) || defined(DEVICE_TC44X) || defined(DEVICE_TC4EX) || defined(DEVICE_TC4PX) */
...
#if defined(DEVICE_TC45X) || defined(DEVICE_TC46X) || defined(DEVICE_TC48XAA) || defined(DEVICE_TC48X) || defined(DEVICE_TC4ZX) || defined(DEVICE_TC44X) || defined(DEVICE_TC4EX) || defined(DEVICE_TC4PX)
/** \brief Configures LDO.
 *
 * \param[inout] port       Pointer to the port which should be accessed.
 * \param[in]   timerConfig Configure the timer. Range: \ref IfxPort_BlankingTimerConfig.
 *
 * \retval None
 */
IFX_EXTERN void IfxPort_configureLDO(Ifx_P *port, IfxPort_BlankingTimerConfig timerConfig);
#endif /* #if defined(DEVICE_TC45X) || defined(DEVICE_TC46X) || defined(DEVICE_TC48XAA) || defined(DEVICE_TC48X) || defined(DEVICE_TC4ZX) || defined(DEVICE_TC44X) || defined(DEVICE_TC4EX) || defined(DEVICE_TC4PX) */
