...
IFX_INLINE void IfxGtm_Tom_Pwm_setDuty(IfxGtm_Tom_Pwm_Driver *driver, float32 requestDuty)
{
    ...
    {
        period = IfxGtm_Tom_Ch_getCompareZeroShadow(driver->tom, driver->tomChannel);
    }
    else
    {
        period = IfxGtm_Tom_Ch_getCompareZero(driver->tom, driver->tomChannel);
    }
...
IFX_INLINE void IfxGtm_Tom_Pwm_setFrequency(IfxGtm_Tom_Pwm_Driver *driver, float32 requestFrequency)
{
    ...
    if (driver->synchronousUpdateEnabled == TRUE)
    {
        currentPeriod     = IfxGtm_Tom_Ch_getCompareZeroShadow(driver->tom, driver->tomChannel);
        currentDutyCycle  = IfxGtm_Tom_Ch_getCompareOneShadow(driver->tom, driver->tomChannel);
    }
    else
    {
