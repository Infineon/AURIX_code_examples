...
#ifndef IFXLETH_CFG_TC48X_H
#define IFXLETH_CFG_TC48X_H 1
 ...
 */
#define IFXLETH_NUM_RX_QUEUES     (4)
 ...
 */
#define IFXLETH_NUM_PORTS         (3)

/* Derivative and Port specific Configurations*/

/** \brief Number of Ports in Leth 0
 */
#define IFXLETH0_NUM_PORTS         (3)

/** \brief Number of Ports in Leth 0
 */
#define IFXLETH1_NUM_PORTS         (0)

/** \brief 1Gbps speed avaialability in Leth 0
 */
#define IFXLETH0_IS_1G_SUPPORTED   (FALSE)

/** \brief 1Gbps speed avaialability in Leth 1
 */
#define IFXLETH1_IS_1G_SUPPORTED   (FALSE)

/** \brief Availability of Bridge in Leth 0
 */
#define IFXLETH0_IS_BRIDGE_AVAILABLE   (TRUE)

/** \brief Availability of Bridge in Leth 1
 */
#define IFXLETH1_IS_BRIDGE_AVAILABLE   (FALSE)

/** \brief Number of Tx queues in MTL block in Leth 0
 */
#define IFXLETH0_NUM_TX_QUEUES     (5)

/** \brief Number of Tx queues in MTL block in Leth 1
 */
#define IFXLETH1_NUM_TX_QUEUES     (0)

/** \brief Number of Rx queues in MTL block in Leth 0
 */
#define IFXLETH0_NUM_RX_QUEUES     (4)

/** \brief Number of Rx queues in MTL block in Leth 1
 */
#define IFXLETH1_NUM_RX_QUEUES     (0)

/** \brief Max number of Tx DMA channels of DMA in Leth 0
 */
#define IFXLETH0_NUM_TX_CHANNELS   (8)

/** \brief Max number of Rx Channels of DMA in Leth 0
 */
#define IFXLETH0_NUM_RX_CHANNELS   (8)

/** \brief Max number of DMA channels in Leth 0
 */
#define IFXLETH0_NUM_DMA_CHANNELS  (8)

/** \brief Max number of Tx DMA channels of DMA in Leth 1
 */
#define IFXLETH1_NUM_TX_CHANNELS   (0)

/** \brief Max number of Rx Channels of DMA in Leth 1
 */
#define IFXLETH1_NUM_RX_CHANNELS   (0)

/** \brief Max number of DMA channels in Leth 1
 */
#define IFXLETH1_NUM_DMA_CHANNELS  (0)
 ...
 */
#define IFXLETH_IS_MULTI_PORT_SUPPORT  (TRUE)

/** \brief Receive Buffer size High 13_Y
 */
#define IFXLETH1_RBSZ_13_Y  			(FALSE)
 ...
 */
#define IFXLETH_IS_EXTPTPTIMESEL_AVAILABLE (TRUE)

/** \brief Usage of Port Index
 */
#define IFXLETH_USE_PORTINDEX			(TRUE)
 ...
 */
#define IFXLETH_IS_SRVC_RQST_PPS3_AVAILABLE		(FALSE)

/** \brief Availability of Service Request Wake up
 */
#define IFXLETH_IS_SRVC_RQST_WUP_AVAILABLE		(TRUE)

/** \brief Availability of Service Request MCGR0
 */
#define IFXLETH_IS_SRVC_RQST_MCGR0_AVAILABLE	(TRUE)

/** \brief Availability of Service Request MCGR1
 */
#define IFXLETH_IS_SRVC_RQST_MCGR1_AVAILABLE	(TRUE)

/** \brief Availability of Service Request MCGR2
 */
#define IFXLETH_IS_SRVC_RQST_MCGR2_AVAILABLE	(TRUE)
 ...
 */
#define IFXLETH_IS_DISABLE_RXER_AVAILABLE		(TRUE)

/** \brief Enable or disable RXDEN bit of PORTCTRL0
 */
#define IFXLETH_ENABLE_DISABLE_RXDEN			(TRUE)
...
typedef enum
{
    ...
    IfxLeth_RxMtlQueue_2 = 2,  /**< \brief Rx Queue 2 */
    IfxLeth_RxMtlQueue_3 = 3,  /**< \brief Rx Queue 3 */
} IfxLeth_RxMtlQueue;
