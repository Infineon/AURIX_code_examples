...
#ifndef IFXCLOCK_CFG_TC48X_H
#define IFXCLOCK_CFG_TC48X_H 1
...
#ifndef IFX_CFG_CLOCK_APLL_FREQUENCY
#    define IFX_CFG_CLOCK_APLL_FREQUENCY   98304000   /**< \brief Default APLL frequency */
#endif
...
#error "AurixPlus Triboard supported crystal frequencies are 20MHz, 25MHz, 40MHz and 50MHz"
#endif
 ...
 */
#define IFXCLOCK_IS_EXTCLK_XSPISL_AVAILABLE           (FALSE)

/** \brief Availability of K3 Divider
 */
#define IFXCLOCK_IS_K3DIVIDER_AVAILABLE               (FALSE)

/** \brief Availability of clock audio
 */
#define IFXCLOCK_IS_EXTCLK_AUDIO_AVAILABLE            (TRUE)

/** \brief Availability of External Clock FSI2
 */
#define IFXCLOCK_IS_EXTCLK_FSI2_AVAILABLE             (TRUE)

/** \brief Availability of External Clock CPB
 */
#define IFXCLOCK_IS_EXTCLK_CPB_AVAILABLE              (FALSE)

/** \brief Availability of External Clock MSC
 */
#define IFXCLOCK_IS_EXTCLK_MSC_AVAILABLE              (FALSE)
 ...
 */
#define IFXCLOCK_SYSPLL_KXDIV_KXPREDIV_VALUE          (0x00000011)
...
#if (IFX_CFG_CLOCK_APLL_FREQUENCY == (98304000))
#define IFXCLOCK_CFG_APLL_FREQ     98M304HZ
#else
#error "Wrong APLL frequency configuration!, check IFX_CFG_CLOCK_APLL_FREQUENCY configuration in Ifx_Cfg.h."
#error "Supported APLL frequencies are 98.304MHz."
#endif
...
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(40 - 1), (IfxClock_K2divider)(8 - 1), (IfxClock_K2PreDivider)(1 - 1)}
...
#define IFXCLOCK_CFG_SYS_PLL_20MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(40 - 1), (IfxClock_K2divider)(2 - 1), (IfxClock_K2PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_20MHZ_400MHZ */
...
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(32 - 1), (IfxClock_K2divider)(8 - 1), (IfxClock_K2PreDivider)(1 - 1)}
...
#define IFXCLOCK_CFG_SYS_PLL_25MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(32 - 1), (IfxClock_K2divider)(2 - 1), (IfxClock_K2PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_25MHZ_400MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 divider has initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 40MHz Crystal and 400MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_SYS_PLL_40MHZ_400MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider }*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(20 - 1), (IfxClock_K2divider)(8 - 1), (IfxClock_K2PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_400MHZ */
#else
/* Ramp Osc is enabled hence k2 divider has final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ
/**** Macro for Initial Pll step, for profile with 40MHz Crystal and 400MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_SYS_PLL_40MHZ_400MHZ                          \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider }*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(20 - 1), (IfxClock_K2divider)(2 - 1), (IfxClock_K2PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_400MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 divider has initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 50MHz Crystal and 400MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_SYS_PLL_50MHZ_400MHZ                          \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(16 - 1), (IfxClock_K2divider)(8 - 1), (IfxClock_K2PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_400MHZ */
#else
/* Ramp Osc is enabled hence k2 divider has final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 50MHz Crystal and 400MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_SYS_PLL_50MHZ_400MHZ                          \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(16 - 1), (IfxClock_K2divider)(2 - 1), (IfxClock_K2PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_400MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#ifndef IFXCLOCK_CFG_APLL_20MHZ_98M304HZ
/** \brief Macro for Initial Pll step, for profile with 20MHz Crystal and 98.304MHz target (fDCO= 983.04MHz)*/
#define IFXCLOCK_CFG_APLL_20MHZ_98M304HZ                         \
/*{ uint8 pDivider, uint8 kDivider, uint8 nDividerInt, uint8 nDividerFrac}*/\
    {(IfxClock_Pdivider)(1 - 1),(IfxClock_Kdivider)(10 - 1),(IfxClock_Ndivider)(49 - 1),(uint16)(0x26F)}
#endif /*#ifndef IFXCLOCK_CFG_APLL_20MHZ_98M304HZ */

/*******************************25MHz Oscillator Frequency******************************************/

#ifndef IFXCLOCK_CFG_APLL_25MHZ_98M304HZ
/** \brief Macro for Initial Pll step, for profile with 25MHz Crystal and 98.304MHz target (fDCO= 983.04MHz)*/
#define IFXCLOCK_CFG_APLL_25MHZ_98M304HZ                         \
/*{ uint8 pDivider, uint8 kDivider, uint8 nDividerInt, uint8 nDividerFrac}*/\
    {(IfxClock_Pdivider)(1 - 1),(IfxClock_Kdivider)(10 - 1),(IfxClock_Ndivider)(39 - 1),(uint16)(0x525)}
#endif /*#ifndef IFXCLOCK_CFG_APLL_25MHZ_98M304HZ */

/*******************************40MHz Oscillator Frequency******************************************/

#ifndef IFXCLOCK_CFG_APLL_40MHZ_98M304HZ
/** \brief Macro for Initial Pll step, for profile with 40MHz Crystal and 98.304MHz target (fDCO= 983.04MHz)*/
#define IFXCLOCK_CFG_APLL_40MHZ_98M304HZ                         \
/*{ uint8 pDivider, uint8 kDivider, uint8 nDividerInt, uint8 nDividerFrac}*/\
    {(IfxClock_Pdivider)(2 - 1),(IfxClock_Kdivider)(10 - 1),(IfxClock_Ndivider)(39 - 1),(uint16)(0x26F)}
#endif /*#ifndef IFXCLOCK_CFG_APLL_40MHZ_98M304HZ */

/*******************************50MHz Oscillator Frequency******************************************/

#ifndef IFXCLOCK_CFG_APLL_50MHZ_98M304HZ
/** \brief Macro for Initial Pll step, for profile with 50MHz Crystal and 98.304MHz target (fDCO= 983.04MHz)*/
#define IFXCLOCK_CFG_APLL_50MHZ_98M304HZ                         \
/*{ uint8 pDivider, uint8 kDivider, uint8 nDividerInt, uint8 nDividerFrac}*/\
    {(IfxClock_Pdivider)(2 - 1),(IfxClock_Kdivider)(10 - 1),(IfxClock_Ndivider)(39 - 1),(uint16)(0x525)}
#endif /*#ifndef IFXCLOCK_CFG_APLL_50MHZ_98M304HZ */
...
/*macro for  audio pll initial step configuration */
#define IFXCLOCK_CFG_APLL_INITIAL_STEP_BASIC_(xtalFreq, apllFreq) IFXCLOCK_CFG_APLL_##xtalFreq##_##apllFreq
#define IFXCLOCK_CFG_APLL_INITIAL_STEP_BASIC(xtalFreq, apllFreq)  IFXCLOCK_CFG_APLL_INITIAL_STEP_BASIC_(xtalFreq, apllFreq)
#define IFXCLOCK_CFG_APLL_INITIAL_STEP IFXCLOCK_CFG_APLL_INITIAL_STEP_BASIC(IFXCLOCK_CFG_XTAL_FREQ, IFXCLOCK_CFG_APLL_FREQ)
...
/************** SYSCCUCON1 : GETHDIV  (Output : fGETH)**************/
/* Target = 200 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_GETHDIV_400MHZ
#define IFXCLOCK_CFG_GETHDIV_400MHZ             (2)
#endif /*#ifndef IFXCLOCK_CFG_GETHDIV_400MHZ */
...
#define IFXCLOCK_CFG_SYSCCUCON1_BASIC_(pll0Freq, pll1Freq, pll2Freq) \
    (uint32)( \
		...
		(IFXCLOCK_CFG_GETHDIV_##pll0Freq << IFX_CLOCK_SYSCCUCON1_GETHDIV_OFF) | \
