...
#define QSPI6_SLAVE                 &MODULE_QSPI6   /* SPI Slave module                                             */
...
void initQSPI1Master(void)
{
    ...
    const IfxQspi_SpiMaster_Pins qspi0MasterPins = {
        ...
        &IfxQspi0_MTSR_P22_5_OUT, IfxPort_OutputMode_pushPull,       /* MasterTransmitSlaveReceive pin (MOSI)    */
        &IfxQspi0_MRSTC_P22_6_IN, IfxPort_InputMode_pullDown,        /* MasterReceiveSlaveTransmit pin (MISO)    */
...
void initQSPI1MasterChannel(void)
{
    ...
    const IfxQspi_SpiMaster_Output qspi0SlaveSelect = {                 /* QSPI0 Master selects the QSPI2 Slave     */
        &IfxQspi0_SLSO12_P22_4_OUT, IfxPort_OutputMode_pushPull,       /* Slave Select port pin (CS)               */
...
void initQSPI2Slave(void)
{
    ...
    IfxQspi_SpiSlave_initModuleConfig(&spiSlaveConfig, QSPI6_SLAVE);    /* Initialize it with default values        */

    /* Select the port pins for communication */
    const IfxQspi_SpiSlave_Pins QSPI2SlavePins = {
        &IfxQspi6_SCLKC_P03_1_IN, IfxPort_InputMode_pullDown,           /* SCLK Pin                       (CLK)     */
        &IfxQspi6_MTSRA_P03_2_IN, IfxPort_InputMode_pullDown,           /* MasterTransmitSlaveReceive pin (MOSI)    */
        &IfxQspi6_MRST_P03_0_OUT, IfxPort_OutputMode_pushPull,          /* MasterReceiveSlaveTransmit pin (MISO)    */
        &IfxQspi6_SLSIA_P03_4_IN, IfxPort_InputMode_pullDown,           /* SlaveSelect Pin                (CS)      */
        IfxPort_PadDriver_cmosAutomotiveSpeed3                          /* Pad driver mode                          */
    };
