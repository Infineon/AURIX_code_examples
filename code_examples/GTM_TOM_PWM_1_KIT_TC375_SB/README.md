...
## Board  
The board used for testing is the AURIX&trade; TC375 SB (KIT_A2G_TC375_ARD_SB).

## Scope of work  
The LED is driven by pin 2 of the port 10. The state of the pin is controlled by the PWM signal generated by the TOM timer of GTM.
...
LED (1) is used for this example.

<img src="./Images/TC375_SB_Top_View.png" width="500" />  
...
- *tomChannel* – Selection of the channel which is driving the LED (Channel 2 in this example)
...
## Run and Test
After code compilation and flashing the device, observe the LED (1), which should be fading.

<img src="./Images/TC375_SB_Top_View_Run_and_Test.png" width="500" />  
