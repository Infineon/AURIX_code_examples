 ...
 * IN THE SOFTWARE.
 *********************************************************************************************************************/
 /*\title PWM controlled melody on Buzzer
 ...
 *
 * \name PWM_Buzzer_1_KIT_TC297_TFT
 * \version V1.0.0
 * \board APPLICATION KIT TC2X7 V1.1, KIT_AURIX_TC297_TFT_BC-Step, TC29xTA/TX_BC-step
 * \keywords AURIX, GTM, PWM, PWM_Buzzer_1, buzzer, song
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_PWM_Buzzer_1_KIT_TC297_TFT-TR-v01_00_00-EN.pdf
...
int core0_main(void)
{
    ...
    initPWMBuzzer();    /* Initialize the timer for the PWM */
    startBuzzerSong();  /* Playing Mario's melody           */
