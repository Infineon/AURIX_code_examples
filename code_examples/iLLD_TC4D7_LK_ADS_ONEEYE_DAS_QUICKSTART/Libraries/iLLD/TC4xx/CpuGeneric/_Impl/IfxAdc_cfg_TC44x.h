...
#ifndef IFXADC_CFG_TC44X_H
#define IFXADC_CFG_TC44X_H 1
 ...
 */
#define IFXADC_NUM_CDSP_CORES        (1)
...
typedef enum
{
    ...
    IfxAdc_CdspCore_count = 1   /**< \brief Count */
} IfxAdc_CdspCore;
