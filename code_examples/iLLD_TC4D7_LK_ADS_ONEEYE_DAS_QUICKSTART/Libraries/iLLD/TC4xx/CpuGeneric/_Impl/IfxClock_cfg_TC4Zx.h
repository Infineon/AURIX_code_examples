...
#ifndef IFXCLOCK_CFG_TC4ZX_H
#define IFXCLOCK_CFG_TC4ZX_H 1
...
/** \brief Availability of External Clock MT0
 */
 ...
 */
#define IFXCLOCK_PERPLL_FREQ2_PREDIV                {10u, 11u, 12u, 0u, 14u, 0u, 16u, 17u, 0u, 0u, 20u, 0u, 0u, 0u, 0u, 0u}

/** \brief Ramp oscillator Upper frequency Limit in steps of 10Mhz
 */
#define IFXCLOCK_RAMP_OSC_UPPER_FREQ_LIMIT          (500)
...
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial }*/            \
    {(IfxClock_Pdivider)(2 - 1), (IfxClock_Ndivider)(45 - 1), (IfxClock_K2divider)(3 - 1), (IfxClock_K2PreDivider)(1 - 1)}
...
#define IFXCLOCK_CFG_SYS_PLL_20MHZ_450MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial }*/            \
    {(IfxClock_Pdivider)(2 - 1), (IfxClock_Ndivider)(45 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K2PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_20MHZ_450MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 divider has initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_20MHZ_500MHZ
/**** Macro for Initial Pll step, for profile with 20MHz Crystal and 500MHz target (fDCO= 1GHZ)*/
#define IFXCLOCK_CFG_SYS_PLL_20MHZ_500MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(50 - 1), (IfxClock_K2divider)(10 - 1), (IfxClock_K2PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_20MHZ_500MHZ */
#else
/* Ramp Osc is enabled hence k2 divider has final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_20MHZ_500MHZ
/**** Macro for Initial Pll step, for profile with 20MHz Crystal and 500MHz target (fDCO= 1GHZ)*/
#define IFXCLOCK_CFG_SYS_PLL_20MHZ_500MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(50 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K2PreDivider)(2 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_20MHZ_500MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 divider has initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_25MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 25MHz Crystal and 450MHz target (fDCO= 450)*/
#define IFXCLOCK_CFG_SYS_PLL_25MHZ_450MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider }*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(18 - 1), (IfxClock_K2divider)(3 - 1), (IfxClock_K2PreDivider)(1 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_25MHZ_450MHZ */
#else
/* Ramp Osc is enabled hence k2 divider has final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_25MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 25MHz Crystal and 450MHz target (fDCO= 450)*/
#define IFXCLOCK_CFG_SYS_PLL_25MHZ_450MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider }*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(18 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K2PreDivider)(1 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_25MHZ_450MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence  k2 divider has initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_25MHZ_500MHZ
/**** Macro for Initial Pll step, for profile with 25MHz Crystal and 500MHz target (fDCO= 1GHz)*/
#define IFXCLOCK_CFG_SYS_PLL_25MHZ_500MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider }*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(40 - 1),  (IfxClock_K2divider)(10 - 1), (IfxClock_K2PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_25MHZ_500MHZ */
#else
/* Ramp Osc is enabled hence  k2 divider has final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_25MHZ_500MHZ
/**** Macro for Initial Pll step, for profile with 25MHz Crystal and 500MHz target (fDCO= 1GHz)*/
...
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(80 - 1), (IfxClock_K2divider)(8 - 1), (IfxClock_K2PreDivider)(1 - 1)}
...
#define IFXCLOCK_CFG_SYS_PLL_10MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(80 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K2PreDivider)(2 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_10MHZ_400MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 divider has initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_10MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 10MHz Crystal and 450MHz target (fDCO= 450)*/
#define IFXCLOCK_CFG_SYS_PLL_10MHZ_450MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider }*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(45 - 1), (IfxClock_K2divider)(3 - 1), (IfxClock_K2PreDivider)(1 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_10MHZ_450MHZ */
#else
/* Ramp Osc is enabled hence k2 divider has final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_10MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 10MHz Crystal and 450MHz target (fDCO= 450)*/
#define IFXCLOCK_CFG_SYS_PLL_10MHZ_450MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider }*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(45 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K2PreDivider)(1 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_10MHZ_450MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence  k2 divider has initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_10MHZ_500MHZ
/**** Macro for Initial Pll step, for profile with 10MHz Crystal and 500MHz target (fDCO= 500)*/
#define IFXCLOCK_CFG_SYS_PLL_10MHZ_500MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider }*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(50 - 1), (IfxClock_K2divider)(5 - 1), (IfxClock_K2PreDivider)(1 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_10MHZ_500MHZ */
#else
/* Ramp Osc is enabled hence  k2 divider has final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_10MHZ_500MHZ
/**** Macro for Initial Pll step, for profile with 10MHz Crystal and 500MHz target (fDCO= 500)*/
#define IFXCLOCK_CFG_SYS_PLL_10MHZ_500MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider }*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(50 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K2PreDivider)(1 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_10MHZ_500MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 divider has initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 40MHz Crystal and 450MHZ target (fDCO= 450)*/
#define IFXCLOCK_CFG_SYS_PLL_40MHZ_450MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDividerc}*/            \
    {(IfxClock_Pdivider)(4 - 1), (IfxClock_Ndivider)(45 - 1), (IfxClock_K2divider)(3 - 1), (IfxClock_K2PreDivider)(1 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_450MHZ */
#else
/* Ramp Osc is enabled hence k2 divider has final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 40MHz Crystal and 450MHz target (fDCO= 450)*/
#define IFXCLOCK_CFG_SYS_PLL_40MHZ_450MHZ                          \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider }*/            \
    {(IfxClock_Pdivider)(4 - 1), (IfxClock_Ndivider)(45 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K2PreDivider)(1 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_450MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 divider has initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_500MHZ
/**** Macro for Initial Pll step, for profile with 40MHz Crystal and 500MHz target (fDCO= 500)*/
#define IFXCLOCK_CFG_SYS_PLL_40MHZ_500MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider }*/            \
    {(IfxClock_Pdivider)(2 - 1), (IfxClock_Ndivider)(25 - 1), (IfxClock_K2divider)(5 - 1), (IfxClock_K2PreDivider)(1 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_500MHZ */
#else
/* Ramp Osc is enabled hence k2 divider has final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_500MHZ
/**** Macro for Initial Pll step, for profile with 40MHz Crystal and 500MHz target (fDCO= 500)*/
#define IFXCLOCK_CFG_SYS_PLL_40MHZ_500MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider }*/            \
    {(IfxClock_Pdivider)(2 - 1), (IfxClock_Ndivider)(25 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K2PreDivider)(1 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_500MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 divider has initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 50MHz Crystal and 450MHZ target (fDCO= 450)*/
#define IFXCLOCK_CFG_SYS_PLL_50MHZ_450MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(9 - 1), (IfxClock_K2divider)(3 - 1), (IfxClock_K2PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_450MHZ */
#else
/* Ramp Osc is enabled hence k2 divider have final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 50MHz Crystal and 450MHz target (fDCO= 450)*/
#define IFXCLOCK_CFG_SYS_PLL_50MHZ_450MHZ                          \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(9 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K2PreDivider)(1 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_450MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 divider has initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_500MHZ
/**** Macro for Initial Pll step, for profile with 50MHz Crystal and 500MHz target (fDCO= 500)*/
#define IFXCLOCK_CFG_SYS_PLL_50MHZ_500MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(10 - 1), (IfxClock_K2divider)(5 - 1), (IfxClock_K2PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_500MHZ */
#else
/* Ramp Osc is enabled hence k2 divider has final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_500MHZ
/**** Macro for Initial Pll step, for profile with 50MHz Crystal and 500MHz target (fDCO= 500)*/
#define IFXCLOCK_CFG_SYS_PLL_50MHZ_500MHZ                         \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(10 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K2PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_500MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
/******************************* OSCCON DEFAULT ******************************************/
#ifndef IFX_CLOCK_OSCCON_GAINSEL_VAL
#define IFX_CLOCK_OSCCON_GAINSEL_VAL             (3)
#endif
...
#ifndef IFX_CLOCK_OSCCON_HYSCTL_VAL
#define IFX_CLOCK_OSCCON_HYSCTL_VAL              (0)
#endif
...
/************** SYSCCUCON0 : SPBDIV  (Output : fSPB)**************/
/* Target = 90 MHz AND Source = Fsource0 */
...
/************** SYSCCUCON1 : GETHDIV  (Output : fGETH)**************/
/* Target = 225 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_GETHDIV_450MHZ
#define IFXCLOCK_CFG_GETHDIV_450MHZ             (2)
#endif /*#ifndef IFXCLOCK_CFG_GETHDIV_450MHZ */
...
/************** SYSCCUCON1 : GETHDIV  (Output : fGETH)**************/
/* Target = 250 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_GETHDIV_500MHZ
#define IFXCLOCK_CFG_GETHDIV_500MHZ             (2)
#endif /*#ifndef IFXCLOCK_CFG_GETHDIV_500MHZ */
...
#define IFXCLOCK_CFG_OSCCON_MASK \
    (uint32)( \
        (IFX_CLOCK_OSCCON_GAINSEL_MSK << IFX_CLOCK_OSCCON_GAINSEL_OFF) | \
        (IFX_CLOCK_OSCCON_APREN_MSK << IFX_CLOCK_OSCCON_APREN_OFF) | \
        (IFX_CLOCK_OSCCON_HYSEN_MSK << IFX_CLOCK_OSCCON_HYSEN_OFF) | \
        (IFX_CLOCK_OSCCON_HYSCTL_MSK << IFX_CLOCK_OSCCON_HYSCTL_OFF) | \
...
#define IFXCLOCK_CFG_OSCCON_VALUE \
    (uint32)( \
        (IFX_CLOCK_OSCCON_GAINSEL_VAL << IFX_CLOCK_OSCCON_GAINSEL_OFF) | \
        (IFX_CLOCK_OSCCON_APREN_VAL << IFX_CLOCK_OSCCON_APREN_OFF) | \
        (IFX_CLOCK_OSCCON_HYSEN_VAL << IFX_CLOCK_OSCCON_HYSEN_OFF) | \
        (IFX_CLOCK_OSCCON_HYSCTL_VAL << IFX_CLOCK_OSCCON_HYSCTL_OFF) | \
...
#define IFXCLOCK_CFG_SYSCCUCON0_MASK \
    (uint32)( \
        ...
        (IFX_CLOCK_SYSCCUCON0_FSI2DIV_MSK << IFX_CLOCK_SYSCCUCON0_FSI2DIV_OFF) |\
...
#define IFXCLOCK_CFG_SYSCCUCON0_BASIC_(pll0Freq, pll1Freq, pll2Freq) \
    (uint32)( \
        ...
        (IFXCLOCK_CFG_FSI2DIV_##pll0Freq << IFX_CLOCK_SYSCCUCON0_FSI2DIV_OFF) |\
...
#define IFXCLOCK_CFG_PERCCUCON1_MASK \
    (uint32)( \
		...
		(IFX_CLOCK_PERCCUCON1_SDMMCPERON_MSK << IFX_CLOCK_PERCCUCON1_XSPIPERON_OFF) | \
...
#define IFXCLOCK_CFG_PFLASH_WAITSTATE_VAL (11)
#endif
