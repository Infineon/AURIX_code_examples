...
#ifndef IFXNVMR_CFG_TC45X_H
#define IFXNVMR_CFG_TC45X_H 1
 ...
 */
#define IFXNVMR_DNVM_EEPROM_SIZE          (0x10000u)
 ...
 */
#define IFXNVMR_PNVM10_START              (0xA0200000)
 ...
 */
#define IFXNVMR_CFG_FLASH_WAITSTATE       (7u)
 ...
 */
#define IFXNVMR_INJECT_PNVM_DNVM_ECC_ERROR   (TRUE)

/** \brief PNVM request operations sleep, wait.
 */
#define IFXNVMR_PNVM_REQUEST_OPERATION       (FALSE)

/** \brief DNVM request operations sleep, wait.
 */
#define IFXNVMR_DNVM_REQUEST_OPERATION       (FALSE)

/** \brief Gets the PNVM tight margin read error status.
 */
#define IFXNVMR_PNVM_GET_ERROR_STATUS        (FALSE)

/** \brief Gets the DNVM tight margin read error status.
 */
#define IFXNVMR_DNVM_GET_ERROR_STATUS        (FALSE)
...
typedef enum
{
    ...
    IfxNvmr_Pnvm_1A = 0x01   /**< \brief PRRAM A for CPU1 */
} IfxNvmr_Pnvm;
