...
#define TX_ID_BYTE          0x80                                /* Set the LIN ID byte to a random number           */
#define ID_BYTE             0x80                                /* Set the LIN ID byte to a random number           */


extern IfxAsclin_Lin_Pins Lin_Master_pins;
...
void init_ASCLIN_LIN_master(void)
{
    ...
    linMasterConfig.pins = &Lin_Master_pins;                               /* Port pins configuration                          */
