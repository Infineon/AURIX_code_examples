 ...
 *              like "info" or "help".
 *
 * \name OneEye_UART_Shell_1_KIT_TC397_TFT
 * \version V1.0.0
 * \board APPLICATION KIT TC3X7 V2.0, KIT_A2G_TC397_5V_TFT, TC39xXX_B-Step
 * \keywords OneEye, UART, USB, Shell, AURIX
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_OneEye_UART_Shell_1_KIT_TC397_TFT-TR-v01_00_00-EN.pdf
