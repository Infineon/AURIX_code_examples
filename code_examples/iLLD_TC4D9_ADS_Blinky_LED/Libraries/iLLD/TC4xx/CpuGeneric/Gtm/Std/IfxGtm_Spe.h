...
{
    Ifx_UReg_32Bit valid : 1;       /**< \brief validity of the specified Pattern */
    Ifx_UReg_32Bit pattern : 3;     /**< \brief Input Signal for SPE */
} IfxGtm_Spe_PatternSignal;
 ...
 *
 * \param[inout] spe       Pointer to the spe device.
 * \param[in]    interrupt Interrupt signal. Range: \ref IfxGtm_Spe_InterruptSignal.
 *
 * \retval None
 */
 ...
 * \param[in]    inputSignal Input signal. Range: \ref IfxGtm_Spe_InputSignal.
 ...
 *
 * \retval uint32 Actual input pattern. Range: 0 to 7.
 */
 ...
 *
 * \param[inout] spe     Pointer to the spe device.
 * \param[in]    pattern Actual input pattern. Range: 0 to 7.
 *
 * \retval None
 */
 ...
 * \param[in] spe Pointer to the spe device.
 *
 * \retval uint32 Current pattern pointer. Range: 0 to 7.
 */
 ...
 * \param[in] spe Pointer to the spe device.
 *
 * \retval IfxGtm_Spe_ControlCommand Control command selection. Range: \ref IfxGtm_Spe_ControlCommand.
 */
 ...
 * \param[in] spe Pointer to the spe device.
 *
 * \retval IfxGtm_Spe_Direction IfxGtm_Spe_Direction Direction. Range: \ref IfxGtm_Spe_Direction.
 */
 ...
 *
 * \param[in] spe Pointer to the spe device.
 * \param[in] channel TOM[x] output channel. Range: \ref IfxGtm_Spe_OutChannel.
 *
 * \retval uint32 Fast shutoff level. Range: 0 to 0xFF.
 */
 ...
 * \param[in] spe Pointer to the spe device.
 *
 * \retval uint32 New input pattern. Range: 0 to 7.
 */
IFX_INLINE uint32 IfxGtm_Spe_getNewInputPat(Ifx_GTM_CLS_SPE *spe);

/** \brief Gets the output control register (OUT_CTRL) as a whole word to read the current output pattern.
 *
 * \param[in] spe Pointer to the spe device.
 *
 * \retval uint32 Output control register as whole word. Range: 0 to 0xFFFF.
 */
 ...
 *
 * \param[in] spe      Pointer to the spe device.
 * \param[in] patIndex Step or index number of the pattern specified. Range: \ref IfxGtm_Spe_PatternIndex.
 *
 * \retval uint32 Output pattern as whole word. Range: 0 to 0xFFFF.
 */
 ...
 * \param[in] spe Pointer to the spe device.
 *
 * \retval IfxGtm_Spe_Direction Previous Direction. Range: \ref IfxGtm_Spe_Direction.
 */
 ...
 * \param[in] spe Pointer to the spe device.
 *
 * \retval uint32 Previous input pattern. Range: 0 to 7.
 */
 ...
 *
 * \param[inout] spe     Pointer to the spe device.
 * \param[in]    pattern Previous input pattern. Range: 0 to 7.
 *
 * \retval None
 */
 ...
 * \param[in] spe Pointer to the spe device.
 *
 * \retval uint32 Step counter. Range: 0 to 0xFFFFFF.
 */
 ...
 *
 * \param[inout] spe      Pointer to the spe device.
 * \param[in]    timInput TIM input signal to be selected. Range: \ref IfxGtm_Spe_TimInput.
 *
 * \retval None
 */
IFX_INLINE void IfxGtm_Spe_selectTimInput(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_TimInput timInput);

/** \brief Selects the source which will trigger the spe control output.
 *
 * \param[inout] spe     Pointer to spe device.
 * \param[in]    trigger Trigger source. Range: \ref IfxGtm_Spe_TriggerSource.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] spe Pointer to the spe device.
 * \param[in]    cmd Control command selection. Range: \ref IfxGtm_Spe_ControlCommand.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] spe  Pointer to the spe device.
 * \param[in]    mode Interrupt mode. Range: \ref IfxGtm_Spe_InterruptMode.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] spe   Pointer to the spe device.
 * \param[in]    count Step counter value. Range: 0 to 0xFFFFFF.
 *
 * \retval None
 */
...
IFX_INLINE void IfxGtm_Spe_setInputPattern(Ifx_GTM_CLS_SPE *spe, IfxGtm_Spe_InputPattern *patPtr, IfxGtm_Spe_PatternIndex patIndex)
{
    ...
    spe->PAT.U |= ((uint32)(pattern & 0xFu) << ((uint32)patIndex * (IFX_GTM_CLS_SPE_PAT_IP1_PAT_OFF - IFX_GTM_CLS_SPE_PAT_IP0_PAT_OFF)));
}
