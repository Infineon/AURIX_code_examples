...
IFX_INLINE sint16 IfxAdc_readTmadcResult(IfxAdc_TmadcModule moduleId, IfxAdc_TmadcResultReg resultReg)
{
#if defined(DEVICE_TC4DX) || defined(DEVICE_TC48XAA) || defined(DEVICE_TC48X) || defined(DEVICE_TC45X) 
...
#endif /* #if defined(DEVICE_TC4DX) || defined(DEVICE_TC48XAA) || defined(DEVICE_TC48X) || defined(DEVICE_TC45X) */
}
