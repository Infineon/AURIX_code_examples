...
/** \Alias type used in Fcc module to represent ADC interrupt configuration. Maps IfxAdc_Fcc_InterruptConfig to the generic IfxAdc_SrvReq structure,
  ...
  */
typedef IfxAdc_SrvReq IfxAdc_Fcc_InterruptConfig;
...
typedef struct
{
    uint16 deltaMinus;       /**< \brief Delta MInus. Range: 0 to 0xFFFF */
    uint16 deltaPlus;        /**< \brief Delta Plus. Range: 0 to 0xFFFF */
...
typedef struct
{
    ...
    uint16                delayCount;       /**< \brief Trigger delay count. Range: 0 to 0xFFFF */
} IfxAdc_Fcc_Trigger;
...
typedef struct
{
    ...
    boolean                      selectBoundaryFlag;         /**< \brief Range: TRUE: Software BFL, FALSE: Hardware BFL */
    boolean                      swBoundaryFlagValue;        /**< \brief Range:TRUE: Set BFL, FALSE: Clear BFL */
    boolean                      enableboundary;             /**< \brief Range:TRUE: Boundary flag mode enable, FALSE: Boundary flag mode disable */
...
typedef struct
{
    uint16                  stepWidth;       /**< \brief Step width for reference value. Range: 0 to 0xFFFF */
    uint16                  stepSize;        /**< \brief Step size for reference value. Range: 0 to 0x3FF */
    uint16                  startTV;         /**< \brief Start Threshold value. Range: 0 to 0x3FF */
    uint16                  endTV;           /**< \brief End Threshold value. Range: 0 to 0x3FF */
    IfxAdc_FccRampDirection rampDir;         /**< \brief Ramp direction. Range: \ref IfxAdc_FccRampDirection  */
...
typedef struct
{
    ...
    uint8                            filterDepth;       /**< \brief Glitch filter depth value. Range: 0 to 0xFF */
    uint16                           initialTv;         /**< \brief Fcc initial threshold value. Range: 0 to 0x3FF */
 ...
 *
 * \param[inout] fcc    Fcc pointer to the module handle
 ...
 * \param[in]    rampConfig Ramp configuration
 *
 * \retval None
 */
...
/** \brief Function to trigger FCC threshold update by software
 *
 * \param[inout] fcc Pointer to Fcc module sfr
 *
 * \retval None
 */
IFX_INLINE void IfxAdc_Fcc_triggerThresholdUpdate(Ifx_ADC_FCC *fcc);
