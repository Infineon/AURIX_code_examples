...
#if defined(DEVICE_TC49XN) || defined(DEVICE_TC48XAA) || defined(DEVICE_TC48X) || defined(DEVICE_TC48X) || defined(DEVICE_TC46X) || defined(DEVICE_TC4EX) || defined(DEVICE_TC4PX)
 ...
 * \param[in] channelId     EXMOD, DSADC channel ID
 *                          Range: 0 to 9
 * \param[in] hasAnalogMod  Set to TRUE for DSADC channels
 ...
 *
 * \param[in] filterChainCfg Pointer to the Filter Chain configuration
 * \param[in] channelId      EXMOD, DSADC channel ID
 *                           Range: 0 to 9
 * \param[in] hasAnalogMod   Set to TRUE for DSADC channels
 *
 ...
 *
 * \param[in] boundaryCfg  Pointer to boundary configuration
 * \param[in] channelId    EXMOD, DSADC channel ID
 *                         Range: 0 to 9
 * \param[in] hasAnalogMod True  --> Function is intended to be used for Dsadc channel
 *                         FALSE --> Function is intended to be used for Exmod channel
 *
 * \retval None
 */
 ...
 *
 * \param[in] queue        Pointer to queue configuration
 * \param[in] channel      Pointer to handle of DSADC/EXMOD channel
 * \param[in] hasAnalogMod TRUE --> Function is intended to be used for Dsadc channel
 *                         FALSE --> Function is intended to be used for Exmod channel
 *
 * \retval None
 ...
 *
 * \param[inout] channel Pointer to dsadc/exmod channel handle
 *
 * \retval None
 */
 ...
 *
 * \param[in] channel      Pointer to dsadc/exmod channel handle
 * \param[in] hasAnalogMod True  --> Function is intended to be used for Dsadc channel
 *                         FALSE --> Function is intended to be used for Exmod channel
 *
 ...
 *
 * \param[inout] channel      Pointer to dsadc/Exmod channel handle
 * \param[in]    resBuff      Buffer to store result
 ...
 *
 * \param[in] channel      Pointer to dsadc/Exmod channel handle
 * \param[in] hasAnalogMod Range: True  --> Function is intended to be used for Dsadc channel
 *                                FALSE --> Function is intended to be used for Exmod channel
 *
 * \retval Return valid result from the buffer
 * Range: 0 to 0xFFFF
 */
...
#if defined(DEVICE_TC48XAA) || defined(DEVICE_TC48X) || defined(DEVICE_TC48X)
...
#endif /* #if defined(DEVICE_TC48XAA) || defined(DEVICE_TC48X) || defined(DEVICE_TC48X) */
...
#endif /* #if defined(DEVICE_TC49XN) || defined(DEVICE_TC48XAA) || defined(DEVICE_TC48X) || defined(DEVICE_TC46X) || defined(DEVICE_TC4EX) */
