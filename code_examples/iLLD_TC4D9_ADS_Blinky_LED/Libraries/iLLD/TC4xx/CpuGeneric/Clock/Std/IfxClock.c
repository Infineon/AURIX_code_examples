...
#if defined(DEVICE_TC48XAA) || defined(DEVICE_TC48X) || defined(DEVICE_TC46X) || defined(DEVICE_TC45X) || defined(DEVICE_TC44X) || defined(DEVICE_TC4ZX) || defined(DEVICE_TC4EX) || defined(DEVICE_TC4PX)
#include "IfxDmur_reg.h"
#include "IfxPmur_reg.h"
#endif /* #if defined(DEVICE_TC48XAA) || defined(DEVICE_TC48X) || defined(DEVICE_TC46X) || defined(DEVICE_TC45X) || defined(DEVICE_TC44X) || defined(DEVICE_TC4ZX) || defined(DEVICE_TC4EX) */
...
#else
		DMUR0_UR_DRWAIT.B.VALUE  = config->flashFconWaitStateConfig->dFlashWaitCycles;
        PMUR0A_UR_PRWAIT.B.VALUE = config->flashFconWaitStateConfig->pFlashWaitCycles;
#endif /* #if defined(DEVICE_TC4DX) || defined(DEVICE_TC49XN) */
    }
...
uint32 IfxClock_getExtClock1Frequency(void)
{
    ...
    if (CLOCK_EXTCON.B.EN1)
    {
        ...
        case 0x1E:
            freq = IfxClock_getPerPllFrequency3();
            break;
...
#if defined(DEVICE_TC49XN) || defined(DEVICE_TC46X) || defined(DEVICE_TC45X) || defined(DEVICE_TC4EX) || defined(DEVICE_TC4PX)		
uint32 IfxClock_getPpuFrequency(void)
{
    uint32 frequency = IfxClock_getSriFrequency();
