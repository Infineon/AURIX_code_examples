 ...
 *
 * \param[in] gpt12 Pointer to module base address.
 *
 * \retval Ifx_SRC_SRCR* Address of timer 2 Interrupt.
 */
 ...
 * \param[in] gpt12 Pointer to module base address.
 *
 * \retval Ifx_SRC_SRCR* Address of  Timer 3 Interrupt.
 */
 ...
 * \param[in] gpt12 Pointer to module base address.
 *
 * \retval Ifx_SRC_SRCR* Address of timer 4 interrupt.
 */
 ...
 * \param[in] gpt12 Pointer to module base address.
 *
 * \retval Ifx_SRC_SRCR* Address of Timer 5 Interrupt.
 */
 ...
 * \param[in] gpt12 Pointer to module base address.
 *
 * \retval Ifx_SRC_SRCR* Address of Timer 6 interrupt.
 */
 ...
 * \param[in] gpt12 Pointer to module base address.
 *
 * \retval Ifx_SRC_SRCR* Address of capture Interrupt.
 */
 ...
 *
 * \param[inout] gpt12     Pointer to module base address.
 * \param[in]    inputMode Input prescaler value in capture mode. Range: \ref IfxGpt12_CaptureInputMode.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] gpt12  Pointer to module base address.
 * \param[in]    source Direction source. Range: \ref IfxGpt12_TimerDirectionSource.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] gpt12   Pointer to module base address.
 * \param[in]    enabled Enable/Disable choice.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] gpt12           Pointer to module base address
 * \param[in]    inputMode input Prescaler value in reload mode. Range: \ref IfxGpt12_ReloadInputMode.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] gpt12  Pointer to module base address.
 * \param[in]    enable Enable / disable choice for T3OE.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] gpt12 Pointer to module base address.
 * \param[in]    mode  Select the capture trigger mode. Range: \ref IfxGpt12_CaptureTriggerMode.
 *
 * \retval None
 */
 ...
 *
 * \param[in] capIn     The TxIn Pin which should be configured.
 ...
 *
 * \param[in] txOut      The TxOUT Pin which should be configured.
 ...
 * \param[inout] gpt12 Pointer to module base address
 * \param[in]    bps1  Select the GPT1 block Prescaler. Range: \ref IfxGpt12_Gpt1BlockPrescaler.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] gpt12 Pointer to module base address.
 * \param[in]   bps2   Select the GPT2 block Prescaler. Range: \ref IfxGpt12_Gpt2BlockPrescaler.
 *
 * \retval None
 */
 ...
 *
 * \param[in] txEudIn   The TxEUD_IN Pin which should be configured.
 * \param[in] inputMode The pin input mode which should be configured. Range: \ref IfxPort_InputMode.
 *
 * \retval None
 */
 ...
 *
 * \param[in] txIn      The TxIn Pin which should be configured.
 * \param[in] inputMode The pin input mode which should be configured. Range: \ref IfxPort_InputMode.
 *
 * \retval None
 */
 ...
 * \param[in] gpt12 Pointer to module base address.
 *
 * \retval IfxGpt12_Mode Mode of operation. Range: \ref IfxGpt12_Mode.
 */
 ...
 * \param[in] gpt12 Pointer to module base address.
 *
 * \retval uint16 Timer current value. Range: 0 to 0xFFFF.
 */
 ...
 * \param[in] gpt12 Pointer to module base address.
 *
 * \retval float32 Gpt12 module frequency.
 */
 ...
 *
 * \param[inout] gpt12    Pointer to Module base address.
 * \param[in]    runTimer Start/stop Timer 2. Range: \ref IfxGpt12_TimerRun.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] gpt12 Pointer to module base address.
 * \param[in]    value Timer Value. Range: 0 to 0xFFFF.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] gpt12    Pointer to module base address.
 * \param[in]    runTimer Start/stop Timer 3. Range: \ref IfxGpt12_TimerRun.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] gpt12    Pointer to module base address
 * \param[in]    runTimer Start/stop Timer 5. Range: \ref IfxGpt12_TimerRun.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] gpt12    Pointer to module base address.
 * \param[in]    runTimer Start/stop Timer 6. Range: \ref IfxGpt12_TimerRun.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] gpt12 Pointer to GPT12 registers.
 * \param[in]    value Reload value. Range: 0 to 0xFFFF.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] gpt12 Pointer to GPT12 module registers.
 * \param[in] mode Module suspend mode. Range: \ref IfxGpt12_SuspendMode.
 *
 * \retval None
 */
 ...
 *
 * \param[in] gpt12 Pointer to GPT12 module registers.
 *
 ...
 *
 * \param[in] gpt12 GPT12 Module pointer.
 *
 * \retval IfxGpt12_Index GPT12 resource index. Range: \ref IfxGpt12_Index.
 */
 ...
 *
 * \param[inout] gpt12  GPT12 module pointer.
