...
# iLLD_TC4D9_ADS_Blinky_LED

**An LED is blinking based on the timing given by a wait function.**  

## Device  
The device used in this example is AURIX&trade; TC4D9XP_A-Step_CC_COM

## Board  
The board used for testing is the AURIX&trade; TC4D9 COM TriBoard (KIT_TC4D9_COM_TRB)

## Scope of work   
A wait function is used to add delays between switching on and switching off an LED on port pin P33.0
...
## Hardware setup  
This code example has been developed for the board KIT_TC4D9_COM_TRB (AURIX&trade; TC4D9 COM TriBoard).

<img src="./Images/KIT_TC4D9_COM_TRB.PNG" width="800" />    
...
## Run and Test   
After code compilation and flashing the device, observe the LED P33.0 which is blinking at a frequency of approximately 1 Hz.

<img src="./Images/KIT_TC4D9_COM_TRB_S.PNG" width="800" />  
