...
typedef struct _Ifx_LLI_ALCLR_Bits
{
    ...
    __IO Ifx_Strict_32Bit WPSTMADC:1;      /**< \brief [2:2] Clear alarm event status for LLI slave port connected toTMADC (rwh) */
    __I  Ifx_Strict_32Bit :1;              /**< \brief [3:3] \internal Reserved */
    __IO Ifx_Strict_32Bit WPSEGTM:1;       /**< \brief [4:4] Clear alarm event status for LLI slave port connected to eGTM slave interface (rwh) */
    ...
    __IO Ifx_Strict_32Bit STMADC:1;        /**< \brief [10:10] Clear alarm event status for AXI slave interface on TMADC (rwh) */
    __I  Ifx_Strict_32Bit :1;              /**< \brief [11:11] \internal Reserved */
    __IO Ifx_Strict_32Bit SEGTM:1;         /**< \brief [12:12] Clear alarm event status for AXI slave interface on eGTM (rwh) */
...
typedef struct _Ifx_LLI_ALEV_Bits
{
    ...
    __I  Ifx_Strict_32Bit WPSTMADC:1;      /**< \brief [2:2] Alarm event for LLI slave port connected to TMADC (rh) */
    __I  Ifx_Strict_32Bit :1;              /**< \brief [3:3] \internal Reserved */
    __I  Ifx_Strict_32Bit WPSEGTM:1;       /**< \brief [4:4] Alarm event for LLI slave port connected to eGTM slave interface (rh) */
    ...
    __I  Ifx_Strict_32Bit STMADC:1;        /**< \brief [10:10] Alarm event for AXI slave interface on TMADC (rh) */
    __I  Ifx_Strict_32Bit :1;              /**< \brief [11:11] \internal Reserved */
    __I  Ifx_Strict_32Bit SEGTM:1;         /**< \brief [12:12] Alarm event for AXI slave interface on eGTM (rh) */
...
/** \brief Error injection from a nominated slave interface. Consult device specific chapters. */
...
typedef volatile struct _Ifx_LLI
{
       ...
       __IO Ifx_LLI_SEGEN                       SEGEN;                  /**< \brief 18, Error injection from a nominated slave interface. Consult device specific chapters.*/
