...
# iLLD_TC467_LK_ADS_STM_Interrupt 
...
## Run and Test   
After code compilation and flashing the device, observe the LED1(P22.7), which should be blinking at a frequency of about 1 Hz.
  

<img src="./Images/LED_Blinking.gif" width="850" />  
