 ...
 * IN THE SOFTWARE.
 *********************************************************************************************************************/
 /*\title Emergency stop triggered by an SMU alarm
 ...
 *
 * \name SMU_Emergency_Stop_Alarm_1_KIT_TC297_TFT
 * \version V1.0.0
 * \board APPLICATION KIT TC2X7 V1.1, KIT_AURIX_TC297_TFT_BC-Step, TC29xTA/TX_B-Step
 * \keywords AURIX, SMU, SMU_Emergency_Stop_Alarm_1, alarm, emergency stop
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_SMU_Emergency_Stop_Alarm_1_KIT_TC297_TFT-TR-v01_00_00-EN.pdf
...
int core0_main(void)
{
    ...
    config_SMU_Emergency_Stop();  /* Call the configuration function of the SMU  */
    trigger_SMU_Emergency_Stop(); /* Call the triggering function of the Alarm 0 */
