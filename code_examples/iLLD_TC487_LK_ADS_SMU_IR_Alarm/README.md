...
# iLLD_TC487_LK_ADS_SMU_IR_Alarm

**SMU_SAFE0 Software Alarm 0 triggers an interrupt request to CPU0**    

## Device  
The device used in this example is AURIX&trade; TC487QP_A-Step_MC_COM 
...
## Hardware setup  
This code example has been developed for the board  AURIX&trade; TC487 lite Kit (KIT_A3G_TC487_LITE). A debugger is needed to step through the code and see when the software alarm is triggered.
 
<img src="./Images/KIT_TC487_LK_Front.png" width="800" />
...
When running the code, observe that the LED P03.9 is initially turned off. Then, by allowing the code execution to continue after the breakpoint, observe that the LED P22.7 is turned on.  
