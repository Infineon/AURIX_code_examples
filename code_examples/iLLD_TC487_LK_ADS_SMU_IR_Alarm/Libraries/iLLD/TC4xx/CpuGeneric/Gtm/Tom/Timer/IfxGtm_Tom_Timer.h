...
typedef struct
{
    Ifx_Priority   isrPriority;       /**< \brief Interrupt Priority, if 0 the interrupt is disable. Range: 0 to 0xFF */
...
typedef struct
{
    ...
    uint16                     triggerPoint;             /**< \brief Trigger point in timer ticks. Range: 0 to 0xFFFF */
...
typedef struct
{
    ...
    uint16                    channelsMask[IFXGTM_TOM_NUM_TGC];                        /**< \brief Mask for channels to be modified together, The 1st value corresponds to the Timer's TGC, the 2nd value corresponds to the timer's next TGC if any. Range: 0 to 0xFFFF */
    uint32                    offset;                                                  /**< \brief Timer initial offset in ticks. Range: 0 to 0xFFFF */
    uint32                    tgcGlobalControlDisableUpdate[IFXGTM_TOM_NUM_TGC];       /**< \brief Cached value for TGC GLOB_CTR. Range: 0 to 0xFFFF */
    uint32                    tgcGlobalControlApplyUpdate[IFXGTM_TOM_NUM_TGC];         /**< \brief Cached value for TGC GLOB_CTR. Range: 0 to 0xFFFF */
 ...
 *
 * \retval uint32 Returns the initial timer offset in ticks. Range: 0 to 0xFFFF.
 */
 ...
 * \param[in] driver TOM Timer interface Handle.
 *
 * \retval volatile uint32* Pointer.
 */
 ...
 *
 * \param[inout] driver  TOM Timer interface Handle.
 * \param[in]    channel Channel to ba added to the mask. Range: \ref IfxGtm_Tom_Ch.
 *
 * \retval None
 */
 ...
 * \param[in] driver TOM Timer interface Handle.
 *
 * \retval uint16 Period. Range: 0 to 0xFFFF.
 */
 ...
 * \param[in] driver TOM Timer interface Handle.
 *
 * \retval uint16 Trigger point. Range: 0 to 0xFFFF.
 */
 ...
 *
 * \param[inout] driver TOM Timer interface Handle.
 * \param[in]    period Period value. Range: 0 to 0xFFFF.
 *
 * \retval TRUE on success else FALSE.
 */
 ...
 *
 * \param[inout] driver       TOM Timer interface Handle.
 * \param[in]    triggerPoint Trigger point value. Range: 0 to 0xFFFF.
 *
 * \retval None
 */
