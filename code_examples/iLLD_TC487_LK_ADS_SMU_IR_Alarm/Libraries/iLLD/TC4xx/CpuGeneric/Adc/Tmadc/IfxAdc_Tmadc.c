...
{
#if defined(DEVICE_TC4DX) || defined(DEVICE_TC48X) || defined(DEVICE_TC48XA21) || defined(DEVICE_TC45X) || defined(DEVICE_TC4ZX) 
    ...
    return channel->rsltSFR->B.RESULT;     /* read result */
#endif /* #if defined(IFX_ILLD_PPU_USAGE) */
#endif /* #if defined(DEVICE_TC49XN) || defined(DEVICE_TC48X) || defined(DEVICE_TC48XA21) || defined(DEVICE_TC45X) || defined(DEVICE_TC4ZX) */
}
...
uint16 IfxAdc_Tmadc_readTimestamp(IfxAdc_Tmadc_Ch *channel)
{
    ...
    timeStamp = channel->tmstmpSFR->B.TIMESTAMP;
#endif /* #if defined(IFX_ILLD_PPU_USAGE) */
#endif /* #if defined(DEVICE_TC4DX) || defined(DEVICE_TC48X) || defined(DEVICE_TC48XA21) || defined(DEVICE_TC45X) || defined(DEVICE_TC4ZX) */
    return timeStamp;
}
