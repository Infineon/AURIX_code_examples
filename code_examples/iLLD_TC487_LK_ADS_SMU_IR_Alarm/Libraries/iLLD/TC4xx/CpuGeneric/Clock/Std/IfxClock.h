...
#if defined(DEVICE_TC48X) || defined(DEVICE_TC48XA21) || defined(DEVICE_TC46X) || defined(DEVICE_TC44X) || defined(DEVICE_TC4ZX) || defined(DEVICE_TC4EX) || defined(DEVICE_TC4PX)	
/** \brief 100 micro seconds wait time after LCK lock bit set
 */
#ifndef IFXCLOCK_CCUSTAT_LCKLOCK_WAITTIME
#define IFXCLOCK_CCUSTAT_LCKLOCK_WAITTIME            (0.0001f)
#endif
#endif /* #if defined(DEVICE_TC48X) || defined(DEVICE_TC48XA21) || defined(DEVICE_TC46X) || defined(DEVICE_TC44X) || defined(DEVICE_TC4ZX) || defined(DEVICE_TC4EX) */
