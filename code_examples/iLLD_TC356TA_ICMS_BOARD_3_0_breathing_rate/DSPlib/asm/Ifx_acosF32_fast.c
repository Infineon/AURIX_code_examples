...
EXTERN_ASM("Ifx_asinTableF32");
/* Ifx_asinTableF32_t Ifx_asinTableF32[IFX_ASIN_TABLE_N]; */

float32 Ifx_acosF32_fast (float32 a)
{
	IFXASM_ALIGNMENT_8();
