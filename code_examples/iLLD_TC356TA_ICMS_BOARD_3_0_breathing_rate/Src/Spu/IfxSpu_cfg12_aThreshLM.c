...
/*This SPU config looks for local maxima and applies absolute threshold along angle dimension */

IfxSpu_ConfigSlot *IfxSpu_cfg12_aThreshLM(IfxSpu_SlotConfig *cfg, uint32 slotNr, Ifx_SPU *spu)
{
    ...
    /** ------------ PASS 0 ------------ */
    {
        ...
        pcfg0->cfar.baseAddress = IFX_OFFSETOF(SPU_Rmem_Map_t, CFARLMAMap[0]);
