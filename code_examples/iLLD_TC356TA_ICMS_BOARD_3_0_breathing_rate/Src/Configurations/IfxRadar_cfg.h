...
typedef struct
{
    ...
    sint16    phaseData[DEMO_MAX_TARGETS][RADAR_NUM_MICRO_DOPPLER];
    sint32    PHI[DEMO_MAX_TARGETS][RADAR_NUM_MICRO_DOPPLER];
    csint32   rr_spectrum[DEMO_MAX_TARGETS][RADAR_FFT2_LEN/2];
    csint32   rr_spectrum_filtered[DEMO_MAX_TARGETS][RADAR_FFT2_LEN/2];
    cfloat32  microDopplertargets[DEMO_MAX_TARGETS][RADAR_NUM_VRX_AZIMUTH][RADAR_NUM_MICRO_DOPPLER];
    cfloat32  microDopplerbeamformed[DEMO_MAX_TARGETS][RADAR_NUM_MICRO_DOPPLER];
    stats     stat_br[DEMO_MAX_TARGETS];
} SPU_Rmem_Map_t;
