 ...
 *              generated by the Generic Timer Module (GTM) in-built Timer Output Module (TOM).
 *
 * \name iLLD_TC375_ADS_GTM_TOM_PWM_2
 * \version V1.0.0
 * \board AURIX TC375 lite Kit, KIT_A2G_TC375_LITE, TC37xTP_A-Step
 * \keywords AURIX, GTM, GTM_TOM_PWM2, general timer, timer, PWM
