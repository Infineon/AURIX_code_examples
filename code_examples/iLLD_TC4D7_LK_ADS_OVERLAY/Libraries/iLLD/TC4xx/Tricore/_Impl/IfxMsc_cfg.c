...
#if !defined(DEVICE_TC48X) && !defined(DEVICE_TC48XA21) && !defined(DEVICE_TC45X) && !defined(DEVICE_TC44X)
...
#endif /* #if !defined(DEVICE_TC48X) && !defined(DEVICE_TC48XA21) && !defined(DEVICE_TC45X) && !defined(DEVICE_TC44X) */
