...
## Board  
The board used for testing is the AURIX&trade; TC375 SB (KIT_AURIX_TC375_SB).

## Scope of work  
A wait function is used to add delays between switching on and switching off an LED on port pin P10.2.
...
<img src="./Images/SB_TCxx5_V1_Top.png" width="400" />  
...
<img src="./Images/SB_TCxx5_V1_Top_Blinky.png" width="400" />  
