...
# iLLD_TC497_LK_ADS_Interrupt_Prio
...
The two LEDs that are used in this example are P22.7, P22.6. 
...
P22.7 and P22.6 are blinking sequentially and ISR counters are also incrementing according to the priority level of their related timer interrupt.
