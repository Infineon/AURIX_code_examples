...
void tft_transmit_callback(void)
{
    ...
    {
        if (g_Qspi_Tft.drivers.spiMasterChannel.tx.remaining)
        {
            return;
        }
    }
...
void tft_init (void)
{
    ...
    spiMasterChannelConfig.ch.baudrate = 20000000;

    /* Set the transfer data width */
    spiMasterChannelConfig.ch.mode.dataWidth = 16;
    spiMasterChannelConfig.ch.mode.csLeadDelay = IfxQspi_SlsoTiming_1;
    spiMasterChannelConfig.ch.mode.csTrailDelay = IfxQspi_SlsoTiming_0;
    spiMasterChannelConfig.ch.mode.csInactiveDelay = IfxQspi_SlsoTiming_0;
