...
IfxQspi_SpiMaster *qspi2_init (void)
{
    ...
    if (spi2Master.qspi == 0)
    {
        ...
        spiMasterConfig.maximumBaudrate = QSPI2_MAX_BAUDRATE;

        /* ISR priorities and interrupt target */
        spiMasterConfig.txPriority  = ISR_PRIORITY_QSPI2_TX;
        spiMasterConfig.rxPriority  = ISR_PRIORITY_QSPI2_RX;
        spiMasterConfig.erPriority  = ISR_PRIORITY_QSPI2_ER;
        spiMasterConfig.isrProvider = ISR_PROVIDER_QSPI2;
