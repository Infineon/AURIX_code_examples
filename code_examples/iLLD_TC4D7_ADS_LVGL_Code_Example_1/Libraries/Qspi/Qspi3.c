...
IfxQspi_SpiMaster *qspi3_init (void)
{
    ...
    if (spi3Master.qspi == 0)
    {
        ...
        spiMasterConfig.maximumBaudrate = QSPI3_MAX_BAUDRATE;

        /* ISR priorities and interrupt target */
        spiMasterConfig.txPriority  = ISR_PRIORITY_QSPI3_TX;
        spiMasterConfig.rxPriority  = ISR_PRIORITY_QSPI3_RX;
        spiMasterConfig.erPriority  = ISR_PRIORITY_QSPI3_ER;
        spiMasterConfig.isrProvider = ISR_PROVIDER_QSPI3;
