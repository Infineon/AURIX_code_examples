...
IfxQspi_SpiMaster *qspi1_init (void)
{
    ...
    if (spi1Master.qspi == 0)
    {
        ...
        spiMasterConfig.maximumBaudrate = QSPI1_MAX_BAUDRATE;

        /* ISR priorities and interrupt target */
        spiMasterConfig.txPriority  = ISR_PRIORITY_QSPI1_TX;
        spiMasterConfig.rxPriority  = ISR_PRIORITY_QSPI1_RX;
        spiMasterConfig.erPriority  = ISR_PRIORITY_QSPI1_ER;
        spiMasterConfig.isrProvider = ISR_PROVIDER_QSPI1;
        spiMasterConfig.isrProvider = 0;
#ifdef QSPI1_USE_DMA
        // DMA configuration
