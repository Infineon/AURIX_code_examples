...
IfxQspi_SpiMaster *qspi4_init (void)
{
    ...
    if (spi4Master.qspi == 0)
    {
        ...
        spiMasterConfig.maximumBaudrate = QSPI4_MAX_BAUDRATE;

        /* ISR priorities and interrupt target */
        spiMasterConfig.txPriority  = ISR_PRIORITY_QSPI4_TX;
        spiMasterConfig.rxPriority  = ISR_PRIORITY_QSPI4_RX;
        spiMasterConfig.erPriority  = ISR_PRIORITY_QSPI4_ER;
        spiMasterConfig.isrProvider = ISR_PROVIDER_QSPI4;
