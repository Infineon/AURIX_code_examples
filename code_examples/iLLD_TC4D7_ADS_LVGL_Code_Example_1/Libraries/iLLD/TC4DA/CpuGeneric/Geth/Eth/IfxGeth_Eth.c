...
void IfxGeth_Eth_initReceiveDescriptors(IfxGeth_Eth *geth, IfxGeth_Eth_RxChannelConfig *config)
{
    ...
    IFX_ASSERT(IFX_VERBOSE_LEVEL_WARNING, (config->rxBuffer1Size) % 8 == 0);
...
void IfxGeth_Eth_shuffleRxDescriptor(IfxGeth_Eth *geth, IfxGeth_RxDmaChannel channelId)
{
    ...
    tail_pointer->RDES2.U     = 0; /* buffer2 not used */

    tail_pointer->RDES3.U     = 0;
    tail_pointer->RDES3.R.IOC = 1; /* interrupt enabled */
    tail_pointer->RDES3.R.OWN = 1; /* owned by DMA */
