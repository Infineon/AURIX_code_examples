...
uint32 IfxClock_getPerPllFrequency1(void)
{
    ...
    pllFrequency1 = (oscFreq * (clock->PERPLLCON0.B.NDIV + 1)) / ((clock->PERPLLCON0.B.PDIV + 1) * ((clock->PERPLLCON1.B.K2DIV + 1) * (preDiv[clock->PERPLLCON1.B.K2PREDIV]) / 10u ));
...
uint32 IfxClock_getPerPllFrequency2(void)
{
    ...
    uint8      preDiv[16] = {10u, 11u, 12u, 10u, 14u, 10u, 16u, 17u, 10u, 10u, 20u, 10u, 10u, 10u, 10u, 10u};
    oscFreq       = IfxClock_getOscFrequency();
