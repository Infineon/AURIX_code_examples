 ...
 * IN THE SOFTWARE.
 *********************************************************************************************************************/
 /*\title Shell over UART using OneEye
 ...
 *              like "info" or "help".
 *
 * \name OneEye_UART_Shell_1_KIT_TC297_TFT
 * \version V1.0.0
 * \board APPLICATION KIT TC2X7 V1.1, KIT_AURIX_TC297_TFT_BC-Step, TC29xTA/TX_B-Step
 * \keywords OneEye, UART, USB, Shell, AURIX
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_OneEye_UART_Shell_1_KIT_TC297_TFT-TR-v01_00_00-EN.pdf
