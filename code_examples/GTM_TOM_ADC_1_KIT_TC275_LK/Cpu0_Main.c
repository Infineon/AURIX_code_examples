 ...
 * IN THE SOFTWARE.
 *********************************************************************************************************************/
 /*\title GTM TOM ADC conversion triggering
 ...
 *
 * \name GTM_TOM_ADC_1_KIT_TC275_LK
 * \version V1.0.0
 * \board AURIX TC275 lite Kit, KIT_AURIX_TC275_LITE, TC27xTP_D-Step
 * \keywords AURIX, GTM, GTM_TOM_PWM_1, PWM, general timer, timer
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_GTM_TOM_ADC_1_KIT_TC275_LK-TR-v01_00_00-EN.pdf
...
int core0_main(void)
{
    ...
    initGtmTomPwm();    /* Initialization of the GTM TOM module                 */
    initVadc();         /* Initialization of the analog to digital converter    */
