...
#ifndef IFXEGTM_CFG_TC49XN_H
#define IFXEGTM_CFG_TC49XN_H 1
 ...
 */
#define IFXEGTM_PWM_IS_HIGH_RES_AVAILABLE               (TRUE)

/** \brief Availability of input Geth signal
 */
#define IFXEGTM_INPUT_GETH_SIGNAL_IS_AVAILABLE          (FALSE)

/** \brief Availability of input Gpt12 signal
 */
#define IFXEGTM_INPUT_GPT12_SIGNAL_IS_AVAILABLE         (TRUE)
 ...
 */
#define IFXEGTM_CFG_CANXL_TIMEINPUT_MTI_TRIG            (TRUE)
...
#define IFXEGTM_CFG_NUM_GPT12_TIM_INPUT_SIGNALS (8)
...
typedef enum
{
    IfxEgtm_CanxlTimInput_CANXL_MTI_TRIG0,
    IfxEgtm_CanxlTimInput_CANXL_MTI_TRIG1,
    IfxEgtm_CanxlTimInput_CANXL_MTI_TRIG2,
    IfxEgtm_CanxlTimInput_CANXL_MTI_TRIG3
