...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define LED_VM5                              &MODULE_P13, 0                  /* LED_VM5: Port, Pin definition        */
#define CPU0                                 0                               /* CPU0: Core Index                     */
#define VM5                                  5                               /* VM5: Virtual Machine Index           */
#define HV_SCHEDULER_ACTIVATION_THS_VM5      IFX_CFG_HV_ACTIVATION_VM5       /* Scheduler Activation Threshold       */

#if defined(__GNUC__) && !defined(__HIGHTEC__)
#pragma section
#pragma section ".bss_cpu0vm5"
#endif
...
void core0_vm5_main(void)
{
        ...
        IfxPort_setPinMode(LED_VM5, IfxPort_Mode_outputPushPullGeneral);
        /* Set Pin State */
        IfxPort_setPinState(LED_VM5, IfxPort_State_low);
    while (1)
    {
        ...
        if (tc0_vm5_scheduler_ctr > HV_SCHEDULER_ACTIVATION_THS_VM5)
        {
            /* Set Pin State */
            IfxPort_setPinState(LED_VM5, IfxPort_State_high);
...
#if (IFX_CFG_TC0_VM5_INT != 0U)
IFX_INTERRUPT(Cpu0_Vm5_Isr, 24, IFX_VM5_ISR_PRIORITY)
{
    uint32 stmTicks;
