 ...
 * 3. If Vm7 ISR is enabled: initialize STM2 to trigger event for Vm7 */
void core1_vm7_main(void)
{
         ...
         * In the default configuration STM0, Comparator0 is used
         */
...
#if (IFX_CFG_TC1_VM7_INT != 0U)
IFX_INTERRUPT(Cpu1_Vm7_Isr, 37, IFX_VM7_ISR_PRIORITY)
{
    uint32 stmTicks;
