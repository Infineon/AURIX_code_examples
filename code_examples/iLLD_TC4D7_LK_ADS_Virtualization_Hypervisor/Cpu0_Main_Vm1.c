...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define LED_VM1                              &MODULE_P03, 9                  /* LED_VM1: Port, Pin definition        */
...
#endif
    /* Set Port pin mode for the LED P33.0 */
    IfxPort_setPinMode(LED_VM1, IfxPort_Mode_outputPushPullGeneral);
    /* Set Pin State */
