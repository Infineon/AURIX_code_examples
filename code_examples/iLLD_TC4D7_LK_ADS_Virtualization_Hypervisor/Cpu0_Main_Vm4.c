...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define LED_VM4                              &MODULE_P33, 5                  /* LED_VM4: Port, Pin definition        */
#define CPU0                                 0                               /* CPU0: Core Index                     */
#define VM4                                  4                               /* VM4: Virtual Machine Index           */
#define HV_SCHEDULER_ACTIVATION_THS_VM4      IFX_CFG_HV_ACTIVATION_VM4       /* Scheduler Activation Threshold       */

#if defined(__GNUC__) && !defined(__HIGHTEC__)
#pragma section
#pragma section ".bss_cpu0vm4"
#endif
...
void core0_vm4_main(void)
{
        ...
        IfxPort_setPinMode(LED_VM4, IfxPort_Mode_outputPushPullGeneral);
        /* Set Pin State */
        IfxPort_setPinState(LED_VM4, IfxPort_State_low);
    while (1)
    {
        ...
        if (tc0_vm4_scheduler_ctr > HV_SCHEDULER_ACTIVATION_THS_VM4)
        {
            /* Set Pin State */
            IfxPort_setPinState(LED_VM4, IfxPort_State_high);
...
#if (IFX_CFG_TC0_VM4_INT != 0U)
IFX_INTERRUPT(Cpu0_Vm4_Isr, 18, IFX_VM4_ISR_PRIORITY)
{
    uint32 stmTicks;
