...
typedef struct
{
    ...
    uint32                      triggerPoint;             /**< \brief Trigger point in timer ticks. Range: 0 to 0xFFFF  */
...
typedef struct
{
    ...
    uint32                     offset;                 /**< \brief Timer initial offset in ticks. Range: 0 to 0xFFFFFF */
    Ifx_GTM_CLS_CDTM_DTM      *dtm;                    /**< \brief Pointer to DTM object used by ATOM */
    IfxGtm_Dtm_Ch              dtmChannel;             /**< \brief DTM channel */
    uint32                     agcDisableUpdate;       /**< \brief AGC value for disable update. Range: 0 to 0xFFFF */
    uint32                     agcApplyUpdate;         /**< \brief AGC value for apply update. Range: 0 to 0xFFFF */
    uint32                     period;                 /**< \brief Timer period in ticks (cached value). Range: 0 to 0xFFFFFF */
 ...
 * \param[in]   channel Channel to ba added to the mask. Range: \ref IfxGtm_Atom_Ch.
 *
 * \retval None
 */
 ...
 * \param[in] driver ATOM Timer interface Handle.
 *
 * \retval uint32 Period. Range: 0 to 0xFFFFFF.
 */
 ...
 * \param[in] driver ATOM Timer interface Handle.
 *
 * \retval uint32 Trigger point. Range: 0 to 0xFFFFFF.
 */
 ...
 *
 * \param[inout] driver ATOM Timer interface Handle.
 * \param[in]    period Period value. Range: 0 to 0xFFFFFF.
 *
 * \retval TRUE on success else FALSE.
 */
 ...
 *
 * \param[inout] driver       ATOM Timer interface Handle.
 * \param[in]    triggerPoint Trigger point value. Range: 0 to 0xFFFFFF.
 *
 * \retval None
 */
 ...
 * \param[in] driver ATOM Timer interface Handle.
 *
 * \retval uint32 Returns the initial timer offset in ticks. Range: 0 to 0xFFFFFF.
 */
