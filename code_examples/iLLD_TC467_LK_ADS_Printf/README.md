...
## Hardware setup  
This code example has been developed for the board TC467 lite Kit (KIT_A3G_TC467_LITE).  
...
This example relies on the board lib files, specific for the AURIX&trade; TC497 Lite KIT (they can be found in the *Boards* folder).  
