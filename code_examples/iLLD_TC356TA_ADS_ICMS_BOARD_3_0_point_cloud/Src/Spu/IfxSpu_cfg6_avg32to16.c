...
/*This SPU config changes the format of average from 32bit to 16 bit*/

IfxSpu_ConfigSlot *IfxSpu_cfg6_avg32to16(IfxSpu_SlotConfig *cfg, uint32 slotNr, Ifx_SPU *spu)
{
    ...
    cfg->input.rm.baseAddress         = IFX_OFFSETOF(SPU_Rmem_Map_t, average32[0]);
    ...
    cfg->input.rm.binLoopRepeat     = RADAR_NUM_RANGE_GATES * RADAR_NUM_VRX;
    ...
    cfg->input.rm.outerLoopOffset   = 1;
    ...
    /** ------------ PASS 0 ------------ */
    {
        ...
        /*MATH2*/
        /*summation for shifting to 16-bit data*/
        pcfg0->csum.baseAddress       = IFX_OFFSETOF(SPU_Rmem_Map_t, average16[0]);
