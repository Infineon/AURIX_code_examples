...
/*This SPU config extends the 16bit average result in ramp dimension*/

IfxSpu_ConfigSlot *IfxSpu_cfg7_reshape(IfxSpu_SlotConfig *cfg, uint32 slotNr, Ifx_SPU *spu)
{
    ...
    cfg->input.rm.baseAddress       = IFX_OFFSETOF(SPU_Rmem_Map_t, average16[0]);
    ...
    cfg->input.rm.outerLoopOffset   = 0;
    ...
    /** ------------ PASS 0 ------------ */
    {
        ...
        pcfg0->csum.baseAddress   = IFX_OFFSETOF(SPU_Rmem_Map_t, average16[1]);
