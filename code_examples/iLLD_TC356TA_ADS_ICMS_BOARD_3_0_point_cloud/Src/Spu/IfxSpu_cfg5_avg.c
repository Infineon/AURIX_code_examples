...
/*This SPU config calculates the average across ramps in the micro doppler frame*/

IfxSpu_ConfigSlot *IfxSpu_cfg5_avg(IfxSpu_SlotConfig *cfg, uint32 slotNr, Ifx_SPU *spu)
{
    ...
    cfg->input.rm.binLoopOffset     = bin_size_bytes * RADAR_NUM_RANGE_GATES * RADAR_NUM_VRX;
    ...
    /** ------------ PASS 0 ------------ */
    {
        ...
        pcfg0->csum.baseAddress       = IFX_OFFSETOF(SPU_Rmem_Map_t, average32[0]);
