 ...
 *              memory is turned ON.
 *
 * \name Flash_Programming_1_KIT_TC375_LK
 * \version V1.0.0
 ...
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_Flash_Programming_1_KIT_TC375_LK-TR-v01_00_00-EN.pdf
