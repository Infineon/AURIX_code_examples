...
The port pins P02.9 and P02.10 (UART-TX/RX) can be connected to an oscilloscope probe.
 
<img src="./Images/UART_P02_9.png" width="800" />  
...
## Run and Test   
An oscilloscope probe must be connected to the UART TX pin (P02.9) to observe the UART signal.  

After code compilation and flashing the device, perform the following steps:  
- Connect the oscilloscope probe to the TX pin (P02.9)  
