...
void core2_main(void)
{
    ...
    while(1)
    {
        /* This function triggers either a SW Application Reset or a SW System Reset, based on the reset type */
        if (TRUE == g_systemReset)
        {
            g_systemReset = FALSE;
            ...
            IfxScuRcu_configureResetRequestTrigger(IfxScuRcu_Trigger_sw, (IfxScuRcu_ResetType) IfxScuRcu_ResetType_system);
