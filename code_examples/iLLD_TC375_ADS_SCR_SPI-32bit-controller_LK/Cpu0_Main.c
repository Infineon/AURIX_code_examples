 ...
 * IN THE SOFTWARE.
 *********************************************************************************************************************/
 /*\title iLLD_TC375_ADS_SCR_SPI-32bit-controller_LK
 * \abstract This repository is an SCR example demonstrating the SCR-SPI initialization and SW for an 32-bit SPI controller (master). 
 * \description This code example gives an overview how to configure the SCR SSC module as SPI master device and transfer 32-bit data from/to a slave device.
 ...
 *
 * \name iLLD_TC375_ADS_SCR_SPI-32bit-controller_LK
 * \version V1.0.0
