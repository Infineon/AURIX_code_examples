 ...
 *
 * \name RAM_Run_Function_1_KIT_TC375_LK
 * \version V1.0.0
 * \board AURIX TC375 lite Kit, KIT_A2G_TC375_LITE, TC37xTP_A-Step
 * \keywords AURIX, Execute, Function, RAM_Run_Function_1, SRAM
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_RAM_Run_Function_1_KIT_TC375_LK-TR-v01_00_00-EN.pdf
...
void core0_main(void)
{
    ...
    while(1)
    {
        /* Toggle LED: code executed from CPU0 Program Scratch Pad SRAM (PSPR0) */
        toggleLedSram();
