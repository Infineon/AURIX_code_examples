...
void Spu0_init(void)
 ...
 void Spu0_cfg_init(void)
 {
     ...
     IfxSpu_cfg1_rFFT       (&cfg[0],     1, rdr->spu0);  /* slotNr is 1-based [1-128] */
     IfxSpu_cfg2_avg        (&cfg[1],     2, rdr->spu0);
     IfxSpu_cfg3_avg32to16  (&cfg[2],     3, rdr->spu0);
     IfxSpu_cfg4_reshape    (&cfg[3],     4, rdr->spu0);
     IfxSpu_cfg5_sub        (&cfg[4],     5, rdr->spu0);
     ...
     IfxSpu_setupConfigSequence(rdr->spu0, 3, 4, &ctrlcfg);
     IfxSpu_setupConfigSequence(rdr->spu0, 4, 5, &ctrlcfg);
     IfxSpu_setupConfigSequence(rdr->spu0, 5, 0, &ctrlcfg);
 }
