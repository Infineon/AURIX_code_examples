...
IfxSpu_ConfigSlot *IfxSpu_cfg1_rFFT(IfxSpu_SlotConfig *cfg, uint32 slotNr, Ifx_SPU *spu)
{
    ...
    /** ------------ PASS 0 ------------ */
    {
        ...
        pcfg0->fftOut.baseAddress     = IFX_OFFSETOF(SPU_Emem_Map_t, rangeMap.rMap[0]);
