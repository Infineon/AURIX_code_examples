...
IfxSpu_ConfigSlot *IfxSpu_cfg4_reshape(IfxSpu_SlotConfig *cfg, uint32 slotNr, Ifx_SPU *spu)
{
    ...
    cfg->input.rm.baseAddress       = IFX_OFFSETOF(SPU_Emem_Map_t, average16[0]);
    ...
    cfg->input.rm.binLoopRepeat     = RADAR_NUM_RX * RADAR_NUM_RANGE_GATES;
    cfg->input.rm.innerLoopRepeat   = 1;
    cfg->input.rm.outerLoopRepeat   = RADAR_NUM_RAMPS-1;

    cfg->input.rm.binLoopOffset     = bin_size_bytes;
    cfg->input.rm.innerLoopOffset   = bin_size_bytes;
    cfg->input.rm.outerLoopOffset   = IFXEMEM_SIZE; /* zero offset setting is possible through IFXEMEM_SIZE as offset wraps around */
    ...
    /** ------------ PASS 0 ------------ */
    {
        ...
        /*MATH2*/
        /*extend average16[4][128] to average16[64][4][128]*/
        pcfg0->csum.baseAddress   = IFX_OFFSETOF(SPU_Emem_Map_t, average16[1]);
