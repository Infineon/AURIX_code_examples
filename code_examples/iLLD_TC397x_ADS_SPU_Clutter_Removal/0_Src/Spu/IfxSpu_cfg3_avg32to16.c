...
IfxSpu_ConfigSlot *IfxSpu_cfg3_avg32to16(IfxSpu_SlotConfig *cfg, uint32 slotNr, Ifx_SPU *spu)
{
    ...
    cfg->input.rm.baseAddress         = IFX_OFFSETOF(SPU_Emem_Map_t, average32[0]);
    ...
    cfg->input.rm.binLoopRepeat     = RADAR_NUM_RANGE_GATES * RADAR_NUM_RX;
    ...
    /** ------------ PASS 0 ------------ */
    {
        ...
        pcfg0->csum.baseAddress       = IFX_OFFSETOF(SPU_Emem_Map_t, average16[0]);
