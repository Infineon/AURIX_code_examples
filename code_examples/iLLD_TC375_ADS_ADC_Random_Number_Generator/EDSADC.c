...
#define AN0_CH0             0                       /* Conversion channel                                           */
...
void init_EDSADC(void)
{
    ...
    edsadcChannelConfig.firFilter.prefilterEnabled = FALSE;      /* Enable the Pre-Filter in the filter chain        */
    edsadcChannelConfig.firFilter.fir0Enabled = FALSE;           /* Enable the FIR0 Filter in the filter chain       */
    edsadcChannelConfig.firFilter.fir1Enabled = FALSE;           /* Enable the FIR1 Filter in the filter chain       */
    ...
    edsadcChannelConfig.channelId = (IfxEdsadc_ChannelId)AN0_CH0;           /* Select the channel to configure       */
