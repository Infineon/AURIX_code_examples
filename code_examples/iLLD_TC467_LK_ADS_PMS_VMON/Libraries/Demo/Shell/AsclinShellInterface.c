...
boolean AppShell_status(pchar args, void *data, IfxStdIf_DPipe *io)
{
    ...
    else
    {
        ...
        IfxStdIf_DPipe_print(io, "VDDEXTHS  Voltage : %.2f V (min: %.2f V  max: %.2f V)"ENDL, (float) Vddexths, Vddexths_min, Vddexths_max);
...
void initSerialInterface(void)
{
    {   /** - Serial interface */
        ...
        IfxStdIf_DPipe_ascInit(&g_AsclinShellInterface.stdIf.asc, &g_AsclinShellInterface.drivers.asc);
    }
