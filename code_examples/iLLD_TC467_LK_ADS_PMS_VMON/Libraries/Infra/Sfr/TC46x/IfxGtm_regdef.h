...
/** \brief GTM to ASCLIN0 output selection register. 0<8 , if interface exists. */
...
/** \brief GTM to CAN0 output selection register 0. 0*4+ 0<10 , if interface exists. */
...
typedef struct _Ifx_GTM_CLS_ARCH_CTRL_Bits
{
    ...
    __I  Ifx_Strict_32Bit AEIM_CLUSTER:4;    /**< \brief [15:12] ##suppress##AEIM cluster number##suppress## (rh) */
...
{
    __I  Ifx_Strict_32Bit REQ1HOT0:1;      /**< \brief [0:0] The REQ1HOT[t] bit fields show the new allocated slot as 1-hot encoded vector. If no slot could be allocated, all REQ1HOT[t] bit fields are read as 0. (rh) */
    __I  Ifx_Strict_32Bit REQ1HOT1:1;      /**< \brief [1:1] The REQ1HOT[t] bit fields show the new allocated slot as 1-hot encoded vector. If no slot could be allocated, all REQ1HOT[t] bit fields are read as 0. (rh) */
    __I  Ifx_Strict_32Bit REQ1HOT2:1;      /**< \brief [2:2] The REQ1HOT[t] bit fields show the new allocated slot as 1-hot encoded vector. If no slot could be allocated, all REQ1HOT[t] bit fields are read as 0. (rh) */
    __I  Ifx_Strict_32Bit REQ1HOT3:1;      /**< \brief [3:3] The REQ1HOT[t] bit fields show the new allocated slot as 1-hot encoded vector. If no slot could be allocated, all REQ1HOT[t] bit fields are read as 0. (rh) */
    __I  Ifx_Strict_32Bit REQ1HOT4:1;      /**< \brief [4:4] The REQ1HOT[t] bit fields show the new allocated slot as 1-hot encoded vector. If no slot could be allocated, all REQ1HOT[t] bit fields are read as 0. (rh) */
    __I  Ifx_Strict_32Bit REQ1HOT5:1;      /**< \brief [5:5] The REQ1HOT[t] bit fields show the new allocated slot as 1-hot encoded vector. If no slot could be allocated, all REQ1HOT[t] bit fields are read as 0. (rh) */
    __I  Ifx_Strict_32Bit REQ1HOT6:1;      /**< \brief [6:6] The REQ1HOT[t] bit fields show the new allocated slot as 1-hot encoded vector. If no slot could be allocated, all REQ1HOT[t] bit fields are read as 0. (rh) */
    __I  Ifx_Strict_32Bit REQ1HOT7:1;      /**< \brief [7:7] The REQ1HOT[t] bit fields show the new allocated slot as 1-hot encoded vector. If no slot could be allocated, all REQ1HOT[t] bit fields are read as 0. (rh) */
...
typedef struct _Ifx_GTM_CLS_CCM_AEIM_STA_Bits
{
    ...
    __IO Ifx_Strict_32Bit AEIM_XPT_STA:2;    /**< \brief [25:24] ##suppress##AEIM exception status##suppress## (rwch) */
    __I  Ifx_Strict_32Bit :6;              /**< \brief [31:26] \internal Reserved */
...
typedef struct _Ifx_GTM_CLS_CCM_CFG_Bits
{
    ...
    __I  Ifx_Strict_32Bit TBU_DIR1:1;      /**< \brief [30:30] Direction value for time base channel [z] (rh) */
    __I  Ifx_Strict_32Bit TBU_DIR2:1;      /**< \brief [31:31] Direction value for time base channel [z] (rh) */
...
typedef struct _Ifx_GTM_CLS_DPLL_IRQ_NOTIFY_Bits
{
    ...
    __IO Ifx_Strict_32Bit MSI:1;           /**< \brief [6:6] ##suppress##Missing STATE interrupt (may only be triggered if DPLL_CTRL_0.RMO = 1 or DPLL_CTRL_1.SMC = 1).##suppress## (rw1ch) */
    __IO Ifx_Strict_32Bit MTI:1;           /**< \brief [7:7] ##suppress##Missing TRIGGER interrupt (may only be triggered if DPLL_CTRL_0.RMO = 0 or DPLL_CTRL_1.SMC = 1).##suppress## (rw1ch) */
...
{
    __IO Ifx_Strict_32Bit THMA:16;         /**< \brief [15:0] ##suppress##Maximum time between active and inactive TRIGGER slope; the time value corresponds to the timestamp clock counts: This means the clock selected for the TBU_CH0_BASE (see TBU_CH0_CTRL register)##suppress## (rw) */
    __I  Ifx_Strict_32Bit :16;             /**< \brief [31:16] \internal Reserved */
...
typedef struct _Ifx_GTM_CLS_MAP_CTRL_Bits
{
    ...
    __I  Ifx_Strict_32Bit :2;              /**< \brief [19:18] \internal Reserved */
    __IO Ifx_Strict_32Bit TSPP0_I0V:1;     /**< \brief [20:20] ##suppress##Disable of TSPP0 TIM_MAP_DATA[0][48:48] input line##suppress## (rw) */
    __IO Ifx_Strict_32Bit TSPP0_I1V:1;     /**< \brief [21:21] ##suppress##Disable of TSPP0 TIM_MAP_DATA[1][48:48] input line##suppress## (rw) */
    __IO Ifx_Strict_32Bit TSPP0_I2V:1;     /**< \brief [22:22] ##suppress##Disable of TSPP0 TIM_MAP_DATA[2][48:48] input line##suppress## (rw) */
    __I  Ifx_Strict_32Bit :1;              /**< \brief [23:23] \internal Reserved */
    ...
    __I  Ifx_Strict_32Bit :2;              /**< \brief [27:26] \internal Reserved */
    __IO Ifx_Strict_32Bit TSPP1_I0V:1;     /**< \brief [28:28] ##suppress##Disable of TSPP1 TIM_MAP_DATA[3][48:48] input line##suppress## (rw) */
    __IO Ifx_Strict_32Bit TSPP1_I1V:1;     /**< \brief [29:29] ##suppress##Disable of TSPP1 TIM_MAP_DATA[4][48:48] input line##suppress## (rw) */
    __IO Ifx_Strict_32Bit TSPP1_I2V:1;     /**< \brief [30:30] ##suppress##Disable of TSPP1 TIM_MAP_DATA[5][48:48] input line##suppress## (rw) */
    __I  Ifx_Strict_32Bit :1;              /**< \brief [31:31] \internal Reserved */
...
{
    __IO Ifx_Strict_32Bit TRG0:1;          /**< \brief [0:0] Trigger bit [m]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG1:1;          /**< \brief [1:1] Trigger bit [m]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG2:1;          /**< \brief [2:2] Trigger bit [m]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG3:1;          /**< \brief [3:3] Trigger bit [m]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG4:1;          /**< \brief [4:4] Trigger bit [m]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG5:1;          /**< \brief [5:5] Trigger bit [m]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG6:1;          /**< \brief [6:6] Trigger bit [m]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG7:1;          /**< \brief [7:7] Trigger bit [m]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG8:1;          /**< \brief [8:8] Trigger bit [n]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG9:1;          /**< \brief [9:9] Trigger bit [n]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG10:1;         /**< \brief [10:10] Trigger bit [n]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG11:1;         /**< \brief [11:11] Trigger bit [n]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG12:1;         /**< \brief [12:12] Trigger bit [n]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG13:1;         /**< \brief [13:13] Trigger bit [n]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG14:1;         /**< \brief [14:14] Trigger bit [n]. (rw1ch) */
    __IO Ifx_Strict_32Bit TRG15:1;         /**< \brief [15:15] Trigger bit [n]. (rw1ch) */
...
{
    __IO Ifx_Strict_32Bit TRG_S_IRQ0:1;    /**< \brief [0:0] ##suppress##Trigger the MCS[i]_SINT_IRQ_NOTIFY.S_IRQ[k] bit by software. Triggers the shared interrupt bit with id [k]##suppress## (rw) */
    __IO Ifx_Strict_32Bit TRG_S_IRQ1:1;    /**< \brief [1:1] ##suppress##Trigger the MCS[i]_SINT_IRQ_NOTIFY.S_IRQ[k] bit by software. Triggers the shared interrupt bit with id [k]##suppress## (rw) */
    __IO Ifx_Strict_32Bit TRG_S_IRQ2:1;    /**< \brief [2:2] ##suppress##Trigger the MCS[i]_SINT_IRQ_NOTIFY.S_IRQ[k] bit by software. Triggers the shared interrupt bit with id [k]##suppress## (rw) */
    __IO Ifx_Strict_32Bit TRG_S_IRQ3:1;    /**< \brief [3:3] ##suppress##Trigger the MCS[i]_SINT_IRQ_NOTIFY.S_IRQ[k] bit by software. Triggers the shared interrupt bit with id [k]##suppress## (rw) */
    __IO Ifx_Strict_32Bit TRG_S_IRQ4:1;    /**< \brief [4:4] ##suppress##Trigger the MCS[i]_SINT_IRQ_NOTIFY.S_IRQ[k] bit by software. Triggers the shared interrupt bit with id [k]##suppress## (rw) */
    __IO Ifx_Strict_32Bit TRG_S_IRQ5:1;    /**< \brief [5:5] ##suppress##Trigger the MCS[i]_SINT_IRQ_NOTIFY.S_IRQ[k] bit by software. Triggers the shared interrupt bit with id [k]##suppress## (rw) */
    __IO Ifx_Strict_32Bit TRG_S_IRQ6:1;    /**< \brief [6:6] ##suppress##Trigger the MCS[i]_SINT_IRQ_NOTIFY.S_IRQ[k] bit by software. Triggers the shared interrupt bit with id [k]##suppress## (rw) */
    __IO Ifx_Strict_32Bit TRG_S_IRQ7:1;    /**< \brief [7:7] ##suppress##Trigger the MCS[i]_SINT_IRQ_NOTIFY.S_IRQ[k] bit by software. Triggers the shared interrupt bit with id [k]##suppress## (rw) */
    __I  Ifx_Strict_32Bit :24;             /**< \brief [31:8] \internal Reserved */
...
typedef struct _Ifx_GTM_MCSVIRTUALIZATION_VMPRSCONFIG_Bits
{
    ...
    __I  Ifx_UReg_32Bit :8;                /**< \brief [31:24] \internal Reserved */
} Ifx_GTM_MCSVIRTUALIZATION_VMPRSCONFIG_Bits;
...
/** \brief GTM to QSPI0 output selection register. 0<8 , if interface exists. */
...
typedef union
{
    __IO Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_GTM_MCSVIRTUALIZATION_VMPRSCONFIG_Bits B;    /**< \brief Bitfield access */
} Ifx_GTM_MCSVIRTUALIZATION_VMPRSCONFIG;
...
typedef volatile struct _Ifx_GTM_CLS_ICM
{
       ...
       __I  Ifx_GTM_CLS_ICM_IRQG_MCS_CEI        IRQG_MCS_CEI[5];        /**< \brief 64, ICM Interrupt group MCS[j] for Channel Error Interrupt information*/
       __I  Ifx_UReg_8Bit                       reserved_78[44];        /**< \brief 78, \internal Reserved */
       ...
       __I  Ifx_GTM_CLS_ICM_IRQG_MCS_CI         IRQG_MCS_CI[5];         /**< \brief 120, ICM Interrupt group MCS[j] for Channel Interrupt information*/
       __I  Ifx_UReg_8Bit                       reserved_134[44];       /**< \brief 134, \internal Reserved */
       ...
       __IO Ifx_GTM_CLS_ICM_IRQG_ATOM           IRQG_ATOM[2];           /**< \brief 190, */
       __I  Ifx_UReg_8Bit                       reserved_198[8];        /**< \brief 198, \internal Reserved */
       __IO Ifx_GTM_CLS_ICM_IRQG_TOM            IRQG_TOM[2];            /**< \brief 1A0, */
...
typedef volatile struct _Ifx_GTM_CLS_MON
{
       ...
       __IO Ifx_GTM_CLS_MON_ACTIVITY_MCS        ACTIVITY_MCS[5];        /**< \brief C, MON activity register for MCS [j]*/
...
typedef volatile struct _Ifx_GTM_CLS_DPLL
{
       ...
       __IO Ifx_GTM_CLS_DPLL_ACB                ACB[5];                 /**< \brief F00, DPLL_ACB_[n]*/
       __I  Ifx_UReg_8Bit                       reserved_F14[12];       /**< \brief F14, \internal Reserved */
...
/******************************************************************************/
/******************************************************************************/
/** \addtogroup IfxSfr_Gtm_MCSVIRTUALIZATION_struct
 * \{  */
/******************************************************************************/
/** \name Object L2
 * \{  */
/** \brief MCSVIRTUALIZATION object */
typedef volatile struct _Ifx_GTM_MCSVIRTUALIZATION
{
       __IO Ifx_GTM_MCSVIRTUALIZATION_VMPRSCONFIG VMPRSCONFIG;            /**< \brief 0, MCS cluster i VM and PRS configuration Register*/
       __I  Ifx_UReg_8Bit                       reserved_4[4];          /**< \brief 4, \internal Reserved */
} Ifx_GTM_MCSVIRTUALIZATION;
...
{
       __IO Ifx_GTM_CAN_OUT                     OUT[4];                 /**< \brief 0, GTM to CAN0 output selection register 0. 0*4+ 0<10 , if interface exists.*/
} Ifx_GTM_CAN;
...
{
       __IO Ifx_GTM_QSPI_OUT                    OUT;                    /**< \brief 0, GTM to QSPI0 output selection register. 0<8 , if interface exists.*/
} Ifx_GTM_QSPI;
...
{
       __IO Ifx_GTM_ASCLIN_OUT                  OUT;                    /**< \brief 0, GTM to ASCLIN0 output selection register. 0<8 , if interface exists.*/
} Ifx_GTM_ASCLIN;
...
{
       __IO Ifx_GTM_ADC_OUT                     OUT[5];                 /**< \brief 0, GTM to ADC output selection register 0*/
} Ifx_GTM_ADC;
...
{
       __IO Ifx_GTM_SCU_OUT                     OUT[5];                 /**< \brief 0, GTM to SCU output selection register 0 GTM_SCU_TRIG(0)*/
} Ifx_GTM_SCU;
...
typedef volatile struct _Ifx_GTM
{
       ...
       __IO Ifx_GTM_CL                          CL[5];                  /**< \brief 180020, Protection per cluster*/
       __I  Ifx_UReg_8Bit                       reserved_1800D4[252];    /**< \brief 1800D4, \internal Reserved */
       ...
       __IO Ifx_GTM_MCSVIRTUALIZATION           MCSVIRTUALIZATION[5];    /**< \brief 180304, */
       __I  Ifx_UReg_8Bit                       reserved_18032C[340];    /**< \brief 18032C, \internal Reserved */
       ...
       __IO Ifx_GTM_TIMINSEL                    TIMINSEL[5];            /**< \brief 181000, TIM0 input selection register*/
       __I  Ifx_UReg_8Bit                       reserved_181014[60];    /**< \brief 181014, \internal Reserved */
       __IO Ifx_GTM_TIMINSELB                   TIMINSELB[5];           /**< \brief 181050, TIM0 input selection register group B*/
       __I  Ifx_UReg_8Bit                       reserved_181064[156];    /**< \brief 181064, \internal Reserved */
       ...
       __IO Ifx_GTM_MSCSET                      MSCSET[5];              /**< \brief 181200, */
       __I  Ifx_UReg_8Bit                       reserved_181250[64];    /**< \brief 181250, \internal Reserved */
       ...
       __IO Ifx_GTM_QSPI                        QSPI[8];                /**< \brief 181580, GTM to QSPI0 output selection register. 0<8 , if interface exists.*/
       __I  Ifx_UReg_8Bit                       reserved_1815A0[96];    /**< \brief 1815A0, \internal Reserved */
       __IO Ifx_GTM_ASCLIN                      ASCLIN[8];              /**< \brief 181600, GTM to ASCLIN0 output selection register. 0<8 , if interface exists.*/
       ...
       __I  Ifx_UReg_8Bit                       reserved_181714[108];    /**< \brief 181714, \internal Reserved */
       __IO Ifx_GTM_DTMAUX                      DTMAUX[5];              /**< \brief 181780, */
       __I  Ifx_UReg_8Bit                       reserved_1817A8[88];    /**< \brief 1817A8, \internal Reserved */
       __IO Ifx_GTM_SCU                         SCU;                    /**< \brief 181800, */
       __I  Ifx_UReg_8Bit                       reserved_181814[492];    /**< \brief 181814, \internal Reserved */
       __IO Ifx_GTM_TIMS                        TIMS[5];                /**< \brief 181A00, */
       __I  Ifx_UReg_8Bit                       reserved_181AA0[517472];    /**< \brief 181AA0, \internal Reserved */
} Ifx_GTM;
