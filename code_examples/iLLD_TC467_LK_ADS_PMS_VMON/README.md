...
- Compiler: GCC via AURIX&trade; Development Studio limited V1.10.26-L
...
<img src="./Images/TC467_LK_VMON.jpg" width="400" />

After code compilation and flashing the device:
- Check if LED 22.7 is blinking
