...
#if defined(DEVICE_TC45X) || defined(DEVICE_TC46X) || defined(DEVICE_TC48X)
...
#endif /* #if defined(DEVICE_TC45X) || defined(DEVICE_TC46X) || defined(DEVICE_TC48X) */
 ...
 * \param port Pointer to the port which should be accessed
 * \param timerConfig to configure the timer
 * \return None
 */
