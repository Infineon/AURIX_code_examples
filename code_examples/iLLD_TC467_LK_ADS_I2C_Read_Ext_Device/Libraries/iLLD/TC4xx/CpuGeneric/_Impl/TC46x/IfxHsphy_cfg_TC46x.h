...
#ifndef IFXHSPHY_CFG_TC46X_H
#define IFXHSPHY_CFG_TC46X_H 1
...
typedef enum
{
    ...
    IfxHsphy_PhyIndex_none = 2  /**< \brief PHY index none */
} IfxHsphy_PhyIndex;
