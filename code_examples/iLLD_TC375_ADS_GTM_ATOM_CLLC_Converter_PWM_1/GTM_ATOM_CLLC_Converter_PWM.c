/**********************************************************************************************************************
 * \file GTM_ATOM_CLLC_Converter_PWM.h.c
...
#define HVHV_PRI_PWM_T1      &IfxGtm_ATOM0_0_TOUT9_P00_0_OUT          /* Pin which will be driven by the PWM, P00.0  */
#define HVHV_PRI_PWM_T2      &IfxGtm_ATOM0_0N_TOUT17_P00_8_OUT        /* Pin which will be driven by the PWM, P00.8  */
#define HVHV_PRI_PWM_T3      &IfxGtm_ATOM0_1_TOUT11_P00_2_OUT         /* Pin which will be driven by the PWM, P00.2  */
#define HVHV_PRI_PWM_T4      &IfxGtm_ATOM0_1_TOUT10_P00_1_OUT         /* Pin which will be driven by the PWM, P02.4  */
/* Low-voltage side (Secondary) */
#define HVHV_SEC_PWM_T1      &IfxGtm_ATOM0_2_TOUT33_P33_11_OUT        /* Pin which will be driven by the PWM, P33.11 */
#define HVHV_SEC_PWM_T2      &IfxGtm_ATOM0_2N_TOUT23_P33_1_OUT        /* Pin which will be driven by the PWM, P33.1  */
#define HVHV_SEC_PWM_T3      &IfxGtm_ATOM0_3_TOUT49_P22_2_OUT         /* Pin which will be driven by the PWM, P22.2  */
#define HVHV_SEC_PWM_T4      &IfxGtm_ATOM0_3N_TOUT42_P23_1_OUT        /* Pin which will be driven by the PWM, P23.1  */
