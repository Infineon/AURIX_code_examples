...
/** \brief eGTM to ASCLIN0 output selection register. 0<8 , if interface exists. */
...
/** \brief eGTM to CAN0 output selection register 0. 0*4+ 0<10 , if interface exists. */
...
{
       __IO Ifx_EGTM_CAN_OUT                    OUT[4];                 /**< \brief 0, eGTM to CAN0 output selection register 0. 0*4+ 0<10 , if interface exists.*/
} Ifx_EGTM_CAN;
...
{
       __IO Ifx_EGTM_ASCLIN_OUT                 OUT;                    /**< \brief 0, eGTM to ASCLIN0 output selection register. 0<8 , if interface exists.*/
} Ifx_EGTM_ASCLIN;
...
typedef volatile struct _Ifx_EGTM
{
       ...
       __IO Ifx_EGTM_ASCLIN                     ASCLIN[28];             /**< \brief 61600, eGTM to ASCLIN0 output selection register. 0<8 , if interface exists.*/
