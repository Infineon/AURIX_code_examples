...
#else					
                    srcSFR = IfxLeth_getSrcPointer(lethSFR, (IfxLeth_ServiceRequest)(IfxLeth_ServiceRequest_DmaTx_0 + channelIndex)); /* Leth DMA Tx Channel node indexed by (IfxLeth_ServiceRequest_DmaTx_0 + channelIndex) */
#endif                    
...
#else					
                    srcSFR = IfxLeth_getSrcPointer(lethSFR, (IfxLeth_ServiceRequest)(IfxLeth_ServiceRequest_DmaRx_0 + channelIndex)); /* Leth DMA Rx Channel node indexed by (IfxLeth_ServiceRequest_DmaRx_0 + channelIndex) */
#endif                    
