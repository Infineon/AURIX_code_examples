...
const Ifx_Ssw_Bmhd bmhd_0_orig = {
    .sal    = 0xAE400900U,           /* 0x000: System address of BMHD */
    ...
    .crc    = 0xE14060B8U,           /* 0x00C: .crc: Check Result for the BMI Header (offset 000H - 007H)*/
    .pw     = {
...
const Ifx_Ssw_Bmhd bmhd_1_orig = {
    .sal    = 0xAE400A00U,           /* 0x000: System address of BMHD */
    ...
    .crc    = 0x0A77DBBBU,           /* 0x008: .crc: Check Result for the BMI Header (offset 000H - 007H)*/
    .pw     = {
        0x00000000U,                 /* 0x100: .pw0: Password protection word 0 (lsw) */
        0x00000000U,                 /* 0x104: .pw1: Password protection word 1 */
        0x00000000U,                 /* 0x108: .pw2: Password protection word 2 */
...
const Ifx_Ssw_Bmhd bmhd_2_orig = {
    .sal    = 0xAE400B00U,           /* 0x000: System address of BMHD */
    .bmi    = 0x0FU,                 /* 0x000: .bmi: Boot Mode Index (BMI)*/
    .bmhdid = 0xB359U,               /* 0x002: .bmhdid: Boot Mode Header ID (CODE) = B359H*/
    .stad   = 0xA0000000U,           /* 0x004: .stad: User Code start address*/
    .crc    = 0xE5B5B085U,           /* 0x008: .crc: Check Result for the BMI Header (offset 000H - 007H)*/
    .pw     = {
        0x00000000U,                 /* 0x100: .pw0: Password protection word 0 (lsw) */
        0x00000000U,                 /* 0x104: .pw1: Password protection word 1 */
        0x00000000U,                 /* 0x108: .pw2: Password protection word 2 */
...
const Ifx_Ssw_Bmhd bmhd_3_orig = {
    .sal    = 0xAE400C00U,           /* 0x000: System address of BMHD */
    .bmi    = 0x0FU,                 /* 0x000: .bmi: Boot Mode Index (BMI)*/
    .bmhdid = 0xB359U,               /* 0x002: .bmhdid: Boot Mode Header ID (CODE) = B359H*/
    .stad   = 0xA0000000U,           /* 0x004: .stad: User Code start address*/
    .crc    = 0x0769ABFCU,           /* 0x008: .crc: Check Result for the BMI Header (offset 000H - 007H)*/
    .pw     = {
        0x00000000U,                 /* 0x100: .pw0: Password protection word 0 (lsw) */
        0x00000000U,                 /* 0x104: .pw1: Password protection word 1 */
        0x00000000U,                 /* 0x108: .pw2: Password protection word 2 */
