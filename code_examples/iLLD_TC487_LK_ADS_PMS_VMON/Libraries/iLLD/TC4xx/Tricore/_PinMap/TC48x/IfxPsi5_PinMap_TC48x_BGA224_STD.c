/**
 * \file IfxPsi5_PinMap_TC48x_BGA224_STD.c
 * \brief PSI5  details
 *
...
#include "IfxPsi5_PinMap_TC48x_BGA224_STD.h"
...
IfxPsi5_Tx_Out IfxPsi5_TX0_P00_0_OUT = {&MODULE_PSI5, (IfxPsi5_ChannelId)0, {&MODULE_P00, 0}, IfxPort_OutputIdx_alt6};
