/**
 * \file IfxEray_PinMap_TC48x_BGA436_COM.c
 * \brief ERAY  details
 *
...
#include "IfxEray_PinMap_TC48x_BGA436_COM.h"
...
IfxEray_Txd_Out  IfxEray0_TXDB_P02_12_OUT = {&MODULE_ERAY0, (IfxEray_NodeId)1, {&MODULE_P02, 12}, IfxPort_OutputIdx_alt5};
...
IfxEray_Txen_Out IfxEray0_TXENB_P02_14_OUT = {&MODULE_ERAY0, (IfxEray_NodeId)1, {&MODULE_P02, 14}, IfxPort_OutputIdx_alt5};
