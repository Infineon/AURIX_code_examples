 ...
 *
 * \defgroup IfxLld_Gtm_Pwm PWM Driver
 * \ingroup IfxLld_Gtm
 * \defgroup IfxLld_Gtm_Pwm_Enumerations Enumerations
 * \ingroup IfxLld_Gtm_Pwm
 * \defgroup IfxLld_Gtm_Pwm_Config_Structures Config Structures
 * \ingroup IfxLld_Gtm_Pwm
 * \defgroup IfxLld_Gtm_Pwm_Handle_Structures Handle Structures
 * \ingroup IfxLld_Gtm_Pwm
 * \defgroup IfxLld_Gtm_Pwm_Init_APIs Initialization APIs
 * \ingroup IfxLld_Gtm_Pwm
 * \defgroup IfxLld_Gtm_Pwm_Runtime_APIs Runtime APIs
 * \ingroup IfxLld_Gtm_Pwm
 */
...
/** \addtogroup IfxLld_Gtm_Pwm_Enumerations
 * \{ */
/** \brief PWM Alignment
 */
typedef enum
...
/** \addtogroup IfxLld_Gtm_Pwm_Config_Structures
 * \{ */
...
typedef struct
{
    ...
    Ifx_Priority        priority;          /**< \brief Priority for Ccu0/1 interrupt. Range: 0 to 0xFF */
...
/** \addtogroup IfxLld_Gtm_Pwm_Handle_Structures
 * \{ */
...
typedef struct
{
    ...
    IfxGtm_Pwm_SubModule_Ch     timerCh;           /**< \brief Channel Index */
    uint32                      phaseTicks;        /**< \brief Current phase ticks. Range: 0 to 0xFFFFFF */
    uint32                      dutyTicks;         /**< \brief Current duty ticks. Range: 0 to 0xFFFFFF */
} IfxGtm_Pwm_Channel;
...
typedef struct
{
    ...
    uint32                   upenMask0;           /**< \brief UPEN Mask for reg0 [AGC/TGC[0/1]]_GLB_CTRL. Range: 0 to 0xFFFF */
    uint32                   upenMask1;           /**< \brief UPEN Mask for reg1 [AGC/TGC[0/1]]_GLB_CTRL. Range: 0 to 0xFFFF */
...
typedef struct
{
    ...
    uint32                   periodTicks;             /**< \brief Current PWM Period in ticks. Range: 0 to 0xFFFFFF */
    IfxGtm_Pwm_ClockSource   clockSource;             /**< \brief Clock source for Atom/Tom channels */
    IfxGtm_Dtm_ClockSource   dtmClockSource;          /**< \brief Clock source for DTM channels */
    boolean                  syncUpdateEnabled;       /**< \brief TRUE: Update compare registers from shadow at the end of period */
...
/** \addtogroup IfxLld_Gtm_Pwm_Init_APIs
 * \{ */
 ...
 *
 * \param[inout] config Configuration structure.
 ...
 * \param[in]    config   Configuration structure. Length of array is specified in config parameter.
 *
 * \retval None
 */
...
/** \addtogroup IfxLld_Gtm_Pwm_Runtime_APIs
 * \{ */
 ...
 * \param[in]    subModule  ATOM/TOM. Range: \ref IfxGtm_Pwm_SubModule.
 * \param[in]    channel    Channel index. Range: \ref IfxGtm_Pwm_SubModule_Ch.
 * \param[in]    polarity   Active high/low. Range: \ref Ifx_ActiveState.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] pwm1 First PWM handle.
 * \param[inout] pwm2 Second PWM handle.
 *
 * \retval None
 */
 ...
 *
 * \param[in] pwm1 First PWM handle.
 * \param[in] pwm2 Second PWM handle.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] pwm1             PWM handle 1.
 * \param[inout] pwm2             PWM handle 2.
 * \param[in]    requestFrequency Requested frequency in Hz.
 *
 * \retval None
 */
 ...
 * \param[in]    requestPhase New phase value (applicable for edge aligned sync channel). Range: \ref IfxGtm_Pwm_SyncChannelIndex.
 ...
 * It is recommended to use this API only for edge aligned PWM.
 *
 * \param[inout] pwm          PWM handle.
 * \param[in]    requestPhase New phase value(applicable for edge aligned sync channel).
 * \param[in]    requestDuty  New duty value.
 ...
 *
 * \param[inout] channel Channel handle.
...
{
    IfxGtm_Pwm_Channel *channel     = &pwm->channels[configIndex];
    boolean             baseChannel = (configIndex == IfxGtm_Pwm_SyncChannelIndex_0);
