...
/** \Alias type used in Dsadc module to represent ADC interrupt configuration. Maps IfxAdc_Dsadc_DmaSrvReq to the generic IfxAdc_SrvReq structure,
 ...
 */
typedef IfxAdc_SrvReq IfxAdc_Dsadc_DmaSrvReq;

/** \Alias type used in Dsadc module to represent ADC interrupt configuration. Maps IfxAdc_Dsadc_InterruptConfig to the generic IfxAdc_SrvReq structure,
  * which encapsulates interrupt priority, type of service (TOS), and optional virtual machine ID (VM ID) for ADC-related interrupts.
  */
typedef IfxAdc_SrvReq IfxAdc_Dsadc_InterruptConfig;
...
typedef struct
{
    uint8                           sdPositive;        /**< \brief Sign delay value for positive halfwave. Range: 0xFF */
    uint8                           sdNegative;        /**< \brief Sign delay value for negative halfwave. Range: 0xFF */
...
typedef struct
{
    ...
    boolean                     enableAuxCIC;           /**< \brief Range: TRUE: Auxiliary CIC filter enabled, FALSE: Auxiliary CIC filter disabled */
...
typedef struct
{
    ...
    uint8                            numCycles;                   /**< \brief Number of Cycles for internal window control (REPVAL). Range: 0x0F */
    uint8                            numAccValues;                /**< \brief Number of values to accumulate per cycle (INVAL) */
    uint8                            numDiscardValues;            /**< \brief Number of values to discard (NUMVALDIS). Range: 0 to 0x3F */
    ...
    boolean                          resultUpdateMode;            /**< \brief if TRUE: Results generated only during integration window, FALSE: Results generated independent of integration window */
...
typedef struct
{
    ...
    uint16                    offsetComp;         /**< \brief Offset Compensation value. Range: 0 to 0xFFFF */
...
typedef struct
{
    uint16                 delayCount;       /**< \brief Delay count (80MHz clock). Range: 0 to 0xFFFF */
    IfxAdc_DsadcTriggerSel triggerSel;       /**< \brief Select the source of the HW Trigger */
...
typedef struct
{
    uint8 positivePins;       /**< \brief Positive pin connections to Vcm (DSADCx_VCM). Range: 0 to 0xF */
    uint8 negativePins;       /**< \brief Negative pin connections to Vcm (DSADCx_VCM). Range: 0 to 0xF */
...
typedef struct
{
    ...
    boolean                     srvReqGateEnable;       /**< \brief TRUE --> Service Request gate enabled, FALSE --> Service request 2 gate disabled */
...
typedef struct
{
    ...
    boolean                      sr1Enable;                                    /**< \brief Enable or disable for service request 1. Enable or disable for service request 1. Service request for result event from auxiliary filter chain */
    boolean                      sr2Enable;                                    /**< \brief Enable or disable for service request 2. Enable or disable for service request 2. Service request for alarms: limit checking */
...
typedef struct
{
    IfxAdc_Dsadc_InterruptConfig intCfg[IFXADC_DSADC_MAX_SERV_REQ_NODE];       /**< \brief Interrupt configuration */
    IfxAdc_DsadcSrvReq0          sr0Enable;                                    /**< \brief Service request for result event from main filter chain */
    boolean                      sr1Enable;                                    /**< \brief Service request for result event from auxiliary filter chain. Range: TRUE: Service request for SR1 Enabled, FALSE: Service request for SR1 Disabled */
    boolean                      sr2Enable;                                    /**< \brief Service request for alarms: limit checking. Range: TRUE: Service request for SR2 Enabled, FALSE: Service request for SR2 Disabled */
    boolean                      sr3Enable;                                    /**< \brief Service request for special events: timestamp trigger or capture event for sign delay measurement. Range: TRUE: Service request for SR3 Enabled, FALSE: Service request for SR3 Disabled */
    boolean                      enableServiceReq;                             /**< \brief Range: TRUE: enable service request configurations, FALSE: disable service request configurations */
...
typedef struct
{
    ...
    boolean                         enableFilterChain;         /**< \brief If TRUE: Filter chain is enabled, FALSE: Filter chain is disabled */
...
typedef struct
{
    ...
    boolean                 queueEnabled;       /**< \brief Range: TRUE: queue enabled, FALSE: queue disabled */
} IfxAdc_Dsadc_Queue;
...
typedef struct
{
    ...
    boolean timestampStatus;       /**< \brief Time stamp status. Range: TRUE: Time stamp is enabled, FALSE: Time stamp is disabled */
} IfxAdc_Dsadc_Result;
...
typedef struct
{
    ...
    boolean                   enableTimeStamp;       /**< \brief Enable Time Stamp. Range: TRUE: Time stamp os enabled, FALSE: Time stamp is disabled */
...
typedef struct
{
    ...
    boolean                    enableCounter;       /**< \brief Range: TRUE: Counter starts counting at TSCLK rate, FASLE: Timestamp counter is off */
...
typedef struct
{
    ...
    uint16                        calTarget;                  /**< \brief Target value for the calibration algorithm. Range: 0 to 0xFFFF */
    uint16                        gainCorrectionFactor;       /**< \brief Multiplication Factor for Gain Correction During Calibration. Range: 0 to 0x1FFF */
...
typedef struct
{
    ...
    boolean                   fifoEnabled;            /**< \brief Range: TRUE: FIFO is enabled for this channel, FALSE: FIFO is disabled */
    boolean                   timeStampEnabled;       /**< \brief Range: TRUE: time stamp read is enabled for channel, FALSE: time stamp read is disabled */
...
typedef struct
{
    ...
    IfxAdc_DsadcChannel                  channelId;             /**< \brief Channel ID */
    boolean                              autoCalibration;       /**< \brief Range: TRUE: automatic calibration is enabled, FALSE: automatic calibration is disabled */
 ...
 *
 * \param[inout] config Pointer to the configuration
 ...
 *
 * \param[inout] dsadc  pointer to the DSADC driver handle
 * \param[in]    config Pointer to the DSADC configuration
 *
 * \retval None
 */
 ...
 *
 * \param[inout] dsadc      Pointer to module handle
 * \param[in]    carrierCfg Pointer to the Carrier Signal Configuration
 *
 * \retval None
 */
 ...
 *
 * \param[inout] config Carrier generation configuration structure
 *
 * \retval None
 */
 ...
 *
 * \param[in] channelId Pointer to the dsadc sfr structure
 * \param[in] offsetCfg Offset Compensation configuration
 *
 * \retval None
 */
 ...
 *
 * \param[inout] channel Handle of Exmod channel
 * \param[in]    config  Pointer to the channel configuration
 *
 * \retval None
 */
 ...
 *
 * \param[inout] channel Handle of DSADC channel
 * \param[in]    config  Pointer to the channel configuration
 *
 * \retval None
 */
 ...
 * \param[in]     adc    Pointer to ADC sfr
 *
 * \retval None
 */
 ...
 *
 * \param[inout] config Initialize the Exmod channel configuration to default values
 * \param[in]    adc    Pointer to ADC module sfr
 *
 * \retval None
 */
 ...
 *
 * \param[inout] dsadc        Pointer to Dsadc channel sfr
 * \param[in]    rectifierCfg Pointer to the rectifier Configuration
 *
 * \retval None
 */
 ...
 * \param[in] gainCfg   Pointer to the Gain configuration
 *
 * \retval None
 */
 ...
 *
 * \retval Result value (16bit) of channel
 * Range: 0xFFFF
 */
 ...
 *
 * \param[inout] channel Pointer to the Exmod channel handle
 *
 * \retval Result value (16bit) of channel.
 * Returns previous result if result flag not set.
 * Range: 0 to 0xFFFF
 ...
 *
 * \param[inout] channel Pointer to dsadc handle
 *
 * \retval None
 */
 ...
 *
 * \param[in] channel Pointer to dsadc handle
 *
 * \retval Returns Buffer full status
 ...
 * \param[in] channel Pointer to dsadc handle
 *
 * \retval Returns buffer empty status
 ...
 *
 * \param[inout] channel Pointer to Exmod handle
 *
 * \retval None
 */
 ...
 *
 * \param[in] channel Pointer to Exmod handle
 *
 * \retval Returns Buffer full status.
 * Range: TRUE : Buffer Full
 *        FALSE: Buffer not full
 ...
 *
 * \param[inout] channel    Handle of DSADC channel
 * \param[in]    lowerBound Lower Boundary value for limit checking
 *                          Range: 0 to 0xFFFF
 * \param[in]    upperBound Upper Boundary value for limit checking
 *                          Range: 0 to 0xFFFF
 *
 * \retval None
 */
 ...
 *
 * \param[inout] modptr                   Pointer to module handle.
 * \param[in]    dsadcChannelsEnableValue Value to enable the DSADC channels (setting the each bit in this specifies the enable of
 ...
 *
 * \param[inout] modptr                      Pointer to module handle.
 * \param[in]    dsadcFilterChainEnableValue Value to enable the filter chain of DSADC channels (setting the each bit in this specifies the enable of
 ...
 *
 * \param[inout] modptr                      Pointer to module handle.
 * \param[in]    exmodFilterChainEnableValue Value to enable the filter chain of EXMOD channels (setting the each bit in this specifies the enable of
 ...
 *
 * \param[inout] modptr                    Pointer to module handle.
 * \param[in]    dsadcChannelsDisableValue Value to disable the DSADC channels (setting the each bit to value 0 in this specifies the disable  of
 ...
 * \param[inout] modptr                       Pointer to module handle.
 * \param[in]    dsadcFilterChainDisableValue Value to disable the filter chain of DSADC channels (setting the each bit to value 0 in this specifies the disable of
 ...
 *
 * \param[inout] modptr                       Pointer to module handle.
 * \param[in]    exmodFilterChainDisableValue Value to disable the filter chain of EXMOD channels (setting the each bit to 0 in this specifies the disable of
 ...
 * \param[in] channel Pointer to dsadc handle
 *
 * \retval Returns number of valid result in buffer.
 * Range: 0 to 0xFFFF
 */
 ...
 *
 * \param[inout] channel Pointer to dsadc channel information
 * \param[inout] buffer  Pointer to the buffer
 * \param[in]    size    Size of the buffer
 *                       Range: \ref IfxAdc_Dsadc_BufferSize
 *
 * \retval 
 ...
 *
 * \param[inout] channel Pointer to Exmod channel information
 * \param[inout] buffer  Pointer to the buffer
 * \param[in]    size    Size of the buffer
 *                       Range: \ref IfxAdc_Dsadc_BufferSize
 *
 ...
 *
 * \param[inout] channel Pointer to dsadc channel handle
 *
 ...
 *
 * \param[inout] channel Pointer to Exmod channel handle
 *
 * \retval Returns immediate unread data from the Exmod channel buffer.
 * Range: 0 to 0xFFFF
 */
 ...
 *
 * \param[inout] channel Pointer to dsadc channel handle
 * \param[inout] resBuff Buffer to store result
 ...
 *
 * \param[inout] channel Pointer to dsadc Exmod handle
 *
 * \retval None
 */
 ...
 * \param[in] integratorCfg Pointer to the Integrator Configuration
 * \param[in] hasAnalogMod  DSADC_IN or DSADC_EX mode
 *                          Range: True  --> Function is intended to be used for Dsadc channel
