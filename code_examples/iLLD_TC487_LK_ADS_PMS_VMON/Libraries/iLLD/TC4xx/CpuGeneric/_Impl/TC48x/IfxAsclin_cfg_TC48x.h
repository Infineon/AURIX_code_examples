...
#ifndef IFXASCLIN_CFG_TC48X_H
#define IFXASCLIN_CFG_TC48X_H 1
 ...
 */
#define IFXASCLIN_NUM_MODULES (20)

/** \brief Availability of ASCLIN SPI Data Width 32 bits
 */
#define IFXASCLIN_SPI_IS_DATAWIDTH32_AVAILABLE  (TRUE)
