...
#ifndef IFXHSPHY_CFG_TC48X_H
#define IFXHSPHY_CFG_TC48X_H 1
 ...
 */
#define IFXHSPHY_NUM_CHANNELS        				 (1)
 ...
 */
#define IFXHSPHY_ACTUAL_NUM_OF_PHY   				 (1)
 ...
 */
#define IFXHSPHY_IS_PADINTERFACE_USXSGMII_AVAILABLE  (FALSE)

/** \brief Availability of Interface Pad PCIE
 */
#define IFXHSPHY_IS_PADINTERFACE_PCIE_AVAILABLE      (FALSE)
 ...
 */
#define IFXHSPHY_IS_PHY0_AVAILABLE   				 (FALSE)

/** \brief Availability of PHY2
 */
#define IFXHSPHY_IS_PHY2_AVAILABLE   				 (FALSE)
 ...
 */
#define IFXHSPHY_IS_TRGTDEVICE_PCIE 				 (FALSE)
 ...
 */
#define IFXHSPHY_XDATAPATH_INIT_TRIG		 		 (TRUE)

/** \brief Timeout Check
 */
#define IFXHSPHY_TIMEOUT_CHECK 					     (TRUE)

/** \brief TARGET IDX value
 */
#define IFXHSPHY_TRGTDEVICE_IDX_VALUE   			 (1)

/** \brief Start index of the PHYs
 */
#define IFXHSPHY_START_INDEX 						 (1)

/** \brief End index of the PHYs
 */
#define IFXHSPHY_END_INDEX   						 (2)
...
#define IFXHSPHY_CONFIG_LOOKUPTBL_VALUES { \
    ...
    {IfxHsphy_PhyIndex_1,    IfxHsphy_PadNativeInterface_rgmiiPads, IfxHsphy_TrgtDevice_xgmac, 1, IfxHsphy_TrgtDeviceSpeed_0P1G,          NULL_PTR}, \
    {IfxHsphy_PhyIndex_1,    IfxHsphy_PadNativeInterface_rgmiiPads, IfxHsphy_TrgtDevice_xgmac, 1, IfxHsphy_TrgtDeviceSpeed_1G,            NULL_PTR}, \
    {IfxHsphy_PhyIndex_1,    IfxHsphy_PadNativeInterface_rgmiiPads, IfxHsphy_TrgtDevice_xgmac, 1, IfxHsphy_TrgtDeviceSpeed_0P01G,         NULL_PTR}, \
...
typedef enum
{
    ...
    IfxHsphy_PhyIndex_none = 1  /**< \brief PHY index none */
} IfxHsphy_PhyIndex;
...
typedef enum
{
    IfxHsphy_PadNativeInterface_sgmii = 0,  /**< \brief Pad Interface selection for sgmii */
...
typedef enum
{
    ...
    IfxHsphy_XpcsIndex_max = 1  /**< \brief Max value of XPCS index */
} IfxHsphy_XpcsIndex;
...
typedef enum
{
    ...
    IfxHsphy_EthIndex_max  = 1, /**< \brief Max index for ETH */
    IfxHsphy_EthIndex_none = 2  /**< \brief None */
} IfxHsphy_EthIndex;
