...
#ifndef IFXADC_CFG_TC48X_H
#define IFXADC_CFG_TC48X_H 1
 ...
 */
#define IFXADC_NUM_TMADC             (5)

#define IFXADC_NUM_SAR_CORES         (10)

/** \brief Number of DSADC IN Channels
 */
#define IFXADC_NUM_DSADC_IN_CHANNELS (3)

/** \brief Number of CDSP Cores
 */
#define IFXADC_NUM_CDSP_CORES        (3)
...
typedef enum
{
    ...
    IfxAdc_CdspCore_count = 3   /**< \brief Count */
} IfxAdc_CdspCore;
...
typedef enum
{
    ...
    IfxAdc_DsadcChannel_count = 3   /**< \brief Count */
} IfxAdc_DsadcChannel;
...
typedef enum
{
    ...
    IfxAdc_TmadcModule_count = 5   /**< \brief Count */
} IfxAdc_TmadcModule;

#endif /* IFXADC_CFG_TC48X_H */
