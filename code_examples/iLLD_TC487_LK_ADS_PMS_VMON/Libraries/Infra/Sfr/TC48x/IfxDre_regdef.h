...
/** \brief CAN 0 resource partition */
...
/** \brief DMA 0 resource partition */
...
/** \brief Destination memory 0 configuration */
...
/** \brief Destination memory 0 transfer mode configuration */
...
/** \brief Destination memory 0 resource partition */
...
/** \brief Destination memory 0 status */
...
/** \brief Ethernet input buffer 0 configuration */
...
/** \brief Ethernet input buffer 0 error */
...
/** \brief Ethernet input buffer 0 status */
...
/** \brief Ethernet output buffer 0 configuration */
...
/** \brief Ethernet output buffer 0 error */
...
/** \brief Ethernet output buffer 0 MAC header 0 */
...
/** \brief Ethernet output buffer 0 MAC header 1 */
...
/** \brief Ethernet output buffer 0 MAC header 2 */
...
/** \brief Ethernet output buffer 0 MAC header 3 */
...
/** \brief Ethernet output buffer 0 MAC header 4 */
...
/** \brief Ethernet output buffer 0 NTSCF header */
...
/** \brief Ethernet output buffer 0 Stream ID configuration 0 */
...
/** \brief Ethernet output buffer 0 Stream ID configuration 1 */
...
/** \brief Ethernet output buffer 0 status */
...
/** \brief Ethernet output buffer 0 Transmit trigger configuration */
...
/** \brief Ethernet output buffer 0 Timer threshold and status */
...
typedef struct _Ifx_DRE_EWDCFG_Bits
{
    ...
    __IO Ifx_Strict_32Bit MWW:1;           /**< \brief [2:2] Multi-cast Wait Writeback (rw) */
...
/** \brief Rx Ethernet descriptor list 0 configuration and control */
...
/** \brief CAN transmit routing table 0 configuration */
...
/** \brief Stream ID filter 0 configuration */
...
/** \brief Stream ID filter 0 configuration Stream ID filter 1 higher */
...
/** \brief Stream ID filter 0 configuration Stream ID filter 1 lower */
...
/** \brief Stream ID filter 0 configuration Stream ID filter 2 higher */
...
/** \brief Stream ID filter 0 configuration Stream ID filter 2 lower */
...
/** \brief Tx Ethernet descriptor list 0 configuration and control */
typedef struct _Ifx_DRE_TETHDL_CTRL_Bits
{
    ...
    __IO Ifx_Strict_32Bit SDM:1;           /**< \brief [7:7] Single Descriptor Mode (rw) */
    __I  Ifx_Strict_32Bit :11;             /**< \brief [18:8] \internal Reserved */
...
{
       __IO Ifx_DRE_ACCEN_WRA                   WRA;                    /**< \brief 0, Write access enable register A 0*/
       __IO Ifx_DRE_ACCEN_WRB_SRI               WRB;                    /**< \brief 4, Write access enable register B 0*/
       __IO Ifx_DRE_ACCEN_RDA                   RDA;                    /**< \brief 8, Read access enable register A 0*/
       __IO Ifx_DRE_ACCEN_RDB_SRI               RDB;                    /**< \brief C, Read access enable register B 0*/
       __IO Ifx_DRE_ACCEN_VM                    VM;                     /**< \brief 10, VM access enable register 0*/
       __IO Ifx_DRE_ACCEN_PRS                   PRS;                    /**< \brief 14, PRS access enable register 0*/
       __I  Ifx_UReg_8Bit                       reserved_18[8];         /**< \brief 18, \internal Reserved */
} Ifx_DRE_ETH_ACCEN;
...
{
       __IO Ifx_DRE_ETH_ACCEN                   ACCEN;                  /**< \brief 0, ACCEN register set j*/
} Ifx_DRE_ETH;
...
{
       __IO Ifx_DRE_CAN_RP                      RP;                     /**< \brief 0, CAN 0 resource partition*/
} Ifx_DRE_CAN;
...
typedef volatile struct _Ifx_DRE_EIBUF
{
       ...
       __IO Ifx_DRE_EIBUF_CONFIG                CONFIG;                 /**< \brief 4, Ethernet input buffer 0 configuration*/
       __I  Ifx_UReg_8Bit                       reserved_8[4];          /**< \brief 8, \internal Reserved */
       __IO Ifx_DRE_EIBUF_ERROR                 ERROR;                  /**< \brief C, Ethernet input buffer 0 error*/
       __IO Ifx_DRE_EIBUF_STATUS                STATUS;                 /**< \brief 10, Ethernet input buffer 0 status*/
} Ifx_DRE_EIBUF;
...
{
       __IO Ifx_DRE_EOBUF_MAC_H0                H0;                     /**< \brief 0, Ethernet output buffer 0 MAC header 0*/
       __IO Ifx_DRE_EOBUF_MAC_H1                H1;                     /**< \brief 4, Ethernet output buffer 0 MAC header 1*/
       __IO Ifx_DRE_EOBUF_MAC_H2                H2;                     /**< \brief 8, Ethernet output buffer 0 MAC header 2*/
       __IO Ifx_DRE_EOBUF_MAC_H3                H3;                     /**< \brief C, Ethernet output buffer 0 MAC header 3*/
       __IO Ifx_DRE_EOBUF_MAC_H4                H4;                     /**< \brief 10, Ethernet output buffer 0 MAC header 4*/
} Ifx_DRE_EOBUF_MAC;
...
{
       __IO Ifx_DRE_EOBUF_NTSCF_H0              H0;                     /**< \brief 0, Ethernet output buffer 0 NTSCF header*/
       __IO Ifx_DRE_EOBUF_NTSCF_STREAM0_ID      STREAM0_ID;             /**< \brief 4, Ethernet output buffer 0 Stream ID configuration 0*/
       __IO Ifx_DRE_EOBUF_NTSCF_STREAM1_ID      STREAM1_ID;             /**< \brief 8, Ethernet output buffer 0 Stream ID configuration 1*/
} Ifx_DRE_EOBUF_NTSCF;
...
{
       __I  Ifx_UReg_8Bit                       reserved_0[4];          /**< \brief 0, \internal Reserved */
       __IO Ifx_DRE_EOBUF_CONFIG                CONFIG;                 /**< \brief 4, Ethernet output buffer 0 configuration*/
       __IO Ifx_DRE_EOBUF_MAC                   MAC;                    /**< \brief 8, Ethernet output buffer 0 MAC header*/
       __IO Ifx_DRE_EOBUF_NTSCF                 NTSCF;                  /**< \brief 1C, Ethernet output buffer 0 NTSCF header*/
       __IO Ifx_DRE_EOBUF_STATUS                STATUS;                 /**< \brief 28, Ethernet output buffer 0 status*/
       __IO Ifx_DRE_EOBUF_TTC                   TTC;                    /**< \brief 2C, Ethernet output buffer 0 Transmit trigger configuration*/
       __IO Ifx_DRE_EOBUF_TTS                   TTS;                    /**< \brief 30, Ethernet output buffer 0 Timer threshold and status*/
       __IO Ifx_DRE_EOBUF_ERROR                 ERROR;                  /**< \brief 34, Ethernet output buffer 0 error*/
} Ifx_DRE_EOBUF;
...
{
       __IO Ifx_DRE_SIDF_FIL1_L                 L;                      /**< \brief 0, Stream ID filter 0 configuration Stream ID filter 1 lower*/
       __IO Ifx_DRE_SIDF_FIL1_H                 H;                      /**< \brief 4, Stream ID filter 0 configuration Stream ID filter 1 higher*/
} Ifx_DRE_SIDF_FIL1;
...
{
       __IO Ifx_DRE_SIDF_FIL2_L                 L;                      /**< \brief 0, Stream ID filter 0 configuration Stream ID filter 2 lower*/
       __IO Ifx_DRE_SIDF_FIL2_H                 H;                      /**< \brief 4, Stream ID filter 0 configuration Stream ID filter 2 higher*/
} Ifx_DRE_SIDF_FIL2;
...
{
       __IO Ifx_DRE_SIDF_FC                     FC;                     /**< \brief 0, Stream ID filter 0 configuration*/
...
{
       __I  Ifx_UReg_8Bit                       reserved_0[4];          /**< \brief 0, \internal Reserved */
       __IO Ifx_DRE_RT_CONFIG                   CONFIG;                 /**< \brief 4, CAN transmit routing table 0 configuration*/
} Ifx_DRE_RT;
...
{
       __I  Ifx_UReg_8Bit                       reserved_0[4];          /**< \brief 0, \internal Reserved */
       __IO Ifx_DRE_DMEM_CONFIG                 CONFIG;                 /**< \brief 4, Destination memory 0 configuration*/
       __IO Ifx_DRE_DMEM_MODE                   MODE;                   /**< \brief 8, Destination memory 0 transfer mode configuration*/
       __I  Ifx_UReg_8Bit                       reserved_C[12];         /**< \brief C, \internal Reserved */
       __IO Ifx_DRE_DMEM_STATUS                 STATUS;                 /**< \brief 18, Destination memory 0 status*/
       __IO Ifx_DRE_DMEM_RP                     RP;                     /**< \brief 1C, Destination memory 0 resource partition*/
} Ifx_DRE_DMEM;
...
{
       __I  Ifx_UReg_8Bit                       reserved_0[4];          /**< \brief 0, \internal Reserved */
       __IO Ifx_DRE_RETHDL_CTRL                 CTRL;                   /**< \brief 4, Rx Ethernet descriptor list 0 configuration and control*/
} Ifx_DRE_RETHDL;
...
{
       __I  Ifx_UReg_8Bit                       reserved_0[4];          /**< \brief 0, \internal Reserved */
       __IO Ifx_DRE_TETHDL_CTRL                 CTRL;                   /**< \brief 4, Tx Ethernet descriptor list 0 configuration and control*/
...
{
       __IO Ifx_DRE_DMA_RP                      RP;                     /**< \brief 0, DMA 0 resource partition*/
} Ifx_DRE_DMA;
...
typedef volatile struct _Ifx_DRE
{
       ...
       __IO Ifx_DRE_EIBUF                       EIBUF[6];               /**< \brief 10D4, Ethernet input buffer 0 status*/
       __IO Ifx_DRE_EOBUF                       EOBUF[6];               /**< \brief 114C, Ethernet output buffer 0 error*/
       __IO Ifx_DRE_SIDF                        SIDF[8];                /**< \brief 129C, Filter 2*/
       __IO Ifx_DRE_RT                          RT[4];                  /**< \brief 133C, CAN transmit routing table 0 configuration*/
       ...
       __IO Ifx_DRE_DMEM                        DMEM[28];               /**< \brief 1378, Destination memory 0 resource partition*/
       ...
       __IO Ifx_DRE_RETHDL                      RETHDL[6];              /**< \brief 1718, Rx Ethernet descriptor list 0 configuration and control*/
       ...
       __IO Ifx_DRE_DMA                         DMA[6];                 /**< \brief 17FC, DMA 0 resource partition*/
