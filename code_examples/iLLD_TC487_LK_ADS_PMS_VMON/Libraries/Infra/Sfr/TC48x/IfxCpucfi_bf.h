...
/** \brief Length for Ifx_CPUCFI_PFIBUFDIS_Bits.DISR */
#define IFX_CPUCFI_PFIBUFDIS_DISR_LEN (1u)

/** \brief Mask for Ifx_CPUCFI_PFIBUFDIS_Bits.DISR */
#define IFX_CPUCFI_PFIBUFDIS_DISR_MSK (0x1u)

/** \brief Offset for Ifx_CPUCFI_PFIBUFDIS_Bits.DISR */
#define IFX_CPUCFI_PFIBUFDIS_DISR_OFF (0u)

/** \brief Length for Ifx_CPUCFI_PFIBUFDIS_Bits.DISS */
#define IFX_CPUCFI_PFIBUFDIS_DISS_LEN (1u)

/** \brief Mask for Ifx_CPUCFI_PFIBUFDIS_Bits.DISS */
#define IFX_CPUCFI_PFIBUFDIS_DISS_MSK (0x1u)

/** \brief Offset for Ifx_CPUCFI_PFIBUFDIS_Bits.DISS */
#define IFX_CPUCFI_PFIBUFDIS_DISS_OFF (1u)
