...
/** \brief MPLLA analog test bus controls (1 of 3) */
typedef struct _Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB1_Bits
{
    __IO Ifx_UReg_16Bit OVERRIDE_VREG_LEFT:1;    /**< \brief [0:0] Sets MPLLA vreg_left voltage to be 3 time the voltage applied on atb_s_m pin  - 1: vreg_left voltage: 3 times the voltage that is applied on the atb_s_m pin  - 0: vreg_left voltage is internally generated (rw) */
    __IO Ifx_UReg_16Bit OVERRIDE_VREG_RIGHT:1;    /**< \brief [1:1] Sets MPLLA vreg_right voltage to be 3 times the voltage applied on atb_s_m pin  - 1: vreg_right voltage: 3 times the voltage that is applied on the atb_s_m pin  - 0: vreg_right voltage is internally generated (rw) */
    __IO Ifx_UReg_16Bit OVERRIDE_VREG_VP:1;    /**< \brief [2:2] Sets the MPLLA vreg_vp voltage to be 3 times the voltage applied on atb_s_m pin  - 1: vreg_vp voltage: 3 times the voltage that is applied on the atb_s_m pin  - 0: vreg_vp voltage is internally generated (rw) */
    __IO Ifx_UReg_16Bit OVERRIDE_VREG_PMIX:1;    /**< \brief [3:3] Sets the MPLLA vreg_pmix voltage to be 3 times the voltage applied on atb_s_m pin  - 1: vreg_pmix voltage: 3 times the voltage that is applied on the atb_s_m pin  - 0: vreg_pmix voltage is internally generated (rw) */
    __IO Ifx_UReg_16Bit OVERRIDE_VREG:1;    /**< \brief [4:4] For future use (rw) */
    __IO Ifx_UReg_16Bit MEAS_VREG_VCO:1;    /**< \brief [5:5] For future use (rw) */
    __IO Ifx_UReg_16Bit MEAS_VREG_S:1;     /**< \brief [6:6] Measures the MPLLA charge pump output (vdd_h/2) voltage on the atb_s_p pin  - 1: Connects the MPLLA charge pump output (vdd_h/2) node to the atb_s_p pin for measurement  - 0: Disconnects MPLLA charge pump output (vdd_h/2) node from the atb_s_p pin (rw) */
    __IO Ifx_UReg_16Bit MEAS_VREG_L:1;     /**< \brief [7:7] Measures the vreg_left output voltage on the atb_s_p pin  - 1: Connects the vreg_left regulator output node to the atb_s_p pin for measurement  - 0: Disconnects the vreg_left regulator output node from the atb_s_p pin (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB1_Bits;

/** \brief MPLLA analog test bus controls (2 of 3) */
typedef struct _Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB2_Bits
{
    __IO Ifx_UReg_16Bit MEAS_VREG_R:1;     /**< \brief [0:0] Measures the MPLLA vreg_right voltage on the atb_s_p pin  - 1: Connects the vreg_right internal node to the atb_s_p pin for measurement  - 0: Disconnects the vreg_right internal node from the atb_s_p pin (rw) */
    __IO Ifx_UReg_16Bit MEAS_VREG_VP:1;    /**< \brief [1:1] Measures the MPLLA vp tracking regulator output (vreg_vp) voltage on the atb_s_p pin  - 1: Connects the vreg_vp internal node to the atb_s_p pin for measurement  - 0: Disconnects the vreg_vp internal node from the atb_s_p pin (rw) */
    __IO Ifx_UReg_16Bit MEAS_VREG_CP:1;    /**< \brief [2:2] For future use (rw) */
    __IO Ifx_UReg_16Bit MEAS_VP:1;         /**< \brief [3:3] Measures MPLLA internal analog low supply vp voltage on the atb_s_p pin  - 1: Connects the MPLLA internal analog low supply vp net to the atb_s_p pin for measurement  - 0: Disconnects the MPLLA internal analog low supply vp net from the atb_s_p pin (rw) */
    __IO Ifx_UReg_16Bit MEAS_GD:1;         /**< \brief [4:4] Measures the MPLLA internal analog ground gd voltage on the atb_s_p pin  - 1: Connects the MPLLA internal analog ground gd net to the atb_s_p pin for measurement  - 0: Disconnects the MPLLA internal analog ground gd net from the atb_s_p pin (rw) */
    __IO Ifx_UReg_16Bit MEAS_CTL_FINE:1;    /**< \brief [5:5] For future use (rw) */
    __IO Ifx_UReg_16Bit MEAS_MAG_CTRL:1;    /**< \brief [6:6] For future use (rw) */
    __IO Ifx_UReg_16Bit MEAS_MAG_REF:1;    /**< \brief [7:7] For future use (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB2_Bits;

/** \brief MPLLA analog test bus controls (3 of 3) */
typedef struct _Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB3_Bits
{
    __IO Ifx_UReg_16Bit FORCE_FINE_HIGH:1;    /**< \brief [0:0] For future use (rw) */
    __IO Ifx_UReg_16Bit FORCE_FINE_LOW:1;    /**< \brief [1:1] For future use (rw) */
    __IO Ifx_UReg_16Bit OVERRIDE_AMP_ATB:1;    /**< \brief [2:2] For future use (rw) */
    __IO Ifx_UReg_16Bit OVERRIDE_AMP_HIGH:1;    /**< \brief [3:3] For future use (rw) */
    __IO Ifx_UReg_16Bit OVERRIDE_AMP_LOW:1;    /**< \brief [4:4] For future use (rw) */
    __IO Ifx_UReg_16Bit MEAS_VBIAS_PMIX:1;    /**< \brief [5:5] Measure the vbias voltage inside phase mixer (pmix) on the atb_s_p pin  - 1: Connects the vbias internal node in pmix of MPLLA to atb_s_p pin for measurement  - 0: Disconnects the vbias internal node in pmix from the atb_s_p pin (rw) */
    __IO Ifx_UReg_16Bit MEAS_VREG_PMIX:1;    /**< \brief [6:6] Measure the MPLLA phase mixer regulator (vreg_pmix) voltage on the atb_s_p pin  - 1: Connects the vreg_pmix internal node of MPLLA to the atb_s_p pin for measurement  - 0: Disconnects the vreg_pmix internal node from the atb_s_p pin (rw) */
    __IO Ifx_UReg_16Bit ATB_SELECT:1;      /**< \brief [7:7] This bit connects/disconnects the internal ATB_S signals to external ATB_S signals  - 1: Connects the signals ATB_S signals to external ATB_S signals  - 0: Disconnects the signals (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB3_Bits;

/** \brief Configures MPLLA loop bandwidth */
typedef struct _Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_LOOP_CTRL_Bits
{
    __IO Ifx_UReg_16Bit CP_CNTRL:4;        /**< \brief [3:0] For future use (rw) */
    __IO Ifx_UReg_16Bit OVRD_CP_CONTROL:1;    /**< \brief [4:4] For future use (rw) */
    __IO Ifx_UReg_16Bit PMIX_TRIM:3;       /**< \brief [7:5] Use the following bit settings to control the current in the phase mixer in MPLLA  - 000: +55% of default currentf  - 001: +40% of default current  - 010: +27% of default current  - 011: +16% of default current  - 100: +7% of default current  - 101: default current=80uA  - 110: -7% of default current  - 111: -14% of default current (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_LOOP_CTRL_Bits;

/** \brief MPLLA Override Control Registers */
typedef struct _Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_OVRD_Bits
{
    __IO Ifx_UReg_16Bit OVRD_ENABLE:1;     /**< \brief [0:0] If this bit: 1, it allows bit 1 (enable_reg) to control enable signal (mplla_en) of MPLLA   - 1: Allows bit 1 (enable_reg) to control enable signal (mplla_en) of MPLLA  - 0: Instead of analog register, control this functionality externally using mplla_en pin (rw) */
    __IO Ifx_UReg_16Bit ENABLE_REG:1;      /**< \brief [1:1] If bit 0(ovrd_enable): 1, this bit controls the MPLLA enable signal  - 1: MPLLA is turned on  - 0: MPLLA is turned off (rw) */
    __IO Ifx_UReg_16Bit OVRD_CAL:1;        /**< \brief [2:2] If this bit: 1, it allows analog register bit 3(cal_reg) to control of calibration signal (mpll_cal)  - 1: One can use bit 3 (cal_reg) to turn ON/OFF the calibration of MPLLA  - 0: Instead of analog registers, internal state machines control this functionality (rw) */
    __IO Ifx_UReg_16Bit CAL_REG:1;         /**< \brief [3:3] If bit 2 (ovrd_cal): 1, this bit sets local calibration control to ON/OFF   - 1: Local calibration is turned on  - 0: Local calibration is turned off (rw) */
    __IO Ifx_UReg_16Bit OVRD_FB_CLK_EN:1;    /**< \brief [4:4] If this bit: 1, it allows bit 5 (fb_clk_en_reg) to control of feedback clock enabling signal (mpll_fb_clk_en)  - 1: One can use bit 5 (fb_clk_en_reg) to control feedback clock enabling function  - 0: Instead of analog register, internal state machines control this functionality (rw) */
    __IO Ifx_UReg_16Bit FB_CLK_EN_REG:1;    /**< \brief [5:5] If bit 4 (ovrd_fb_clk_en): 1, this bit controls the feedback clock control signal   - 1: Feedback clock is turned on  - 0: Feedback clock is turned off (rw) */
    __IO Ifx_UReg_16Bit OVERRIDE_INPUT_VREG_CP:1;    /**< \brief [6:6] For future use (rw) */
    __IO Ifx_UReg_16Bit OVRD_CTL_BUF_BYPASS:1;    /**< \brief [7:7] For future use (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_OVRD_Bits;

/** \brief CP regulator cco frequency tuning register */
typedef struct _Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_REG_Bits
{
    __IO Ifx_UReg_16Bit VREG_RING_CTR:2;    /**< \brief [1:0] Use these bits to control the charge pump oscillator frequency in MPLLA voltage regulators  - 00: Charge pump oscillator frequency in MPLLA voltage regulators: 300Mhz  - 01: Charge pump oscillator frequency in MPLLA voltage regulators: 600Mhz  - 10: Charge pump oscillator frequency in MPLLA voltage regulators: 900Mhz  - 11: Charge pump oscillator frequency in MPLLA voltage regulators: 1200Mhz (rw) */
    __IO Ifx_UReg_16Bit NC_5_2:4;          /**< \brief [5:2] For future use (rw) */
    __IO Ifx_UReg_16Bit OVRD_VREG_BYPASS:1;    /**< \brief [6:6] Control signal to override the external pin sup_ana_vreg_bypass_to_vp ,  - 1: Overrides the value of external pin sup_ana_vreg_bypass_to_vp to vreg_bypass_reg  - 0: Uses the value of external pin sup_ana_vreg_bypass_to_vp that decides whether to bypass or not (rw) */
    __IO Ifx_UReg_16Bit VREG_BYPASS_REG:1;    /**< \brief [7:7] Overrides the external pin sup_ana_vreg_bypass_to_vp   - 1: Overrides the value of external pin sup_ana_vreg_bypass_to_vp to 1 if ovrd_vreg_bypass=1  - 0: Overrides the value of external pin sup_ana_vreg_bypass_to_vp to 0 if ovrd_vreg_bypass=1 (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_REG_Bits;

/** \brief mplla testmodes register */
typedef struct _Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TEST0_Bits
{
    __IO Ifx_UReg_16Bit MPLLA_TESTMODE_CP_INT_SW:1;    /**< \brief [0:0] Switchs reference current for integral CP  - 1: V2I generated currents  - 0: Current source generated current (rw) */
    __IO Ifx_UReg_16Bit MPLLA_TESTMODE_OVERFLOW_OFF:1;    /**< \brief [1:1] Disables overflow mechanism in UPLL calibration   - 1: Disables overflow mechanism   - 0: Enables overflow machanism (rw) */
    __IO Ifx_UReg_16Bit MPLLA_TESTMODE_VCOMODE:1;    /**< \brief [2:2] Disables increasing vco current source size   - 1: Keeps the original size of the VCO current source PMOS  - 0: Increases the size of the VCO current source PMOS by 33% (rw) */
    __IO Ifx_UReg_16Bit MPLLA_TESTMODE_VMARG:2;    /**< \brief [4:3] Controls vmarg voltage reference  - 00: 9/23*vp level  - 01: 8/23*vp level  - 10: 7/23*vp level  - 11: External vmarg_ext level (rw) */
    __IO Ifx_UReg_16Bit MPLLA_TESTMODE_CP_PROP_HALF:1;    /**< \brief [5:5] "Enables proportional CP half bit   - 1: Half of proportional CP current gets added to the total CP proportional current  - 0: Half of proportional CP current doesn't get added to the total CP proportional current" (rw) */
    __IO Ifx_UReg_16Bit MPLLA_TESTMODE_CP_PROP_PROG:2;    /**< \brief [7:6] Controls proportional CP current programmability  - 00: 100% current gain  - 01: 125% current gain  - 10: 74% current gain  - 11: 83.3% current gain (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TEST0_Bits;

/** \brief mplla testmodes register */
typedef struct _Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TEST1_Bits
{
    ...
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TEST1_Bits;

/** \brief testmodes register */
typedef struct _Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TESTANA0_Bits
{
    __IO Ifx_UReg_16Bit TESTMODE_VMARG_EXT:1;    /**< \brief [0:0] Overrides vmarg_ext with analog test pin  - 0: disconnect atb_s_m from vmarg_ext  - 1: connects atb_s_m to vmarg_ext (rw) */
    __IO Ifx_UReg_16Bit TESTMODE_OVRD_VREGIN:1;    /**< \brief [1:1] Overrides UPLL regulator input with analog test pin   - 0: disconnect atb_s_m from vbg_filt_vco  - 1: connects atb_s_m to vbg_filt_vco (rw) */
    __IO Ifx_UReg_16Bit TESTMODE_MEAS_GD:1;    /**< \brief [2:2] This bit can be used to measure node gd voltage on atb_s_p pin  - 0: disconnect atb_s_p from gd  - 1: connects atb_s_p to gd (rw) */
    __IO Ifx_UReg_16Bit TESTMODE_MEAS_VP:1;    /**< \brief [3:3] This bit can be used to measure node vp voltage on atb_s_p pin  - 0: disconnect atb_s_p from vp  - 1: connects atb_s_p to vp (rw) */
    __IO Ifx_UReg_16Bit TESTMODE_MEAS_VPH:1;    /**< \brief [4:4] This bit can be used to measure node vph voltage on atb_s_p pin  - 0: disconnect atb_s_p from vph  - 1: connects atb_s_p to vph (rw) */
    __IO Ifx_UReg_16Bit TESTMODE_MEAS_VREG_CP:1;    /**< \brief [5:5] This bit can be used to measure node vreg_cp voltage on atb_s_p pin  - 0: disconnect atb_s_p from vreg_cp  - 1: connects atb_s_p to vreg_cp (rw) */
    __IO Ifx_UReg_16Bit TESTMODE_MEAS_I_V2I:1;    /**< \brief [6:6] This bit can be used to measure internal mplla net i_v2i current through atb_s_p pin   - 0: disconnect atb_s_p from i_v2i  - 1: connects atb_s_p to iv2i to measure current across external 10kohm resistor (rw) */
    __IO Ifx_UReg_16Bit TESTMODE_MEAS_V_V2I:1;    /**< \brief [7:7] This bit can be used to measure internal mplla node vreg_v2i voltage through atb_s_p pin   - 0: disconnect atb_s_p from vreg_v2i  - 1: connects atb_s_p to vreg_v2i (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TESTANA0_Bits;

/** \brief testmodes register */
typedef struct _Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TESTANA1_Bits
{
    __IO Ifx_UReg_16Bit TESTMODE_V2I_VBP:1;    /**< \brief [0:0] Measures vbp voltage from current source on analog test pin (rw) */
    __IO Ifx_UReg_16Bit TESTMODE_V2I_VBN:1;    /**< \brief [1:1] Measures vbn voltage from current source on analog test pin (rw) */
    __IO Ifx_UReg_16Bit TESTMODE_MEAS_VREG_V2I:1;    /**< \brief [2:2] For future use (rw) */
    __IO Ifx_UReg_16Bit TESTMODE_MEAS_VREG_CP:1;    /**< \brief [3:3] For future use (rw) */
    __IO Ifx_UReg_16Bit TESTMODE_EXT_VBG:1;    /**< \brief [4:4] Enables external vbg to be used for the internal regulators   - 0: Internal reference to be used as regulators input  - 1: External bandgap reference to be used as regulators input (rw) */
    __IO Ifx_UReg_16Bit TESTMODE_CNT_OVRD_GS:1;    /**< \brief [5:5] Control signal to override external gearshift pin  - 1: Overrides the value of external pin mplla_ana_gearshift to testmode_ovrd_gs  - 0: Uses the value of external pin mplla_ana_gearshift that decides whether to do gearshift or not (rw) */
    __IO Ifx_UReg_16Bit TESTMODE_OVRD_GS:1;    /**< \brief [6:6] Overrides external gearshift pin  - 1: Overrides the value of external pin to 1 if testmode_cnt_ovrd_gs=1  - 0: Overrides the value of external pin mplla_ana_gearshift to 0 if testmode_cnt_ovrd_gs=1 (rw) */
    __IO Ifx_UReg_16Bit TESTMODE_NC_19:1;    /**< \brief [7:7] For future use (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TESTANA1_Bits;

/** \brief Resistor Tuning and Margin DAC control registers */
typedef struct _Ifx_HSPHY_PHY_SUPX_ANA_RTUNE_CTRL_Bits
{
    __IO Ifx_UReg_16Bit RT_SEL_ATBF:1;     /**< \brief [0:0] GD or atb_s_p/m selection bit for the resistor tuning block RTUNE  - 1: Selects gd as input  - 0: Selects atb_s_p/m as input (rw) */
    __IO Ifx_UReg_16Bit RT_SEL_ATBP:1;     /**< \brief [1:1] atb_s_p/m selection bit for resistor tuning block RTUNE  - 1: Selects atb_s_p  - 0: Selects atb_s_m (rw) */
    __IO Ifx_UReg_16Bit RT_ATB:1;          /**< \brief [2:2] RTUNE ATB mode control (rw) */
    __IO Ifx_UReg_16Bit RT_DAC_CHOP:1;     /**< \brief [3:3] Use the rt_dac_mode<5:4> and rt_dac_chop (bit 3) bits to perform the following functions  - 000: Margin DAC power down  - 001: Margin DAC single ended output drives the atb_s_m pin  - 010: Margin DAC differential output (1/3VDAC+2/3VCM) drives atb_s_m, (4/3VCM-1/3VDAC) drives atb_s_p pin, respectively (rw) */
    __IO Ifx_UReg_16Bit RT_DAC_MODE:2;     /**< \brief [5:4] Margin DAC mode control bits; for more details, see the description for the rt_dac_chop field (rw) */
    __IO Ifx_UReg_16Bit RT_X4_FRCOFF:1;    /**< \brief [6:6] Increases calibration current in RTUNE block to 4x by default  - 1: Increase the RTUNE calibration current to 4x times from the default value  - 0: Turn off this feature (rw) */
    __IO Ifx_UReg_16Bit RT_EN_FRCON:1;     /**< \brief [7:7] Internal analog register enable control for resistor tuning block RTUNE block  - 1: Forces resistor tuning control block to turn ON  - 0: Enable normal resistor tuning block ON/OFF operation (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_ANA_RTUNE_CTRL_Bits;

/** \brief Temperature range, iptat & ref voltage related control register for sup_por */
typedef struct _Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_MISC_MEAS_Bits
{
    __IO Ifx_UReg_16Bit OVRD_TEMP_RANGE_EN:1;    /**< \brief [0:0] This bit allows analog register bit 1(temp_range_en_int) to turn on/off temp range tune circuit  - 1: Allows analog register bit 1(temp_range_en_int) to turn on/off temp range tune circuit  - 0: Instead of analog registers, control this functionality externally using sup_ana_temp_range_en pin (rw) */
    __IO Ifx_UReg_16Bit REG_TEMP_RANGE_EN_INT:1;    /**< \brief [1:1] If bit 0 (ovrd_temp_range_en): 1, this bit enables/disables the temp range tune circuit   - 1: temp range tune circuit is turned on  - 0: temp range tune circuit is turned off (rw) */
    __IO Ifx_UReg_16Bit REG_TEMP_RANGE_TUNE_INT:1;    /**< \brief [2:2] This bit can be used to change the trip point of internal temperature sense block  - 1: Increase the temp trip point to a higher value  - 0: Default value (rw) */
    __IO Ifx_UReg_16Bit REG_IPTAT_PLL_TUNE_INT:2;    /**< \brief [4:3] These bits can be used to program the iptat current going to mpll  - 00: Default value - 12.5%  - 01: Default value   - 10: Default value + 12.5%  - 11: Default value + 25% (rw) */
    __IO Ifx_UReg_16Bit ATB_SW_HIGHREG_VREF_SEL:2;    /**< \brief [6:5] These bits can be used to set unity feedback regulator reference voltage highreg_vref, which can be approximately calculated   - based on equation: 1.22*(high_vreg_vref_sel<1:0>+36)/50 (rw) */
    __IO Ifx_UReg_16Bit REG_SWITCH_MISC_MEAS_7:1;    /**< \brief [7:7] For future use (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_MISC_MEAS_Bits;

/** \brief Miscellaneous analog test bus control and regulator reference voltage control */
typedef struct _Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_MISC_MEAS_1_Bits
{
    __IO Ifx_UReg_16Bit ATB_SW_REF_HYST:2;    /**< \brief [1:0] These bits can be used to program the prescaler input clock buffer hysteresis level  - 00: No hysteresis  - 01: 18 mVpp hysteresis   - 10: 35 mVpp hysteresis   - 11: 50 mVpp hysteresis (rw) */
    __IO Ifx_UReg_16Bit ATB_SW_SLOWVREG_VREF_SEL:3;    /**< \brief [4:2] These bits can be used to set slow regulator reference voltage slowvreg_vref, which can be approximately calculated   - based on equation: 1.22*(slow_vreg_vref_sel<2:0>+18)/50 (rw) */
    __IO Ifx_UReg_16Bit ATB_SW_MEAS_TEMP:1;    /**< \brief [5:5] If this bit: 1, it enables die temperature measurement by sending vbe to atb_s_m and vbg to atb_s_p pins, respectively  - 1: vbe is connected to atb_s_m and vbg is connected to atb_s_p for measurement   - 0: Disconnects vbe and vbg from the atb_s_m and atb_s_p pins, respectively (rw) */
    __IO Ifx_UReg_16Bit ATB_SW_FASTVREG_VREF_SEL:2;    /**< \brief [7:6] These bits can be used to set fast regulator reference voltage fastvreg_vref, which can be approximately calculated   - based on equation: 1.25*(Fast_vreg_vref_sel<1:0>+12)/50 (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_MISC_MEAS_1_Bits;

/** \brief Local power supply measurement in SUP_ANA */
typedef struct _Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_PWR_MEAS_Bits
{
    __IO Ifx_UReg_16Bit ATB_SW_SLOWVREG_VREF:1;    /**< \brief [0:0] This bit connects/disconnects slow regulator reference voltage node slowvreg_vref in SUP_ANA to atb_s_p pin  - 1: Connects the atb_s_p pin to the slowvreg_vref internal node for measurement  - 0: Disconnects the atb_s_p pin connection from slowvreg_vref internal node (rw) */
    __IO Ifx_UReg_16Bit ATB_SW_VPH:1;      /**< \brief [1:1] If bit 5 (atb_sw_half_vph): 0, this bit connects/disconnects atb_s_p pin to internal analog high supply vph of SUP_ANA           - 1: If bit 5 (atb_sw_half_vph): 0, connects vph to atb_s_p pin (rw) */
    __IO Ifx_UReg_16Bit ATB_SW_FASTVREG_VREF:1;    /**< \brief [2:2] This bit connects/disconnects fastvreg_vref inside SUP_ANA block to atb_s_p pin for measurement  - 1: Connects the fast regulator reference voltage fastvreg_vref node inside sup_ana to the atb_s_p pin for measurement  - 0: Disconnects the atb_s_m pin connection from the fastvreg_vref node in sup_ana (rw) */
    __IO Ifx_UReg_16Bit ATB_SW_VP:1;       /**< \brief [3:3] This bit connects/disconnects internal analog low suppy vp of SUP_ANA to atb_s_p for measurement  - 1: Connects internal analog low supply vp of SUP_ANA block to atb_s_p pin for measurement  - 0: Disconnects the atb_s_p pin connection from internal analog low supply vp of SUP_ANA block (rw) */
    __IO Ifx_UReg_16Bit ATB_SW_GD:1;       /**< \brief [4:4] This bit connects/disconnects atb_s_m pin to internal analog ground gd of SUP_ANA block for measurement  - 1: Connects the atb_s_m pin to the internal analog ground gd of SUP_ANA block for measurement  - 0: Disconnects the atb_s_m pin connection from ground (rw) */
    __IO Ifx_UReg_16Bit ATB_SW_HALF_VPH:1;    /**< \brief [5:5] This bit connects/disconnects atb_s_p to vph/2 to monitor internal analog high supply vph of SUP_ANA block  - 1: Set the voltage on the atb_s_p pin to vph/2 of SUP_ANA block  - 0: Remove the atb_s_p pin connection from vph/2 of SUP_ANA block (rw) */
    __IO Ifx_UReg_16Bit ATB_SW:1;          /**< \brief [6:6] Bit to control the connection between atb_s_p and atb_s_m pins  - 1: Connects atb_s_p to atb_s_m  - 0: Disconnects atb_s_p and atb_s_m (rw) */
    __IO Ifx_UReg_16Bit REG_SWITCH_PWR_MEAS_7:1;    /**< \brief [7:7] For future use (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_PWR_MEAS_Bits;

/** \brief Override values for bandgap signals going to ANA */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_ANA_BG_OVRD_OUT_Bits
{
    __IO Ifx_UReg_16Bit BG_EN:1;           /**< \brief [0:0] Overrides the bg_ana_en signal (rw) */
    __IO Ifx_UReg_16Bit BG_OVRD_EN:1;      /**< \brief [1:1] Override enable for bandgap outputs   output signals overridden by this enable are :  bg_ana_en (rw) */
    __IO Ifx_UReg_16Bit ANA_ASYNC_RST:1;    /**< \brief [2:2] Override value for reset register for analog latches.its override enable is ANA_ASYNC_RST_OVRD_EN (rw) */
    __IO Ifx_UReg_16Bit ANA_ASYNC_RST_OVRD_EN:1;    /**< \brief [3:3] Override enable for ana_async_rst (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_4:12;    /**< \brief [15:4] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_ANA_BG_OVRD_OUT_Bits;

/** \brief Override value for mplla signals going to ANA */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_ANA_MPLLA_OVRD_OUT_Bits
{
    __IO Ifx_UReg_16Bit MPLLA_ANA_EN:1;    /**< \brief [0:0] Override value for mplla_ana_en signal (rw) */
    __IO Ifx_UReg_16Bit MPLLA_RST:1;       /**< \brief [1:1] Override value for mplla_ana_rst signal (rw) */
    __IO Ifx_UReg_16Bit MPLLA_CAL:1;       /**< \brief [2:2] Override value for mplla_ana_cal signal (rw) */
    __IO Ifx_UReg_16Bit MPLLA_OUTPUT_EN:1;    /**< \brief [3:3] Override value for mplla_ana_output_en signal (rw) */
    __IO Ifx_UReg_16Bit MPLLA_OUTPUT_L_EN:1;    /**< \brief [4:4] Override value for mplla_ana_output_l_en signal (rw) */
    __IO Ifx_UReg_16Bit MPLLA_OUTPUT_R_EN:1;    /**< \brief [5:5] Override value for mplla_ana_output_r_en signal (rw) */
    __IO Ifx_UReg_16Bit MPLLA_DIV8_CLK_EN:1;    /**< \brief [6:6] Override value for mplla_ana_div8_clk_en signal (rw) */
    __IO Ifx_UReg_16Bit MPLLA_DIV10_CLK_EN:1;    /**< \brief [7:7] Override value for mplla_ana_div10_clk_en signal (rw) */
    __IO Ifx_UReg_16Bit MPLLA_FBCLK_EN:1;    /**< \brief [8:8] Override value for mplla_fb_clk_en signal (rw) */
    __IO Ifx_UReg_16Bit MPLLA_STANDBY_EN:1;    /**< \brief [9:9] Override the mplla_ana_standby signal (rw) */
    __IO Ifx_UReg_16Bit MPLLA_GEARSHIFT:1;    /**< \brief [10:10] Override the mplla_ana_gearshift signal (rw) */
    __IO Ifx_UReg_16Bit MPLLA_DIV16P5_CLK_EN:1;    /**< \brief [11:11] Override the mplla_ana_div16p5_clk_en signal (rw) */
    __IO Ifx_UReg_16Bit MPLLA_DIV_CLK_EN:1;    /**< \brief [12:12] Override value for mplla_ana_div_clk_en signal (rw) */
    __IO Ifx_UReg_16Bit OVRD_SEL:1;        /**< \brief [13:13] Override enable for mplla_ana outputs output signals overridden by this enable are :  mplla_ana_div_clk_en  mplla_ana_div16p5_clk_en  mplla_ana_gearshift  mplla_ana_standby  mplla_fb_clk_en  mplla_ana_div10_clk_en  mplla_ana_div8_clk_en  mplla_ana_output_r_en  mplla_ana_output_l_en  mplla_ana_output_en  mplla_ana_cal  mplla_ana_rst  mplla_ana_en (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_14:2;    /**< \brief [15:14] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_ANA_MPLLA_OVRD_OUT_Bits;

/** \brief Override value for mplla pmix signals going to ANA */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_ANA_MPLLA_PMIX_OVRD_OUT_Bits
{
    __IO Ifx_UReg_16Bit MPLLA_ANA_PMIX_SEL:8;    /**< \brief [7:0] Overrides value for mplla_ana_pmix_sel signal (rw) */
    __IO Ifx_UReg_16Bit MPLLA_ANA_PMIX_SEL_OVRD_EN:1;    /**< \brief [8:8] Override enable for mplla_ana_pmix_sel signal output signals overridden by this enable are :  mplla_ana_pmix_sel[7:0] (rw) */
    __IO Ifx_UReg_16Bit MPLLA_ANA_PMIX_EN:1;    /**< \brief [9:9] Override value for mplla_ana_pmix_en signal (rw) */
    __IO Ifx_UReg_16Bit MPLLA_PMIX_OVRD_EN:1;    /**< \brief [10:10] Override enable for mplla_ana_pmix_en signal output signals overridden by this enable are :  mplla_ana_pmix_en (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_11:5;    /**< \brief [15:11] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_ANA_MPLLA_PMIX_OVRD_OUT_Bits;

/** \brief Override value for RTUNE signals going to ANA */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_ANA_RTUNE_OVRD_OUT_Bits
{
    __IO Ifx_UReg_16Bit RTUNE_COMP_RST:1;    /**< \brief [0:0] Override value for rt_ana_comp_rst signal (rw) */
    __IO Ifx_UReg_16Bit RTUNE_MODE:2;      /**< \brief [2:1] Override value for rt_ana_mode[1:0] signal (rw) */
    __IO Ifx_UReg_16Bit RTUNE_EN:1;        /**< \brief [3:3] Override value for rt_ana_en signal (rw) */
    __IO Ifx_UReg_16Bit RTUNE_VALUE:10;    /**< \brief [13:4] Override value for rt_ana_value[9:0] signal (rw) */
    __IO Ifx_UReg_16Bit RTUNE_OVRD_EN:1;    /**< \brief [14:14] Override enable for rtune outputs output signals overridden by this enable are :  rt_ana_value[9:0]  rt_ana_en  rt_ana_mode[1:0]   rt_ana_comp_rst (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_15:1;    /**< \brief [15:15] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_ANA_RTUNE_OVRD_OUT_Bits;

/** \brief Override value for RX termination signals going to ANA */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_ANA_RX_TERM_OVRD_OUT_Bits
{
    __IO Ifx_UReg_16Bit RX_TERM_VAL:6;     /**< \brief [5:0] Override value for rx_ana_term_val[5:0] signal (rw) */
    __IO Ifx_UReg_16Bit RX_TERM_VAL_OVRD_EN:1;    /**< \brief [6:6] Override enable for rx_ana_term_val[5:0] signal (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_7:9;    /**< \brief [15:7] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_ANA_RX_TERM_OVRD_OUT_Bits;

/** \brief SUP input status register for SUP ANA outputs */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_ANA_STAT_Bits
{
    __I  Ifx_UReg_16Bit RT_ANA_COMP_RESULT:1;    /**< \brief [0:0] Value from ANA for rt_ana_comp_result (rh) */
    __I  Ifx_UReg_16Bit REF_ANA_CLKDET_RESULT:1;    /**< \brief [1:1] Value from ANA for ref_ana_clkdet_result (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_2:14;    /**< \brief [15:2] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_ANA_STAT_Bits;

/** \brief SUP input status register for SUP ANA outputs */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_ANA_STAT1_Bits
{
    __I  Ifx_UReg_16Bit REF_ANA_CLK_ACK:1;    /**< \brief [0:0] Value from ANA for ref_ana_clk_ack (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_1:15;    /**< \brief [15:1] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_ANA_STAT1_Bits;

/** \brief Current values (pre-override) for incoming SUP control signals from ASIC */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_ASIC_IN_Bits
{
    __I  Ifx_UReg_16Bit PHY_RESET:1;       /**< \brief [0:0] Value from ASIC for phy_reset (rh) */
    __I  Ifx_UReg_16Bit REF_CLK_EN:1;      /**< \brief [1:1] Value from ASIC for ref_clk_en (rh) */
    __I  Ifx_UReg_16Bit REF_CLK_DIV2_EN:1;    /**< \brief [2:2] Value from ASIC for ref_clk_div2_en (rh) */
    __I  Ifx_UReg_16Bit REF_REPEAT_CLK_EN:1;    /**< \brief [3:3] Value from ASIC for ref_repeat_clk_en (rh) */
    __I  Ifx_UReg_16Bit REF_USE_PAD:1;     /**< \brief [4:4] Value from ASIC for ref_use_pad (rh) */
    __I  Ifx_UReg_16Bit TEST_BURNIN:1;     /**< \brief [5:5] Value from ASIC for test_burnin (rh) */
    __I  Ifx_UReg_16Bit TEST_POWERDOWN:1;    /**< \brief [6:6] Value from ASIC for test_powerdown (rh) */
    __I  Ifx_UReg_16Bit RTUNE_REQ:1;       /**< \brief [7:7] Value from ASIC for rtune_req (rh) */
    __I  Ifx_UReg_16Bit RTUNE_ACK:1;       /**< \brief [8:8] Value to ASIC for rtune_ack_i (rh) */
    __I  Ifx_UReg_16Bit RES_REQ_IN:1;      /**< \brief [9:9] Value from ASIC for res_req_in (rh) */
    __I  Ifx_UReg_16Bit RES_REQ_OUT:1;     /**< \brief [10:10] Value to ASIC for res_req_out_i (rh) */
    __I  Ifx_UReg_16Bit RES_ACK_IN:1;      /**< \brief [11:11] Value from ASIC for res_ack_in (rh) */
    __I  Ifx_UReg_16Bit RES_ACK_OUT:1;     /**< \brief [12:12] Value to ASIC for res_ack_out_i (rh) */
    __I  Ifx_UReg_16Bit MPLLA_STATE:1;     /**< \brief [13:13] Value to ASIC for mplla_state_i (rh) */
    __I  Ifx_UReg_16Bit RESERVED:1;        /**< \brief [14:14] Reserved for future use (rh) */
    __I  Ifx_UReg_16Bit BG_EN:1;           /**< \brief [15:15] Value from ASIC for bg_en (rh) */
} Ifx_HSPHY_PHY_SUPX_DIG_ASIC_IN_Bits;

/** \brief Debug controls */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_DEBUG_Bits
{
    __IO Ifx_UReg_16Bit DTB_SEL:3;         /**< \brief [2:0] "The lane DTB's are OR'd together with the support DTB signals  selected with the below encodings  - 0 - none  - 1 - mplla DTB output  - 2 - Reserved   - 3 - rtune  DTB output" (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_3:13;    /**< \brief [15:3] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_DEBUG_Bits;

/** \brief Current values (pre-override) for incoming SSC frequency peak controls from ASIC */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_FREQ_CNT_PEAK_ASIC_IN_Bits
{
    __I  Ifx_UReg_16Bit RESERVED:8;        /**< \brief [7:0] Reserved for future use (rh) */
    __I  Ifx_UReg_16Bit MPLLA_SSC_FREQ_CNT_PEAK:8;    /**< \brief [15:8] Value from ASIC for mplla_ssc_freq_cnt_peak (rh) */
} Ifx_HSPHY_PHY_SUPX_DIG_FREQ_CNT_PEAK_ASIC_IN_Bits;

/** \brief High 16 bits of IDCODE */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_IDCODE_HI_Bits
{
    __I  Ifx_UReg_16Bit DATA:16;           /**< \brief [15:0] The upper 16 bits of the IDCODE value  It consists of the following fields  - 31-28 : RTL Version  - 27-24 : Product  - 23-16 : Foundry/Size/Technology (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_IDCODE_HI_Bits;

/** \brief Low 16 bits of IDCODE */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_IDCODE_LO_Bits
{
    __I  Ifx_UReg_16Bit DATA:16;           /**< \brief [15:0] The lower 16 bits of the IDCODE value It consists of the following fields  - 15    : Test Chip  - 14-12 : Site ID  - 11-0  : Synopsys Constant (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_IDCODE_LO_Bits;

/** \brief Current values (pre-override) for incoming level controls from ASIC */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_LVL_ASIC_IN_Bits
{
    __I  Ifx_UReg_16Bit RX_VREF_CTRL:5;    /**< \brief [4:0] Value from ASIC for rx_vref_ctrl (rh) */
    __I  Ifx_UReg_16Bit TX_VBOOST_LVL:3;    /**< \brief [7:5] Value from ASIC for tx_vboost_lvl (rh) */
    __I  Ifx_UReg_16Bit REF_CLKDET_RESULT:1;    /**< \brief [8:8] Value to ASIC for ref_clkdet_result (rh) */
    __I  Ifx_UReg_16Bit REF_CLKDET_EN:1;    /**< \brief [9:9] Value from ASIC for ref_clkdet_en (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_10:6;    /**< \brief [15:10] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_LVL_ASIC_IN_Bits;

/** \brief Override values for level settings */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_LVL_OVRD_IN_Bits
{
    __IO Ifx_UReg_16Bit RX_VREF_CTRL:5;    /**< \brief [4:0] Override value for rx_vref_ctrl (rw) */
    __IO Ifx_UReg_16Bit RX_VREF_CTRL_EN:1;    /**< \brief [5:5] Enable override value for rx_vref_ctrl input signals overridden by this enable are:  rx_vref_ctrl[4:0] (rw) */
    __IO Ifx_UReg_16Bit TX_VBOOST_LVL:3;    /**< \brief [8:6] Override value for tx_vboost_lvl (rw) */
    __IO Ifx_UReg_16Bit TX_VBOOST_LVL_EN:1;    /**< \brief [9:9] Enable override value for tx_vboost_lvl input signals overridden by this enable are:  tx_vboost_lvl[2:0] (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_10:6;    /**< \brief [15:10] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_LVL_OVRD_IN_Bits;

/** \brief Current values (pre-override) for incoming level controls from ASIC */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MISC_ASIC_IN_Bits
{
    __I  Ifx_UReg_16Bit SUP_MISC:8;        /**< \brief [7:0] Value from ASIC for sup_misc (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MISC_ASIC_IN_Bits;

/** \brief Current values (pre-override) for incoming MPLLA controls from ASIC, register #0 */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_ASIC_IN_0_Bits
{
    __I  Ifx_UReg_16Bit MPLLA_EN:1;        /**< \brief [0:0] Value from ASIC for mplla_en (rh) */
    __I  Ifx_UReg_16Bit REF_CLK_MPLLA_DIV2_EN:1;    /**< \brief [1:1] Value from ASIC for ref_clk_mplla_div2_en (rh) */
    __I  Ifx_UReg_16Bit MPLLA_DIV8_CLK_EN:1;    /**< \brief [2:2] Value from ASIC for mplla_div8_clk_en (rh) */
    __I  Ifx_UReg_16Bit MPLLA_DIV10_CLK_EN:1;    /**< \brief [3:3] Value from ASIC for mplla_div10_clk_en (rh) */
    __I  Ifx_UReg_16Bit MPLLA_DIV16P5_CLK_EN:1;    /**< \brief [4:4] Value from ASIC for mplla_div16p5_clk_en (rh) */
    __I  Ifx_UReg_16Bit MPLLA_MULTIPLIER:8;    /**< \brief [12:5] Value from ASIC for mplla_multiplier (rh) */
    __I  Ifx_UReg_16Bit REF_CLK_ACK:1;     /**< \brief [13:13] Value from ANA  for ref_clk_ack (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_14:2;    /**< \brief [15:14] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_ASIC_IN_0_Bits;

/** \brief Current values (pre-override) for incoming MPLLA controls from ASIC, register #1 */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_ASIC_IN_1_Bits
{
    __I  Ifx_UReg_16Bit MPLLA_SSC_EN:1;    /**< \brief [0:0] Value from ASIC for mplla_ssc_en (rh) */
    __I  Ifx_UReg_16Bit MPLLA_SSC_UP_SPREAD:1;    /**< \brief [1:1] Value from ASIC for mplla_ssc_up_spread (rh) */
    __I  Ifx_UReg_16Bit MPLLA_FRACN_CTRL:11;    /**< \brief [12:2] Value from ASIC for mplla_fracn_ctrl (rh) */
    __I  Ifx_UReg_16Bit MPLLA_SSC_CLK_SEL:1;    /**< \brief [13:13] Value from ASIC for mplla_ssc_clk_sel (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_14:2;    /**< \brief [15:14] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_ASIC_IN_1_Bits;

/** \brief Current values (pre-override) for incoming MPLLA_B_DIV_CLK controls from ASIC */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_B_DIV_CLK_ASIC_IN_Bits
{
    __I  Ifx_UReg_16Bit MPLLA_DIV_CLK_EN:1;    /**< \brief [0:0] Value from ASIC for mplla_div_clk_en (rh) */
    __I  Ifx_UReg_16Bit MPLLA_DIV_MULTIPLIER:7;    /**< \brief [7:1] Value from ASIC for mplla_div_multiplier (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_B_DIV_CLK_ASIC_IN_Bits;

/** \brief Override values for incoming MPLLA_DIV_CLK controls from ASIC */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_DIV_CLK_OVRD_IN_Bits
{
    __IO Ifx_UReg_16Bit MPLLA_DIV_CLK_EN:1;    /**< \brief [0:0] Override value for mplla_div_clk_en (rw) */
    __IO Ifx_UReg_16Bit MPLLA_DIV_MULTIPLIER:7;    /**< \brief [7:1] Override value for mplla_div_multiplier (rw) */
    __IO Ifx_UReg_16Bit MPLLA_DIV_OVRD_EN:1;    /**< \brief [8:8] Override enable for MPLLA Div clock: mplla_div_multiplier and mplla_div_clk_en (rw) */
    __IO Ifx_UReg_16Bit MPLLA_WORD_CLK_DIV2_EN:1;    /**< \brief [9:9] Override value for mplla_word_clk_div2_en (rw) */
    __IO Ifx_UReg_16Bit MPLLA_WORD_CLK_DIV2_EN_OVRD_EN:1;    /**< \brief [10:10] Override enable for mplla_word_clk_div2_en (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_11:5;    /**< \brief [15:11] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_DIV_CLK_OVRD_IN_Bits;

/** \brief BG Power UP Time Register */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_BG_PWRUP_TIME_Bits
{
    __IO Ifx_UReg_16Bit BG_SUP_EN_TIME:9;    /**< \brief [8:0] Power up time (in ref_range cycles) for bandgap in SUP (spec >=11us) (rw) */
    __IO Ifx_UReg_16Bit FAST_BG_WAIT:1;    /**< \brief [9:9] Enable fast BG times (simulation only) (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_10:6;    /**< \brief [15:10] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_BG_PWRUP_TIME_Bits;

/** \brief MPLL status register */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_ANA_DAC_OUT_Bits
{
    __I  Ifx_UReg_16Bit MPLL_ANA_DAC_OUT:5;    /**< \brief [4:0] Current value of the PWR FSM state register (r) */
    __I  Ifx_UReg_16Bit RESERVED_15_5:11;    /**< \brief [15:5] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_ANA_DAC_OUT_Bits;

/** \brief MPLL Calibration Override */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_CAL_Bits
{
    __IO Ifx_UReg_16Bit MPLL_CAL:1;        /**< \brief [0:0] mpll_cal value (rw) */
    __IO Ifx_UReg_16Bit MPLL_CAL_OVRD_EN:1;    /**< \brief [1:1] mpll_cal override en (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_2:14;    /**< \brief [15:2] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_CAL_Bits;

/** \brief Defaul cal_force, freq_vco, MPLL DAC in And MAXRANGE Values */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_DAC_MAXRANGE_Bits
{
    __IO Ifx_UReg_16Bit MAX_RANGE:5;       /**< \brief [4:0] Default Max_range Value (rw) */
    __IO Ifx_UReg_16Bit DAC_IN:5;          /**< \brief [9:5] Default Dac in Value (rw) */
    __IO Ifx_UReg_16Bit FREQ_VCO:1;        /**< \brief [10:10] Default freq_vco Value (rw) */
    __IO Ifx_UReg_16Bit CAL_FORCE:1;       /**< \brief [11:11] Default cal_force Value (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_12:4;    /**< \brief [15:12] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_DAC_MAXRANGE_Bits;

/** \brief MPLL override controls */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_OVRD_Bits
{
    __IO Ifx_UReg_16Bit OVRD_SEL:1;        /**< \brief [0:0] Override enable bit (rw) */
    __IO Ifx_UReg_16Bit MPLL_PCLK_EN:1;    /**< \brief [1:1] Overrides the power FSM mpll_pclk_en signal (rw) */
    __IO Ifx_UReg_16Bit DTB_SEL:5;         /**< \brief [6:2] DTB select for MPLL dtb signals possible values are:   - 5\'h01 => {"{"}ref_range_clk & ~scan_mode_i, ref_range_mpll_en{"}"}  - 5\'h02 => {"{"}mpll_ana_output_en_i, mpll_pclk_en{"}"}  - 5\'h03 => {"{"}mpll_div_clk_en, mpll_ana_fb_clk_en_i{"}"}  - 5\'h04 => {"{"}mpll_ana_en_i, mpll_state{"}"}  - 5\'h08 => {"{"}mpll_ana_rst_i, mpll_ana_gearshift_i{"}"}  - 5\'h10 => {"{"}curr_state[0], mpll_cnt[0]{"}"} (rw) */
    __IO Ifx_UReg_16Bit FAST_LOCK:1;       /**< \brief [7:7] Enables Fast MPLL locking (simulation only) (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_OVRD_Bits;

/** \brief Timer thresholds for Reset Setup, Stable and Lock */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_0_Bits
{
    __IO Ifx_UReg_16Bit LOCK_TIME:10;      /**< \brief [9:0] Threshold for the MPLL lock Time (rw) */
    __IO Ifx_UReg_16Bit STABLE_TIME:6;     /**< \brief [15:10] Threshold for the MPLL stability time (rw) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_0_Bits;

/** \brief Timer thresholds for power up gearshift and reset */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_1_Bits
{
    __IO Ifx_UReg_16Bit GEARSHIFT_TIME:8;    /**< \brief [7:0] Threshold for the MPLL gearshift time (Default is 2us) (rw) */
    __IO Ifx_UReg_16Bit PRESET_TIME:8;     /**< \brief [15:8] Threshold for the MPLL preset time (Default is 2us) (rw) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_1_Bits;

/** \brief Timer thresholds for pclk enable and Power down wait */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_2_Bits
{
    __IO Ifx_UReg_16Bit PWRDN_WAIT_TIME:6;    /**< \brief [5:0] Threshold for the MPLL Power Down wait time to Discharge the PLL capacitors (rw) */
    __IO Ifx_UReg_16Bit PCLK_EN_TIME:6;    /**< \brief [11:6] Threshold for the MPLL PCLK (rw) */
    __IO Ifx_UReg_16Bit RESET_SETUP_TIME:2;    /**< \brief [13:12] Threshold for the MPLL Reset Setup Time (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_14:2;    /**< \brief [15:14] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_2_Bits;

/** \brief Timer thresholds for Pclk disable and Power down */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_3_Bits
{
    __IO Ifx_UReg_16Bit PCLK_DIS_TIME:6;    /**< \brief [5:0] Threshold for the PCLK disable time (rw) */
    __IO Ifx_UReg_16Bit PWRDN_TIME:6;      /**< \brief [11:6] Threshold for the MPLL Power down (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_12:4;    /**< \brief [15:12] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_3_Bits;

/** \brief MPLL status register */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_STAT_Bits
{
    __I  Ifx_UReg_16Bit FSM_STATE:4;       /**< \brief [3:0] Current value of the power FSM state register (rh) */
    __I  Ifx_UReg_16Bit MPLL_R_LANES:1;    /**< \brief [4:4] Current value of lane_mpll_r (rh) */
    __I  Ifx_UReg_16Bit MPLL_L_LANES:1;    /**< \brief [5:5] Current value of lane_mpll_l (rh) */
    __I  Ifx_UReg_16Bit MPLL_PCLK_EN:1;    /**< \brief [6:6] Current value of mpll_pclk_en (rh) */
    __I  Ifx_UReg_16Bit MPLL_ANA_OUTPUT_EN:1;    /**< \brief [7:7] Current value of mpll_ana_output_en_i (rh) */
    __I  Ifx_UReg_16Bit MPLL_ANA_FBCLK_EN:1;    /**< \brief [8:8] Current value of mpll_ana_fb_clk_en_i (rh) */
    __I  Ifx_UReg_16Bit MPLL_ANA_CAL:1;    /**< \brief [9:9] Current value of mpll_ana_cal_i (rh) */
    __I  Ifx_UReg_16Bit MPLL_ANA_RST:1;    /**< \brief [10:10] Current value of mpll_ana_rst_i (rh) */
    __I  Ifx_UReg_16Bit MPLL_ANA_EN:1;     /**< \brief [11:11] Current value of mpll_ana_en_i (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_12:4;    /**< \brief [15:12] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_STAT_Bits;

/** \brief Override values for incoming MPLLA controls from ASIC, register #0 */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_0_Bits
{
    __IO Ifx_UReg_16Bit MPLLA_EN:1;        /**< \brief [0:0] Override value for mplla_en (rw) */
    __IO Ifx_UReg_16Bit MPLLA_EN_OVRD_EN:1;    /**< \brief [1:1] Override enable for mplla_en (rw) */
    __IO Ifx_UReg_16Bit REF_CLK_MPLLA_DIV2_EN:1;    /**< \brief [2:2] Override value for ref_clk_mplla_div2_en (rw) */
    __IO Ifx_UReg_16Bit REF_CLK_MPLLA_DIV2_EN_OVRD_EN:1;    /**< \brief [3:3] Override enable for ref_clk_mplla_div2_en (rw) */
    __IO Ifx_UReg_16Bit MPLLA_DIV8_CLK_EN:1;    /**< \brief [4:4] Override value for mplla_div8_clk_en (rw) */
    __IO Ifx_UReg_16Bit MPLLA_DIV8_CLK_EN_OVRD_EN:1;    /**< \brief [5:5] Override enable for mplla_div8_clk_en (rw) */
    __IO Ifx_UReg_16Bit MPLLA_DIV10_CLK_EN:1;    /**< \brief [6:6] Override value for mplla_div10_clk_en (rw) */
    __IO Ifx_UReg_16Bit MPLLA_DIV10_CLK_EN_OVRD_EN:1;    /**< \brief [7:7] Override value for mplla_div10_clk_en (rw) */
    __IO Ifx_UReg_16Bit MPLLA_DIV16P5_CLK_EN:1;    /**< \brief [8:8] Override value for mplla_div16p5_clk_en (rw) */
    __IO Ifx_UReg_16Bit MPLLA_DIV16P5_CLK_EN_OVRD_EN:1;    /**< \brief [9:9] Override enable for mplla_div16p5_clk_en (rw) */
    __IO Ifx_UReg_16Bit MPLLA_STANDBY:1;    /**< \brief [10:10] Override value for mplla_standby (rw) */
    __IO Ifx_UReg_16Bit MPLLA_STANDBY_OVRD_EN:1;    /**< \brief [11:11] Override enable for mplla_standby (rw) */
    __IO Ifx_UReg_16Bit MPLLA_TX_CLK_DIV:3;    /**< \brief [14:12] Override value for mplla_tx_clk_div (rw) */
    __IO Ifx_UReg_16Bit MPLLA_TX_CLK_DIV_OVRD_EN:1;    /**< \brief [15:15] Override enable for mplla_tx_clk_div (rw) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_0_Bits;

/** \brief Override values for incoming MPLLA controls from ASIC, register #1 */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_1_Bits
{
    __IO Ifx_UReg_16Bit MPLLA_MULTIPLIER:8;    /**< \brief [7:0] Override value for mplla_multiplier[7:0] (rw) */
    __IO Ifx_UReg_16Bit MPLLA_MULTIPLIER_OVRD_EN:1;    /**< \brief [8:8] Override enable for mplla_multiplier[7:0] (rw) */
    __IO Ifx_UReg_16Bit MPLLA_SSC_OVRD_EN:1;    /**< \brief [9:9] Override enable Signals overridden by this enable are:  mplla_ssc_en  mplla_ssc_up_spread  mplla_fracn_ctrl  mplla_ssc_freq_cnt_init  mplla_ssc_freq_cnt_peak  mplla_ssc_clk_sel  mplla_ssc_range (rw) */
    __IO Ifx_UReg_16Bit MPLLA_CP_PROP_GS:4;    /**< \brief [13:10] Override value for mplla_cp_prop_gs[3:0] (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_14:2;    /**< \brief [15:14] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_1_Bits;

/** \brief Override values for incoming MPLLA controls from ASIC, register #2 */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_2_Bits
{
    __IO Ifx_UReg_16Bit MPLLA_CP_PROP:4;    /**< \brief [3:0] Override value for mplla_cp_prop[3:0] (rw) */
    __IO Ifx_UReg_16Bit MPLLA_CP_INT_GS:5;    /**< \brief [8:4] Override value for mplla_cp_int_gs[4:0] (rw) */
    __IO Ifx_UReg_16Bit MPLLA_CP_INT:5;    /**< \brief [13:9] Override value for mplla_cp_int[4:0] (rw) */
    __IO Ifx_UReg_16Bit MPLLA_CP_OVRD_EN:1;    /**< \brief [14:14] Override enable Signals overridden by this enable are:  mplla_cp_int  mplla_cp_int_gs  mplla_cp_prop  mplla_cp_prop_gs (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_15:1;    /**< \brief [15:15] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_2_Bits;

/** \brief Override values for incoming MPLLA controls from ASIC, register #3 */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_3_Bits
{
    __IO Ifx_UReg_16Bit MPLLA_SSC_EN:1;    /**< \brief [0:0] Override value for mplla_ssc_en (rw) */
    __IO Ifx_UReg_16Bit MPLLA_SSC_UP_SPREAD:1;    /**< \brief [1:1] Override value for mplla_ssc_up_spread (rw) */
    __IO Ifx_UReg_16Bit MPLLA_FRACN_CTRL:11;    /**< \brief [12:2] Override value for mplla_fracn_ctrl[10:0] (rw) */
    __IO Ifx_UReg_16Bit MPLLA_SSC_CLK_SEL:1;    /**< \brief [13:13] Override value for mplla_ssc_clk_sel (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_14:2;    /**< \brief [15:14] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_3_Bits;

/** \brief Override values for incoming MPLLA controls from ASIC, register #4 */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_4_Bits
{
    __IO Ifx_UReg_16Bit MPLLA_SSC_FREQ_CNT_INIT:12;    /**< \brief [11:0] Override value for mplla_ssc_freq_cnt_init[11:0] (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_12:4;    /**< \brief [15:12] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_4_Bits;

/** \brief Override values for incoming MPLLA controls from ASIC, register #5 */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_5_Bits
{
    __IO Ifx_UReg_16Bit MPLLA_SSC_FREQ_CNT_PEAK:8;    /**< \brief [7:0] Override value for mplla_ssc_freq_cnt_peak[7:0] (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_8:8;    /**< \brief [15:8] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_5_Bits;

/** \brief Frequency Control for Spread Spectrum #0 */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_FREQ_0_Bits
{
    __IO Ifx_UReg_16Bit FREQ_CNT_INIT:12;    /**< \brief [11:0] Initial Frequency Counter Value (rw) */
    __IO Ifx_UReg_16Bit FREQ_0_OVRD:1;     /**< \brief [12:12] Frequency Register Override (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_13:3;    /**< \brief [15:13] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_FREQ_0_Bits;

/** \brief Frequency Control for Spread Spectrum #1 */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_FREQ_1_Bits
{
    __IO Ifx_UReg_16Bit FREQ_PK:8;         /**< \brief [7:0] Peak Frequency Value (for changing direction) (rw) */
    __IO Ifx_UReg_16Bit FREQ_1_OVRD:1;     /**< \brief [8:8] Frequency Register Override (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_9:7;    /**< \brief [15:9] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_FREQ_1_Bits;

/** \brief Current MPLL phase selector value */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_PHASE_Bits
{
    __IO Ifx_UReg_16Bit DTHR:2;            /**< \brief [1:0] Bits below the useful resolution (2 reads needed to read value) (rwh) */
    __IO Ifx_UReg_16Bit VAL:9;             /**< \brief [10:2] Phase value from zero reference (2 reads needed to read value) (rwh) */
    __IO Ifx_UReg_16Bit ZERO_FREQ:1;       /**< \brief [11:11] Zero frequency register (rwh) */
    __IO Ifx_UReg_16Bit FRACN_CTRL_DIV:4;    /**< \brief [15:12] FracN Ctrl Divisor to get better resolution and lower PPM errors when synthesizing from a non-integer reference clock (rwh) */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_PHASE_Bits;

/** \brief Override values for incoming REFCLK and RESET controls from ASIC #0 */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_REFCLK_OVRD_IN_0_Bits
{
    __IO Ifx_UReg_16Bit REF_CLK_EN:1;      /**< \brief [0:0] Override value for ref_clk_en (rw) */
    __IO Ifx_UReg_16Bit REF_CLK_EN_OVRD_EN:1;    /**< \brief [1:1] Override enable for ref_clk_en (rw) */
    __IO Ifx_UReg_16Bit REF_CLK_DIV2_EN:1;    /**< \brief [2:2] Override value for ref_clk_div2_en (rw) */
    __IO Ifx_UReg_16Bit REF_CLK_DIV2_EN_OVRD_EN:1;    /**< \brief [3:3] Override enable for ref_clk_div2_en (rw) */
    __IO Ifx_UReg_16Bit REF_USE_PAD:1;     /**< \brief [4:4] Override value for ref_use_pad (rw) */
    __IO Ifx_UReg_16Bit REF_USE_PAD_OVRD_EN:1;    /**< \brief [5:5] Override enable for ref_use_pad (rw) */
    __IO Ifx_UReg_16Bit REF_REPEAT_CLK_EN:1;    /**< \brief [6:6] Override value for ref_repeat_clk_en (rw) */
    __IO Ifx_UReg_16Bit REF_REPEAT_CLK_EN_OVRD_EN:1;    /**< \brief [7:7] Override enable for ref_repeat_clk_en (rw) */
    __IO Ifx_UReg_16Bit REF_CLK_RANGE:3;    /**< \brief [10:8] Override value for ref_range[2:0] (rw) */
    __IO Ifx_UReg_16Bit REF_CLK_RANGE_OVRD_EN:1;    /**< \brief [11:11] Override enable for ref_range[2:0] (rw) */
    __IO Ifx_UReg_16Bit BG_EN:1;           /**< \brief [12:12] Override value for bg_en (rw) */
    __IO Ifx_UReg_16Bit BG_EN_OVRD_EN:1;    /**< \brief [13:13] Override enable for bg_en (rw) */
    __IO Ifx_UReg_16Bit REF_CLKDET_EN:1;    /**< \brief [14:14] Override value for ref_clkdet_en (rw) */
    __IO Ifx_UReg_16Bit REF_CLKDET_EN_OVRD_EN:1;    /**< \brief [15:15] Override enable for ref_clkdet_en (rw) */
} Ifx_HSPHY_PHY_SUPX_DIG_REFCLK_OVRD_IN_0_Bits;

/** \brief Override values for incoming REFCLK and RESET controls from ASIC #1 */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_REFCLK_OVRD_IN_1_Bits
{
    __IO Ifx_UReg_16Bit VPH_NOMINAL:2;     /**< \brief [1:0] Override value for nominal_vph_sel[1:0] (rw) */
    __IO Ifx_UReg_16Bit VPH_NOMINAL_OVRD_EN:1;    /**< \brief [2:2] Override enable for nominal_vph_sel[1:0] (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_3:13;    /**< \brief [15:3] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_REFCLK_OVRD_IN_1_Bits;

/** \brief Configure Rtune Operation */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_CONFIG_Bits
{
    __IO Ifx_UReg_16Bit FAST_RTUNE:1;      /**< \brief [0:0] Enable fast resistor tuning (simulation only) (rw) */
    __IO Ifx_UReg_16Bit RX_CAL_EN:1;       /**< \brief [1:1] Enable calibration of RX resistor (rw) */
    __IO Ifx_UReg_16Bit TX_CAL_EN:1;       /**< \brief [2:2] Enable calibration of TX resistor (rw) */
    __IO Ifx_UReg_16Bit RTUNE_PWRUP_TIME:6;    /**< \brief [8:3] Set the power-up timer in terms of number of ref_range_clk cycles (time >=721us) (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_9:7;    /**< \brief [15:9] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_CONFIG_Bits;

/** \brief Resistor tuning debug controls */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_DEBUG_Bits
{
...
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_DEBUG_Bits;

/** \brief Set value of RX Resistor */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_RX_SET_VAL_Bits
{
    __IO Ifx_UReg_16Bit RX_SET_VAL:6;      /**< \brief [5:0] Set value of RX resistor Writing a value to this register will set the RX resistor value (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_6:10;    /**< \brief [15:6] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_RX_SET_VAL_Bits;

/** \brief RX Resistor tuning register status */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_RX_STAT_Bits
{
    __I  Ifx_UReg_16Bit RX_STAT:6;         /**< \brief [5:0] Current value of the RX resistor tuning register (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_6:10;    /**< \brief [15:6] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_RX_STAT_Bits;

/** \brief Resistor tuning register status */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_STAT_Bits
{
    __I  Ifx_UReg_16Bit STAT:10;           /**< \brief [9:0] Current value of the register specified by the DEBUG.TYPE field (rh) */
    __I  Ifx_UReg_16Bit DTB_RTUNE:2;       /**< \brief [11:10] DTB sampling for rtune where dtb_rtune = {"{"}(rtune_state[2]^rtune_state[1]),rtune_state[0]{"}"}  and rtune_state[2:0]  equals to  RTUNE_IDLE           = 3\'b000;   RTUNE_REXT           = 3\'b001;  RTUNE_PWRUP          = 3\'b011;  RTUNE_COMP_RST       = 3\'b010;   RTUNE_COMP_EVAL      = 3\'b110;   RTUNE_DONE           = 3\'b100;  RTUNE_TXDN2UP        = 3\'b101; (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_12:4;    /**< \brief [15:12] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_STAT_Bits;

/** \brief Set value of TX-DN Resistor */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXDN_SET_VAL_Bits
{
    __IO Ifx_UReg_16Bit TXDN_SET_VAL:10;    /**< \brief [9:0] Set value of TX-DN resistor Writing a value to this register will set the TX-DN resistor value (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_10:6;    /**< \brief [15:10] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXDN_SET_VAL_Bits;

/** \brief TX-DN Resistor tuning register status */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXDN_STAT_Bits
{
    __I  Ifx_UReg_16Bit TXDN_STAT:10;      /**< \brief [9:0] Current value of the TX-DN resistor tuning register (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_10:6;    /**< \brief [15:10] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXDN_STAT_Bits;

/** \brief Set value of TX-UP Resistor */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXUP_SET_VAL_Bits
{
    __IO Ifx_UReg_16Bit TXUP_SET_VAL:10;    /**< \brief [9:0] Set value of TX-UP resistor Writing a value to this register will set the TX-UP resistor value (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_10:6;    /**< \brief [15:10] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXUP_SET_VAL_Bits;

/** \brief TX-UP Resistor tuning register status */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXUP_STAT_Bits
{
    __I  Ifx_UReg_16Bit TXUP_STAT:10;      /**< \brief [9:0] Current value of the TX-UP resistor tuning register (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_10:6;    /**< \brief [15:10] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXUP_STAT_Bits;

/** \brief Current values (pre-override) for incoming level controls from ASIC */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_RX_TXUP_TERM_OFFSET_ASIC_IN_Bits
{
    ...
    __I  Ifx_UReg_16Bit RESERVED_15_14:2;    /**< \brief [15:14] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_RX_TXUP_TERM_OFFSET_ASIC_IN_Bits;

/** \brief Current values (pre-override) for incoming level controls from ASIC */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_SUP_ASIC_IN_0_Bits
{
    __I  Ifx_UReg_16Bit VPH_NOMINAL:2;     /**< \brief [1:0] Value from ASIC for nominal_vph_sel (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_2:14;    /**< \brief [15:2] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_SUP_ASIC_IN_0_Bits;

/** \brief Current values (pre-override) for incoming level controls from ASIC */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_SUP_ASIC_IN_1_Bits
{
    __I  Ifx_UReg_16Bit MPLLA_TX_CLK_DIV:3;    /**< \brief [2:0] Value from ASIC for mplla_tx_clk_div (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_3:13;    /**< \brief [15:3] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_SUP_ASIC_IN_1_Bits;

/** \brief Override values for support block ASIC inputs */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_0_Bits
{
    __IO Ifx_UReg_16Bit RTUNE_REQ:1;       /**< \brief [0:0] Override value for rtune_req (rw) */
    __IO Ifx_UReg_16Bit RTUNE_OVRD_EN:1;    /**< \brief [1:1] Enable override of rtune_req input signals overridden by this enable are:  rtune_req (rw) */
    __IO Ifx_UReg_16Bit RES_REQ_IN:1;      /**< \brief [2:2] Override value for res_req_in (rw) */
    __IO Ifx_UReg_16Bit RES_ACK_IN:1;      /**< \brief [3:3] Override value for res_ack_in (rw) */
    __IO Ifx_UReg_16Bit RES_OVRD_EN:1;     /**< \brief [4:4] Enable override of res_req_in and res_ack_in input signals overridden by this enable are:  res_ack_in  res_req_in (rw) */
    __IO Ifx_UReg_16Bit REF_CLK_ACK:1;     /**< \brief [5:5] Override value for ref_clk_ack_i output (rw) */
    __IO Ifx_UReg_16Bit REF_CLKD_ACK_OVRD_EN:1;    /**< \brief [6:6] Override enable for ref_clk_ack_i output (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_7:9;    /**< \brief [15:7] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_0_Bits;

/** \brief Override values for support block ASIC inputs, register #1 */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_1_Bits
{
    __IO Ifx_UReg_16Bit TXUP_TERM_OFFSET:9;    /**< \brief [8:0] Override value for TXUP termination offset txup_term_offset[8:0] (rw) */
    __IO Ifx_UReg_16Bit TXUP_TERM_OFFSET_OVRD_EN:1;    /**< \brief [9:9] Override enable for TXUP termination offset (rw) */
    __IO Ifx_UReg_16Bit RX_TERM_OFFSET:5;    /**< \brief [14:10] Override value for RX termination Offset rx_term_offset[4:0] (rw) */
    __IO Ifx_UReg_16Bit RX_TERM_OFFSET_OVRD_EN:1;    /**< \brief [15:15] Override enable for RX termination Offset input signals overridden by this enable are:  rx_term_offset[4:0] (rw) */
} Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_1_Bits;

/** \brief Override values for support block ASIC inputs, register #2 */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_2_Bits
{
    __IO Ifx_UReg_16Bit TXDN_TERM_OFFSET:9;    /**< \brief [8:0] Override value for TXDN termination offset txdn_term_offset[8:0] (rw) */
    __IO Ifx_UReg_16Bit TXDN_TERM_OFFSET_OVRD_EN:1;    /**< \brief [9:9] Override enable for TXDN termination Offset input signals overridden by this enable are:  txdn_term_offset[8:0] (rw) */
    __IO Ifx_UReg_16Bit SUP_VREG_BYPASS_TO_VP:1;    /**< \brief [10:10] Override value for sup_vreg_bypass_to_vp (rw) */
    __IO Ifx_UReg_16Bit SUP_VREG_BYPASS_TO_VP_OVRD_EN:1;    /**< \brief [11:11] Override enable for sup_vreg_bypass_to_vp input signals overridden by this enable are:  sup_vreg_bypass_to_vp (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_12:4;    /**< \brief [15:12] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_2_Bits;

/** \brief Override values for incoming SUP MISC BUS from ASIC */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_MISC_Bits
{
    __IO Ifx_UReg_16Bit SUP_MISC_OVRD_VAL:8;    /**< \brief [7:0] Override value for sup_misc[7:0] (rw) */
    __IO Ifx_UReg_16Bit SUP_MISC_OVRD_EN:1;    /**< \brief [8:8] Override Enable for sup_misc[7:0] (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_9:7;    /**< \brief [15:9] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_MISC_Bits;

/** \brief Override values for support block ASIC outputs */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_OUT_Bits
{
    __IO Ifx_UReg_16Bit RTUNE_ACK:1;       /**< \brief [0:0] Override value for rtune_ack output (rw) */
    __IO Ifx_UReg_16Bit RTUNE_ACK_OVRD_EN:1;    /**< \brief [1:1] Override enable for rtune_ack output (rw) */
    __IO Ifx_UReg_16Bit RES_REQ_OUT:1;     /**< \brief [2:2] Override value for res_req_out output (rw) */
    __IO Ifx_UReg_16Bit RES_REQ_OUT_OVRD_EN:1;    /**< \brief [3:3] Override enable for res_req_out output (rw) */
    __IO Ifx_UReg_16Bit RES_ACK_OUT:1;     /**< \brief [4:4] Override value for res_ack_out output (rw) */
    __IO Ifx_UReg_16Bit RES_ACK_OUT_OVRD_EN:1;    /**< \brief [5:5] Override enable for res_ack_out output (rw) */
    __IO Ifx_UReg_16Bit MPLLA_STATE:1;     /**< \brief [6:6] Override value for mplla_state output (rw) */
    __IO Ifx_UReg_16Bit MPLLA_STATE_OVRD_EN:1;    /**< \brief [7:7] Override enable for mplla_state output (rw) */
    __IO Ifx_UReg_16Bit RESERVED:2;        /**< \brief [9:8] Reserved for future use (rw) */
    __IO Ifx_UReg_16Bit REF_CLKDET_RESULT:1;    /**< \brief [10:10] Override value for ref_clkdet_result output (rw) */
    __IO Ifx_UReg_16Bit REF_CLKDET_RESULT_OVRD_EN:1;    /**< \brief [11:11] Override enable for ref_clkdet_result output (rw) */
    __I  Ifx_UReg_16Bit RESERVED_15_12:4;    /**< \brief [15:12] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_OUT_Bits;

/** \brief Current values (pre-override) for incoming level controls from ASIC */
typedef struct _Ifx_HSPHY_PHY_SUPX_DIG_TXDN_TERM_OFFSET_ASIC_IN_Bits
{
    __I  Ifx_UReg_16Bit TXDN_TERM_OFFSET:9;    /**< \brief [8:0] Value from ASIC for txup_term_offset (rh) */
    __I  Ifx_UReg_16Bit RESERVED_15_9:7;    /**< \brief [15:9] Reserved for Future use (r) */
} Ifx_HSPHY_PHY_SUPX_DIG_TXDN_TERM_OFFSET_ASIC_IN_Bits;
...
/** \brief SR MII MMD Control Register0 */
...
/** \brief VR MII MMD Digital Control1 Register0 */
...
/** \brief VR MII MMD Digital Control 3 Register0 */
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB1_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB1;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB2_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB2;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB3_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB3;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_LOOP_CTRL_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_LOOP_CTRL;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_OVRD_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_OVRD;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_REG_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_REG;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TEST0_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TEST0;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TEST1_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TEST1;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TESTANA0_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TESTANA0;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TESTANA1_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TESTANA1;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_ANA_RTUNE_CTRL_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_ANA_RTUNE_CTRL;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_MISC_MEAS_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_MISC_MEAS;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_MISC_MEAS_1_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_MISC_MEAS_1;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_PWR_MEAS_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_PWR_MEAS;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_ANA_BG_OVRD_OUT_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_ANA_BG_OVRD_OUT;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_ANA_MPLLA_OVRD_OUT_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_ANA_MPLLA_OVRD_OUT;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_ANA_MPLLA_PMIX_OVRD_OUT_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_ANA_MPLLA_PMIX_OVRD_OUT;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_ANA_RTUNE_OVRD_OUT_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_ANA_RTUNE_OVRD_OUT;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_ANA_RX_TERM_OVRD_OUT_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_ANA_RX_TERM_OVRD_OUT;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_ANA_STAT_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_ANA_STAT;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_ANA_STAT1_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_ANA_STAT1;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_ASIC_IN_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_ASIC_IN;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_DEBUG_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_DEBUG;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_FREQ_CNT_PEAK_ASIC_IN_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_FREQ_CNT_PEAK_ASIC_IN;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_IDCODE_HI_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_IDCODE_HI;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_IDCODE_LO_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_IDCODE_LO;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_LVL_ASIC_IN_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_LVL_ASIC_IN;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_LVL_OVRD_IN_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_LVL_OVRD_IN;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MISC_ASIC_IN_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MISC_ASIC_IN;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_ASIC_IN_0_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_ASIC_IN_0;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_ASIC_IN_1_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_ASIC_IN_1;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_B_DIV_CLK_ASIC_IN_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_B_DIV_CLK_ASIC_IN;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_DIV_CLK_OVRD_IN_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_DIV_CLK_OVRD_IN;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_BG_PWRUP_TIME_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_BG_PWRUP_TIME;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_ANA_DAC_OUT_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_ANA_DAC_OUT;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_CAL_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_CAL;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_DAC_MAXRANGE_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_DAC_MAXRANGE;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_OVRD_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_OVRD;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_0_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_0;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_1_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_1;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_2_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_2;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_3_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_3;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_STAT_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_STAT;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_0_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_0;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_1_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_1;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_2_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_2;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_3_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_3;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_4_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_4;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_5_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_5;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_FREQ_0_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_FREQ_0;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_FREQ_1_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_FREQ_1;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_PHASE_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_PHASE;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_REFCLK_OVRD_IN_0_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_REFCLK_OVRD_IN_0;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_REFCLK_OVRD_IN_1_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_REFCLK_OVRD_IN_1;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_CONFIG_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_CONFIG;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_DEBUG_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_DEBUG;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_RX_SET_VAL_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_RX_SET_VAL;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_RX_STAT_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_RX_STAT;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_STAT_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_STAT;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXDN_SET_VAL_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXDN_SET_VAL;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXDN_STAT_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXDN_STAT;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXUP_SET_VAL_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXUP_SET_VAL;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXUP_STAT_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXUP_STAT;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_RX_TXUP_TERM_OFFSET_ASIC_IN_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_RX_TXUP_TERM_OFFSET_ASIC_IN;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_SUP_ASIC_IN_0_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_SUP_ASIC_IN_0;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_SUP_ASIC_IN_1_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_SUP_ASIC_IN_1;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_0_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_0;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_1_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_1;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_2_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_2;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_MISC_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_MISC;
...
typedef union
{
    __IO Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_OUT_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_OUT;
...
typedef union
{
    __I  Ifx_UReg_16Bit U;                 /**< \brief Unsigned access */
    __I  Ifx_SReg_16Bit I;                 /**< \brief Signed access */
    Ifx_HSPHY_PHY_SUPX_DIG_TXDN_TERM_OFFSET_ASIC_IN_Bits B;    /**< \brief Bitfield access */
} Ifx_HSPHY_PHY_SUPX_DIG_TXDN_TERM_OFFSET_ASIC_IN;
...
{
       __IO Ifx_HSPHY_XPCS_MII_CTRL             CTRL;                   /**< \brief 0, SR MII MMD Control Register0*/
       __I  Ifx_UReg_8Bit                       reserved_4[131068];     /**< \brief 4, \internal Reserved */
       __IO Ifx_HSPHY_XPCS_MII_DIG_CTRL1        DIG_CTRL1;              /**< \brief 20000, VR MII MMD Digital Control1 Register0*/
       __I  Ifx_UReg_8Bit                       reserved_20004[12];     /**< \brief 20004, \internal Reserved */
       __IO Ifx_HSPHY_XPCS_MII_VR_MII_DIG_CTRL3 VR_MII_DIG_CTRL3;       /**< \brief 20010, VR MII MMD Digital Control 3 Register0*/
...
/******************************************************************************/
/******************************************************************************/
/** \addtogroup IfxSfr_Hsphy_PHY_SUPX_struct
 * \{  */
/******************************************************************************/
/** \name Object L2
 * \{  */
/** \brief SUPX object */
typedef volatile struct _Ifx_HSPHY_PHY_SUPX
{
       __I  Ifx_HSPHY_PHY_SUPX_DIG_IDCODE_LO    DIG_IDCODE_LO;          /**< \brief 0, Low 16 bits of IDCODE*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_IDCODE_HI    DIG_IDCODE_HI;          /**< \brief 2, High 16 bits of IDCODE*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_REFCLK_OVRD_IN_0 DIG_REFCLK_OVRD_IN_0;    /**< \brief 4, Override values for incoming REFCLK and RESET controls from ASIC #0*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_REFCLK_OVRD_IN_1 DIG_REFCLK_OVRD_IN_1;    /**< \brief 6, Override values for incoming REFCLK and RESET controls from ASIC #1*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_DIV_CLK_OVRD_IN DIG_MPLLA_DIV_CLK_OVRD_IN;    /**< \brief 8, Override values for incoming MPLLA_DIV_CLK controls from ASIC*/
       __I  Ifx_UReg_8Bit                       reserved_A[2];          /**< \brief A, \internal Reserved */
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_0 DIG_MPLLA_OVRD_IN_0;    /**< \brief C, Override values for incoming MPLLA controls from ASIC, register #0*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_1 DIG_MPLLA_OVRD_IN_1;    /**< \brief E, Override values for incoming MPLLA controls from ASIC, register #1*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_2 DIG_MPLLA_OVRD_IN_2;    /**< \brief 10, Override values for incoming MPLLA controls from ASIC, register #2*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_3 DIG_MPLLA_OVRD_IN_3;    /**< \brief 12, Override values for incoming MPLLA controls from ASIC, register #3*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_4 DIG_MPLLA_OVRD_IN_4;    /**< \brief 14, Override values for incoming MPLLA controls from ASIC, register #4*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_OVRD_IN_5 DIG_MPLLA_OVRD_IN_5;    /**< \brief 16, Override values for incoming MPLLA controls from ASIC, register #5*/
       __I  Ifx_UReg_8Bit                       reserved_18[12];        /**< \brief 18, \internal Reserved */
       __IO Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_0 DIG_SUP_OVRD_IN_0;      /**< \brief 24, Override values for support block ASIC inputs*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_OUT DIG_SUP_OVRD_OUT;       /**< \brief 26, Override values for support block ASIC outputs*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_LVL_OVRD_IN  DIG_LVL_OVRD_IN;        /**< \brief 28, Override values for level settings*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_DEBUG        DIG_DEBUG;              /**< \brief 2A, Debug controls*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_ASIC_IN_0 DIG_MPLLA_ASIC_IN_0;    /**< \brief 2C, Current values (pre-override) for incoming MPLLA controls from ASIC, register #0*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_ASIC_IN_1 DIG_MPLLA_ASIC_IN_1;    /**< \brief 2E, Current values (pre-override) for incoming MPLLA controls from ASIC, register #1*/
       __I  Ifx_UReg_8Bit                       reserved_30[8];         /**< \brief 30, \internal Reserved */
       __I  Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_B_DIV_CLK_ASIC_IN DIG_MPLLA_B_DIV_CLK_ASIC_IN;    /**< \brief 38, Current values (pre-override) for incoming MPLLA_B_DIV_CLK controls from ASIC*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_ASIC_IN      DIG_ASIC_IN;            /**< \brief 3A, Current values (pre-override) for incoming SUP control signals from ASIC*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_LVL_ASIC_IN  DIG_LVL_ASIC_IN;        /**< \brief 3C, Current values (pre-override) for incoming level controls from ASIC*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_FREQ_CNT_PEAK_ASIC_IN DIG_FREQ_CNT_PEAK_ASIC_IN;    /**< \brief 3E, Current values (pre-override) for incoming SSC frequency peak controls from ASIC*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_1 DIG_SUP_OVRD_IN_1;      /**< \brief 40, Override values for support block ASIC inputs, register #1*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_IN_2 DIG_SUP_OVRD_IN_2;      /**< \brief 42, Override values for support block ASIC inputs, register #2*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_RX_TXUP_TERM_OFFSET_ASIC_IN DIG_RX_TXUP_TERM_OFFSET_ASIC_IN;    /**< \brief 44, Current values (pre-override) for incoming level controls from ASIC*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_TXDN_TERM_OFFSET_ASIC_IN DIG_TXDN_TERM_OFFSET_ASIC_IN;    /**< \brief 46, Current values (pre-override) for incoming level controls from ASIC*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_SUP_OVRD_MISC DIG_SUP_OVRD_MISC;      /**< \brief 48, Override values for incoming SUP MISC BUS from ASIC*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_MISC_ASIC_IN DIG_MISC_ASIC_IN;       /**< \brief 4A, Current values (pre-override) for incoming level controls from ASIC*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_SUP_ASIC_IN_0 DIG_SUP_ASIC_IN_0;      /**< \brief 4C, Current values (pre-override) for incoming level controls from ASIC*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_SUP_ASIC_IN_1 DIG_SUP_ASIC_IN_1;      /**< \brief 4E, Current values (pre-override) for incoming level controls from ASIC*/
       __I  Ifx_UReg_8Bit                       reserved_50[48];        /**< \brief 50, \internal Reserved */
       __IO Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_LOOP_CTRL ANA_MPLLA_LOOP_CTRL;    /**< \brief 80, Configures MPLLA loop bandwidth*/
       __IO Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_OVRD   ANA_MPLLA_OVRD;         /**< \brief 82, MPLLA Override Control Registers*/
       __IO Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB1   ANA_MPLLA_ATB1;         /**< \brief 84, MPLLA analog test bus controls (1 of 3)*/
       __IO Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB2   ANA_MPLLA_ATB2;         /**< \brief 86, MPLLA analog test bus controls (2 of 3)*/
       __IO Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_ATB3   ANA_MPLLA_ATB3;         /**< \brief 88, MPLLA analog test bus controls (3 of 3)*/
       __I  Ifx_UReg_8Bit                       reserved_8A[10];        /**< \brief 8A, \internal Reserved */
       __IO Ifx_HSPHY_PHY_SUPX_ANA_RTUNE_CTRL   ANA_RTUNE_CTRL;         /**< \brief 94, Resistor Tuning and Margin DAC control registers*/
       __IO Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_PWR_MEAS ANA_SWITCH_PWR_MEAS;    /**< \brief 96, Local power supply measurement in SUP_ANA*/
       __IO Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_MISC_MEAS_1 ANA_SWITCH_MISC_MEAS_1;    /**< \brief 98, Miscellaneous analog test bus control and regulator reference voltage control*/
       __IO Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_REG    ANA_MPLLA_REG;          /**< \brief 9A, CP regulator cco frequency tuning register*/
       __I  Ifx_UReg_8Bit                       reserved_9C[2];         /**< \brief 9C, \internal Reserved */
       __IO Ifx_HSPHY_PHY_SUPX_ANA_SWITCH_MISC_MEAS ANA_SWITCH_MISC_MEAS;    /**< \brief 9E, Temperature range, iptat & ref voltage related control register for sup_por*/
       __IO Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TEST0  ANA_MPLLA_TEST0;        /**< \brief A0, mplla testmodes register*/
       __IO Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TEST1  ANA_MPLLA_TEST1;        /**< \brief A2, mplla testmodes register*/
       __IO Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TESTANA0 ANA_MPLLA_TESTANA0;     /**< \brief A4, testmodes register*/
       __IO Ifx_HSPHY_PHY_SUPX_ANA_MPLLA_TESTANA1 ANA_MPLLA_TESTANA1;     /**< \brief A6, testmodes register*/
       __I  Ifx_UReg_8Bit                       reserved_A8[24];        /**< \brief A8, \internal Reserved */
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_OVRD DIG_MPLLA_MPLL_PWR_CTL_MPLL_OVRD;    /**< \brief C0, MPLL override controls*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_STAT DIG_MPLLA_MPLL_PWR_CTL_STAT;    /**< \brief C2, MPLL status register*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_DAC_MAXRANGE DIG_MPLLA_MPLL_PWR_CTL_MPLL_DAC_MAXRANGE;    /**< \brief C4, Defaul cal_force, freq_vco, MPLL DAC in And MAXRANGE Values*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_0 DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_0;    /**< \brief C6, Timer thresholds for Reset Setup, Stable and Lock*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_1 DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_1;    /**< \brief C8, Timer thresholds for power up gearshift and reset*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_2 DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_2;    /**< \brief CA, Timer thresholds for pclk enable and Power down wait*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_3 DIG_MPLLA_MPLL_PWR_CTL_MPLL_TIMERS_3;    /**< \brief CC, Timer thresholds for Pclk disable and Power down*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_CAL DIG_MPLLA_MPLL_PWR_CTL_MPLL_CAL;    /**< \brief CE, MPLL Calibration Override*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_MPLL_ANA_DAC_OUT DIG_MPLLA_MPLL_PWR_CTL_MPLL_ANA_DAC_OUT;    /**< \brief D0, MPLL status register*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_MPLL_PWR_CTL_BG_PWRUP_TIME DIG_MPLLA_MPLL_PWR_CTL_BG_PWRUP_TIME;    /**< \brief D2, BG Power UP Time Register*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_PHASE DIG_MPLLA_SSC_SS_PHASE;    /**< \brief D4, Current MPLL phase selector value*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_FREQ_0 DIG_MPLLA_SSC_SS_FREQ_0;    /**< \brief D6, Frequency Control for Spread Spectrum #0*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_MPLLA_SSC_SS_FREQ_1 DIG_MPLLA_SSC_SS_FREQ_1;    /**< \brief D8, Frequency Control for Spread Spectrum #1*/
       __I  Ifx_UReg_8Bit                       reserved_DA[38];        /**< \brief DA, \internal Reserved */
       __IO Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_DEBUG  DIG_RTUNE_DEBUG;        /**< \brief 100, Resistor tuning debug controls*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_CONFIG DIG_RTUNE_CONFIG;       /**< \brief 102, Configure Rtune Operation*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_STAT   DIG_RTUNE_STAT;         /**< \brief 104, Resistor tuning register status*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_RX_SET_VAL DIG_RTUNE_RX_SET_VAL;    /**< \brief 106, Set value of RX Resistor*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXDN_SET_VAL DIG_RTUNE_TXDN_SET_VAL;    /**< \brief 108, Set value of TX-DN Resistor*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXUP_SET_VAL DIG_RTUNE_TXUP_SET_VAL;    /**< \brief 10A, Set value of TX-UP Resistor*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_RX_STAT DIG_RTUNE_RX_STAT;      /**< \brief 10C, RX Resistor tuning register status*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXDN_STAT DIG_RTUNE_TXDN_STAT;    /**< \brief 10E, TX-DN Resistor tuning register status*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_RTUNE_TXUP_STAT DIG_RTUNE_TXUP_STAT;    /**< \brief 110, TX-UP Resistor tuning register status*/
       __I  Ifx_UReg_8Bit                       reserved_112[28];       /**< \brief 112, \internal Reserved */
       __IO Ifx_HSPHY_PHY_SUPX_DIG_ANA_MPLLA_OVRD_OUT DIG_ANA_MPLLA_OVRD_OUT;    /**< \brief 12E, Override value for mplla signals going to ANA*/
       __I  Ifx_UReg_8Bit                       reserved_130[2];        /**< \brief 130, \internal Reserved */
       __IO Ifx_HSPHY_PHY_SUPX_DIG_ANA_RTUNE_OVRD_OUT DIG_ANA_RTUNE_OVRD_OUT;    /**< \brief 132, Override value for RTUNE signals going to ANA*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_ANA_RX_TERM_OVRD_OUT DIG_ANA_RX_TERM_OVRD_OUT;    /**< \brief 134, Override value for RX termination signals going to ANA*/
       __I  Ifx_HSPHY_PHY_SUPX_DIG_ANA_STAT     DIG_ANA_STAT;           /**< \brief 136, SUP input status register for SUP ANA outputs*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_ANA_BG_OVRD_OUT DIG_ANA_BG_OVRD_OUT;    /**< \brief 138, Override values for bandgap signals going to ANA*/
       __IO Ifx_HSPHY_PHY_SUPX_DIG_ANA_MPLLA_PMIX_OVRD_OUT DIG_ANA_MPLLA_PMIX_OVRD_OUT;    /**< \brief 13A, Override value for mplla pmix signals going to ANA*/
       __I  Ifx_UReg_8Bit                       reserved_13C[2];        /**< \brief 13C, \internal Reserved */
       __I  Ifx_HSPHY_PHY_SUPX_DIG_ANA_STAT1    DIG_ANA_STAT1;          /**< \brief 13E, SUP input status register for SUP ANA outputs*/
} Ifx_HSPHY_PHY_SUPX;
...
typedef volatile struct _Ifx_HSPHY_PHY
{
       ...
       __IO Ifx_HSPHY_PHY_SUPX                  SUPX;                   /**< \brief 10000, */
       __I  Ifx_UReg_8Bit                       reserved_10140[7872];    /**< \brief 10140, \internal Reserved */
...
typedef volatile struct _Ifx_HSPHY
{
       ...
       __I  Ifx_UReg_8Bit                       reserved_248[952];      /**< \brief 248, \internal Reserved */
