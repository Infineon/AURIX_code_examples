...
#define CLOCK_ACCENAPLL_WRA /*lint --e(923, 9078)*/ (*(volatile Ifx_CLOCK_ACCEN_WRA*)0xF0064080u)

/** \brief 84, Write access enable register B */
#define CLOCK_ACCENAPLL_WRB /*lint --e(923, 9078)*/ (*(volatile Ifx_CLOCK_ACCEN_WRB_FPI*)0xF0064084u)

/** \brief 88, Read access enable register A */
#define CLOCK_ACCENAPLL_RDA /*lint --e(923, 9078)*/ (*(volatile Ifx_CLOCK_ACCEN_RDA*)0xF0064088u)

/** \brief 8C, Read access enable register B */
#define CLOCK_ACCENAPLL_RDB /*lint --e(923, 9078)*/ (*(volatile Ifx_CLOCK_ACCEN_RDB_FPI*)0xF006408Cu)

/** \brief 90, VM access enable register */
#define CLOCK_ACCENAPLL_VM /*lint --e(923, 9078)*/ (*(volatile Ifx_CLOCK_ACCEN_VM*)0xF0064090u)

/** \brief 94, PRS access enable register */
#define CLOCK_ACCENAPLL_PRS /*lint --e(923, 9078)*/ (*(volatile Ifx_CLOCK_ACCEN_PRS*)0xF0064094u)
...
/** \brief 70C, Audio-PLL configuration register 0 */
#define CLOCK_APLLCON0 /*lint --e(923, 9078)*/ (*(volatile Ifx_CLOCK_APLLCON0*)0xF006470Cu)

/** \brief 710, Audio-PLL configuration register 1 */
#define CLOCK_APLLCON1 /*lint --e(923, 9078)*/ (*(volatile Ifx_CLOCK_APLLCON1*)0xF0064710u)

/** \brief 714, Audio-PLL configuration register 2 */
#define CLOCK_APLLCON2 /*lint --e(923, 9078)*/ (*(volatile Ifx_CLOCK_APLLCON2*)0xF0064714u)

/** \brief 71C, Audio-PLL status register */
#define CLOCK_APLLSTAT /*lint --e(923, 9078)*/ (*(volatile Ifx_CLOCK_APLLSTAT*)0xF006471Cu)
