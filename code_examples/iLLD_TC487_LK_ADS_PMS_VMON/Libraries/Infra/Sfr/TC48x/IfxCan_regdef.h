 ...
 *
 *
 * Version: MC_ACE_A3G_HSI_MCMCAN/V0.2.4.1.0
...
typedef struct _Ifx_CAN_N_CCCR_Bits
{
    ...
    __IO Ifx_UReg_32Bit MON:1;             /**< \brief [5:5] Bus Monitoring Mode - MON (rw) */
...
typedef struct _Ifx_CAN_N_PSR_Bits
{
    ...
    __I  Ifx_UReg_32Bit TDCV:7;            /**< \brief [22:16] Transmitter Delay Compensation Value - TDCV (rh) */
...
typedef struct _Ifx_CAN_N_TEST_Bits
{
    ...
    __IO Ifx_UReg_32Bit LBCK:1;            /**< \brief [4:4] Loop Back Mode - LBCK (rw) */
    __IO Ifx_UReg_32Bit TX:2;              /**< \brief [6:5] Control of Transmit Pin - TX (rw) */
