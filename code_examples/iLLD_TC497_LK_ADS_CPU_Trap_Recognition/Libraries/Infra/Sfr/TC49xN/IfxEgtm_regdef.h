...
/** \brief eGTM to ASCLIN0 output selection register. 0<8 then interface exists. */
...
/** \brief eGTM to CAN0 output selection register 0. 0*4+ 0<18 then interface exists. */
...
{
       __IO Ifx_EGTM_CAN_OUT                    OUT[4];                 /**< \brief 0, eGTM to CAN0 output selection register 0. 0*4+ 0<18 then interface exists.*/
} Ifx_EGTM_CAN;
...
{
       __IO Ifx_EGTM_ASCLIN_OUT                 OUT;                    /**< \brief 0, eGTM to ASCLIN0 output selection register. 0<8 then interface exists.*/
} Ifx_EGTM_ASCLIN;
...
typedef volatile struct _Ifx_EGTM
{
       ...
       __IO Ifx_EGTM_FOUTENC                    FOUTENC[4];             /**< \brief 61500, FOUT Selection for Encoder Interface 0. 4 resources exist on this device.*/
       ...
       __IO Ifx_EGTM_ASCLIN                     ASCLIN[28];             /**< \brief 61600, eGTM to ASCLIN0 output selection register. 0<8 then interface exists.*/
       ...
       __I  Ifx_UReg_8Bit                       reserved_618A0[352];    /**< \brief 618A0, \internal Reserved */
