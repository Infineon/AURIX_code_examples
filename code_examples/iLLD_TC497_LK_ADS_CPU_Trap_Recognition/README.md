...
# iLLD_TC497_LK_ADS_CPU_Trap_Recognition 
...
- Observe the following information:
    ...
    parameters. The trap is provoked by CPU0 (*tCpu*), it is a trap of class `4` (*tClass*), the trap id is `2` (*tId*) and the return address (*tAddr*) is `0x80002cf8`
...
- Observe the following information:
    ...
    - The trap is provoked by CPU0, it is a trap of class `4`, the trap id is `3` and the return address is `0x800009DE`
...
- Observe the following information:
    ...
    - The trap is provoked by CPU0, it is a trap of class `5`, the trap id is `1` and the return address is `0x80002D3E`
