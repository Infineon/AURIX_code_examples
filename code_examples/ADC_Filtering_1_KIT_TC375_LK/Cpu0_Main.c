 ...
 *
 * \name ADC_Filtering_1_KIT_TC375_LK
 * \version V1.0.0
 ...
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_ADC_Filtering_1_KIT_TC375_LK-TR-v01_00_00-EN.pdf
...
void core0_main(void)
{
    ...
    /* Introduce a delay to avoid reading incorrect values due to the filters not being yet at full speed */
    wait(ticksFor100ms);
    ...
    while(1)
    {
        ...
        IIRmeasure.currentValue  = readADCValue(AN38) / DIV_FACTOR_IIR;
        FIRmeasure.currentValue  = readADCValue(AN37) / DIV_FACTOR_FIR;
