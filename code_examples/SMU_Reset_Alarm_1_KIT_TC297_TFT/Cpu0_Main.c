 ...
 * \name SMU_Reset_Alarm_1_KIT_TC297_TFT
 * \version V1.0.1
 ...
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_SMU_Reset_Alarm_1_KIT_TC297_TFT-TR-v01_00_01-EN.pdf
...
int core0_main(void)
{
    ...
    config_SMU_reset();  /* Call the configuration function of the SMU  */
    trigger_SMU_reset(); /* Call the triggering function of the Alarm 0 */
