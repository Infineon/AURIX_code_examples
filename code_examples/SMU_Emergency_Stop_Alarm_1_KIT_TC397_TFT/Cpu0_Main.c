 ...
 *
 * \name SMU_Emergency_Stop_Alarm_1_KIT_TC397_TFT
 * \version V1.0.2
 ...
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_SMU_Emergency_Stop_Alarm_1_KIT_TC397_TFT-TR-v01_00_02-EN.pdf
...
void core0_main(void)
{
    ...
    config_SMU_Emergency_Stop();    /* Configure the SMU            */
    trigger_SMU_Emergency_Stop();   /* Trigger the Software Alarm 0 */
