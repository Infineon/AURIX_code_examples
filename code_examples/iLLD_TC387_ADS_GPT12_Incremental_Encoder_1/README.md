...
# iLLD_TC387_ADS_GPT12_Incremental_Encoder_1  
...
The General Purpose Timer Unit (GPT12) consists of two GPT blocks (GPT1 and GPT2). Each block has a multifunctional timer structure which incorporates several 16-bit timers.
...
## Hardware setup  
This code example is developed for the board KIT_A2G_TC387_5V_TFT

<img src="./Images/TC38x_bottom.png" width="800" />

## Implementation  

**NOTE:** The *Bsp.h* and *Bsp.c* files were replaced using the files from TC375.
...
- Modify *IfxGpt12_IncrEnc_Config* according to application needs
...
After code compilation and flashing the device open OneEye configuration by double clicking on: Libraries/ iLLD_TC387_ADS_GPT12_Incremental_Encoder_1.OneEye or click on OneEye button within Aurix Development Studio.
