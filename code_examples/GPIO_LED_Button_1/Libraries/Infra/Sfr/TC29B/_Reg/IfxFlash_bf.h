...
#define IFX_FLASH_FSR_P2BUSY_LEN (1u)

/** \brief  Mask for Ifx_FLASH_FSR_Bits.P2BUSY */
#define IFX_FLASH_FSR_P2BUSY_MSK (0x1u)

/** \brief  Offset for Ifx_FLASH_FSR_Bits.P2BUSY */
#define IFX_FLASH_FSR_P2BUSY_OFF (5u)

/** \brief  Length for Ifx_FLASH_FSR_Bits.P3BUSY */
#define IFX_FLASH_FSR_P3BUSY_LEN (1u)

/** \brief  Mask for Ifx_FLASH_FSR_Bits.P3BUSY */
#define IFX_FLASH_FSR_P3BUSY_MSK (0x1u)

/** \brief  Offset for Ifx_FLASH_FSR_Bits.P3BUSY */
#define IFX_FLASH_FSR_P3BUSY_OFF (6u)
...
#define IFX_FLASH_MARP_SELP2_LEN (1u)

/** \brief  Mask for Ifx_FLASH_MARP_Bits.SELP2 */
#define IFX_FLASH_MARP_SELP2_MSK (0x1u)

/** \brief  Offset for Ifx_FLASH_MARP_Bits.SELP2 */
#define IFX_FLASH_MARP_SELP2_OFF (2u)

/** \brief  Length for Ifx_FLASH_MARP_Bits.SELP3 */
#define IFX_FLASH_MARP_SELP3_LEN (1u)

/** \brief  Mask for Ifx_FLASH_MARP_Bits.SELP3 */
#define IFX_FLASH_MARP_SELP3_MSK (0x1u)

/** \brief  Offset for Ifx_FLASH_MARP_Bits.SELP3 */
#define IFX_FLASH_MARP_SELP3_OFF (3u)
