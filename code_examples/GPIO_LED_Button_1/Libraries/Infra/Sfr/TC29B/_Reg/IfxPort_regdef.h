...
typedef union
{
    ...
    Ifx_P_LPCR0_P21_Bits B_P21;             /**< \brief Bitfield access for P21 */
} Ifx_P_LPCR0;
...
typedef union
{
    ...
    Ifx_P_LPCR2_P21_Bits B_P21;             /**< \brief Bitfield access for P21 */
} Ifx_P_LPCR2;
...
typedef union
{
    unsigned int U;                         /**< \brief Unsigned access */
    signed int I;                           /**< \brief Signed access */
    Ifx_P_LPCR3_Bits B;                     /**< \brief Bitfield access */
} Ifx_P_LPCR3;
