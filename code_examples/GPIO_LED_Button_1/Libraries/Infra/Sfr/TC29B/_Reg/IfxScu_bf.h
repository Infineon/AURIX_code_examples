...
#define IFX_SCU_CCUCON0_ADCCLKSEL_LEN (2u)

/** \brief  Mask for Ifx_SCU_CCUCON0_Bits.ADCCLKSEL */
#define IFX_SCU_CCUCON0_ADCCLKSEL_MSK (0x3u)

/** \brief  Offset for Ifx_SCU_CCUCON0_Bits.ADCCLKSEL */
#define IFX_SCU_CCUCON0_ADCCLKSEL_OFF (26u)
...
#define IFX_SCU_CCUCON5_EBUDIV_LEN (4u)

/** \brief  Mask for Ifx_SCU_CCUCON5_Bits.EBUDIV */
#define IFX_SCU_CCUCON5_EBUDIV_MSK (0xfu)

/** \brief  Offset for Ifx_SCU_CCUCON5_Bits.EBUDIV */
#define IFX_SCU_CCUCON5_EBUDIV_OFF (4u)
