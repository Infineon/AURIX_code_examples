...
channel g_chn[] = { {&IfxEvadc_G8CH7_P40_9_IN,  (IfxEvadc_ChannelResult) 0  },  /* AN39 pin  (Average filter channel)  */
                    {&IfxEvadc_G8CH6_P40_8_IN,  (IfxEvadc_ChannelResult) 15 },  /* AN38 pin  (IIR filter channel)      */
                    {&IfxEvadc_G8CH5_P40_7_IN,  (IfxEvadc_ChannelResult) 7  },  /* AN37 pin  (FIR filter channel)      */
                    {&IfxEvadc_G8CH4_P40_6_IN,  (IfxEvadc_ChannelResult) 1  }   /* AN36 pin  (No data modification)    */
};
...
void initEVADCGroup(void)
{
    ...
    adcGroupConf.groupId = IfxEvadc_GroupId_8;                          /* Select the group                         */
...
{
    /* Accumulate 4 result values within the result register before generating a final result for AN39 */
    EVADC_G8_RCR0.B.DMM = IfxEvadc_DataModificationMode_standardDataReduction;  /* Set the Data Modification Mode bit field to Standard Data Reduction */
    EVADC_G8_RCR0.B.DRCTR = IfxEvadc_DataReductionControlMode_3;                /* Configure the Result Register 0 of Group 8 to accumulate 4 conversions */

    /* Apply a 1st order Infinite Impulse Response Filter (IIR) to the result register G8RES15 (AN38) */
    EVADC_G8_RCR15.B.DMM = IfxEvadc_DataModificationMode_resultFilteringMode;   /* Set the Data Modification Mode bit field to Result filtering mode */
    EVADC_G8_RCR15.B.DRCTR = IfxEvadc_DataReductionControlMode_15;              /* Configure the Result Register 15 of Group 8 to apply an IIR filter (a=3, b=4) */

    /* Apply a 3rd order Finite Impulse Response Filter (FIR) to the result register G8RES7 (AN37) */
    EVADC_G8_RCR7.B.DMM = IfxEvadc_DataModificationMode_resultFilteringMode;    /* Set the Data Modification Mode bit field to Result filtering mode */
    EVADC_G8_RCR7.B.DRCTR = IfxEvadc_DataReductionControlMode_4;                /* Configure the Result Register 7 of Group 8 to apply a FIR filter (a=1, b=0, c=2) */
}
