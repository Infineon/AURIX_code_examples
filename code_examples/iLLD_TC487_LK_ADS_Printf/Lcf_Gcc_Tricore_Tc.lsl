...
__TRICORE_DERIVATE_MEMORY_MAP__ = 0x480;
...
MEMORY
{
    ...
    prram2 (rx!p): org = 0x80800000, len = 4M
    prram2_nc (rx!p): org = 0xA0800000, len = 4M

    prram3 (rx!p): org = 0x80C00000, len = 4M
    prram3_nc (rx!p): org = 0xA0C00000, len = 4M

	
    ucb (rx!p): org = 0xae400000, len = 32K
