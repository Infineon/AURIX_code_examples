 ...
 *
 * \name ADC_Filtering_1_KIT_TC275_LK
 * \version V1.0.0
 ...
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_ADC_Filtering_1_KIT_TC275_LK-TR-v01_00_00-EN.pdf
...
int core0_main(void)
{
    ...
    while(1)
    {
        ...
        AVRGmeasure.currentValue = readADCValue(AN39) / DIV_FACTOR_AVRG;
        FIRmeasure.currentValue  = readADCValue(AN38) / DIV_FACTOR_FIR;
        IIRmeasure.currentValue  = readADCValue(AN37) / DIV_FACTOR_IIR;
        NORMmeasure.currentValue = readADCValue(AN36);
