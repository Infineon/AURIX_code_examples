 ...
 *
 * \name CPU_Perf_Counters_1_KIT_TC297_TFT
 * \version V1.0.0
 * \board APPLICATION KIT TC2X7 V1.1, KIT_AURIX_TC297_TFT_BC-Step, TC29xTA/TX_B-Step
 * \keywords AURIX, CPU, CPU_Perf_Counters_1, Performance
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_CPU_Perf_Counters_1_KIT_TC297_TFT-TR-v01_00_00-EN.pdf
...
int core0_main(void)
{
    ...
    initCpuPerfCounters(); /* Initialize the CPU performance counters   */
