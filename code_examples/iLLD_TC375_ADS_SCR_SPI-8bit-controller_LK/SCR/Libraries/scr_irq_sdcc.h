...
#define SSC_EIREN           (0x01)  /* SSC Error Interrupt Enable */
#define SSC_TIREN           (0x02)  /* SSC Transmit Interrupt Enable */
#define SSC_RIREN           (0x04)  /* SSC Receive Interrupt Enable */
#define SSC_FEEN            (0x08)  /* SSC Receive FIFO Empty Interrupt Enable */
#define SSC_FFEN            (0x10)  /* SSC Receive FIFO Full Interrupt Enable */

#define SSC_EIR             (0x01)  /* Error Interrupt Flag for SSC */
#define SSC_TIR             (0x02)  /* Transmit Interrupt Flag for SSC */
#define SSC_RIR             (0x04)  /* Receive Interrupt Flag for SSC */
#define SSC_RER             (0x20)  /* Receive FIFO Empty Interrupt Flag for SSC */
#define SSC_RFR             (0x40)  /* Receive FIFO Full Interrupt Flag for SSC */
