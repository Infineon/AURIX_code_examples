/**
 * \file IfxEray_PinMap_TC46x_BGA436_STD.c
 * \brief ERAY  details
 *
...
#include "IfxEray_PinMap_TC46x_BGA436_STD.h"
...
IfxEray_Txd_Out  IfxEray0_TXDB_P11_14_OUT = {&MODULE_ERAY0, (IfxEray_NodeId)1, {&MODULE_P11, 14}, IfxPort_OutputIdx_alt4};
