...
#ifndef IFXNVMR_CFG_TC46X_H
#define IFXNVMR_CFG_TC46X_H 1
 ...
 */
#define IFXNVMR_DNVM_EEPROM_SIZE                                 (0x80000u)
...
/** \brief PNVM20 END
 */
#define IFXNVMR_PNVM20_END                                       (IFXNVMR_PNVM20_START + 0x100000u - 1u)

/** \brief PNVM21 START
 */
#define IFXNVMR_PNVM21_START                                     (0xA0900000)

/** \brief PNVM21 END
 */
#define IFXNVMR_PNVM21_END                                       (IFXNVMR_PNVM21_START + 0x100000u - 1u)

/** \brief PNVM31 START
 */
#define IFXNVMR_PNVM30_START                                     (0xA0A00000)

/** \brief PNVM30 END
 */
#define IFXNVMR_PNVM30_END                                       (IFXNVMR_PNVM30_START + 0x100000u - 1u)

/** \brief PNVM31 START
 */
#define IFXNVMR_PNVM31_START                                     (0xA0B00000)

/** \brief PNVM31 END
 */
#define IFXNVMR_PNVM31_END                                       (IFXNVMR_PNVM31_START + 0x100000u - 1u)

/** \brief Number of Bits to be Shifted for 1MB page offset
 */
#define IFXNVMR_NVMADDR_1MB_PAGE_OFFSET_BIT_SHIFT                (20u)

/** \brief Staring bank index for the 1MB page address offset banks
 */
#define IFXNVMR_PNVM_BANK_STARTING_POSITION_INDEX_FOR_1MB_OFFSET (4u)
