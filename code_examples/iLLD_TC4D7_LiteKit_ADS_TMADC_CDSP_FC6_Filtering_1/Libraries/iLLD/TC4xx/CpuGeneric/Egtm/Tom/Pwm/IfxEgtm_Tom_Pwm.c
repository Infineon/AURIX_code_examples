...
#if defined(DEVICE_TC4DX) || defined(DEVICE_TC48X) || defined(DEVICE_TC48XA21) || defined(DEVICE_TC4ZX) 
...
#endif /* #if defined(DEVICE_TC4DX) || defined(DEVICE_TC48X) || defined(DEVICE_TC48XA21) || defined(DEVICE_TC4ZX) */
    }
