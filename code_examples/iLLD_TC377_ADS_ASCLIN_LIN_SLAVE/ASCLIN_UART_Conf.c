...
void send_ASCLIN_UART_message(uint8 *mess, Ifx_SizeT size)
{
    IfxAsclin_Asc_write(&g_ascHandle, mess, &size, TIME_INFINITE);   /* Transmit data via TX */
}
