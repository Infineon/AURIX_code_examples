...
void IfxAsclin_Lin_initModuleConfig(IfxAsclin_Lin_Config *config, Ifx_ASCLIN *asclin)
{
    ...
    {
        config->interrupt.enabledInterrupt.rxReceivedHeader            = TRUE;
        config->interrupt.enabledInterrupt.rxReceivedResponse          = TRUE;
        config->interrupt.enabledInterrupt.txTransmittedHeader         = TRUE;
        config->interrupt.enabledInterrupt.txTransmittedResponse       = TRUE;
        config->interrupt.enabledInterrupt.exBreakDetected             = TRUE;
        config->interrupt.enabledInterrupt.exTransmissionCompleted     = TRUE;
        config->interrupt.enabledInterrupt.exHeaderTimeout             = TRUE;
        config->interrupt.enabledInterrupt.exResponseTimeout           = TRUE;
        config->interrupt.enabledInterrupt.exLinParityError            = TRUE;
        config->interrupt.enabledInterrupt.exLinAutobaudDetectionError = TRUE;
        config->interrupt.enabledInterrupt.exLinChecksumError          = TRUE;
        config->interrupt.enabledInterrupt.exFramingError              = TRUE;
        config->interrupt.enabledInterrupt.exCollisionDetectionError   = TRUE;
        config->interrupt.enabledInterrupt.exReceiveFIFOOverflow       = TRUE;
        config->interrupt.enabledInterrupt.exTransmitFIFOOverflow      = TRUE;
    }
