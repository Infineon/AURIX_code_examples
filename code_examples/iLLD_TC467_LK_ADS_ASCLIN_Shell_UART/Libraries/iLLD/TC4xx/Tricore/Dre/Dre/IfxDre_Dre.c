...
void IfxDre_Dre_initEthAddressDatabase(IfxDre_Dre *dre, IfxDre_Dre_EADConfig *config)
{
...
#if defined(DEVICE_TC4DX) || defined(DEVICE_TC48X) || defined(DEVICE_TC44X) || defined(DEVICE_TC4ZX) || defined(DEVICE_TC4EX)
    Ifx_LETH *lethSFR     = (Ifx_LETH *)&MODULE_LETH0;
#endif /* #if defined(DEVICE_TC4DX) || defined(DEVICE_TC48X) || defined(DEVICE_TC44X) || defined(DEVICE_TC4ZX) || defined(DEVICE_TC4EX) */
#if defined(DEVICE_TC4DX) || defined(DEVICE_TC48X) || defined(DEVICE_TC44X) || defined(DEVICE_TC4ZX)
    ...
    *databasePtr   = (uint32)(&gethSFR->DMA.CH[config->gethMac1RxChannelNumber].RXDESC_TAIL_LPOINTER.U);
    ...
    Ifx_LETH *lethSFR0     = (Ifx_LETH *)&MODULE_LETH0; /*Module Address for Leth0*/
    Ifx_LETH *lethSFR1     = (Ifx_LETH *)&MODULE_LETH1; /*Module Address for Leth1*/
