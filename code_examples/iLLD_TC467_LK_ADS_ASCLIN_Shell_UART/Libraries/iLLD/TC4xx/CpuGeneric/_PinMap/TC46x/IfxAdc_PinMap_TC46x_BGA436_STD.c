/**
 * \file IfxAdc_PinMap_TC46x_BGA436_STD.c
 * \brief ADC  details
 *
...
#include "IfxAdc_PinMap_TC46x_BGA436_STD.h"
...
IfxAdc_Clkin_In     IfxAdc_CLKIN0_P33_11_IN = {&MODULE_ADC, {&MODULE_P33, 11}, Ifx_RxSel_a};

IfxAdc_Clkin_In     IfxAdc_CLKIN1_P33_13_IN = {&MODULE_ADC, {&MODULE_P33, 13}, Ifx_RxSel_a};

IfxAdc_Clkin_In     IfxAdc_CLKIN2_P32_5_IN = {&MODULE_ADC, {&MODULE_P32, 5}, Ifx_RxSel_a};

IfxAdc_Clkin_In     IfxAdc_CLKIN3_P10_0_IN = {&MODULE_ADC, {&MODULE_P10, 0}, Ifx_RxSel_a};

IfxAdc_Clkin_In     IfxAdc_CLKIN4_P00_0_IN = {&MODULE_ADC, {&MODULE_P00, 0}, Ifx_RxSel_a};

IfxAdc_Clkin_In     IfxAdc_CLKIN5_P10_6_IN = {&MODULE_ADC, {&MODULE_P10, 6}, Ifx_RxSel_a};

IfxAdc_Clkin_In     IfxAdc_CLKIN6_P01_7_IN = {&MODULE_ADC, {&MODULE_P01, 7}, Ifx_RxSel_a};

IfxAdc_Clkin_In     IfxAdc_CLKIN7_P01_6_IN = {&MODULE_ADC, {&MODULE_P01, 6}, Ifx_RxSel_a};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT0_P32_2_OUT = {&MODULE_ADC, {&MODULE_P32, 2}, IfxPort_OutputIdx_alt7};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT0_P33_11_OUT = {&MODULE_ADC, {&MODULE_P33, 11}, IfxPort_OutputIdx_alt10};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT0_P33_5_OUT = {&MODULE_ADC, {&MODULE_P33, 5}, IfxPort_OutputIdx_alt4};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT1_P33_13_OUT = {&MODULE_ADC, {&MODULE_P33, 13}, IfxPort_OutputIdx_alt11};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT1_P33_1_OUT = {&MODULE_ADC, {&MODULE_P33, 1}, IfxPort_OutputIdx_alt4};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT2_P32_4_OUT = {&MODULE_ADC, {&MODULE_P32, 4}, IfxPort_OutputIdx_alt13};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT2_P32_5_OUT = {&MODULE_ADC, {&MODULE_P32, 5}, IfxPort_OutputIdx_alt7};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT2_P33_3_OUT = {&MODULE_ADC, {&MODULE_P33, 3}, IfxPort_OutputIdx_alt4};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT3_P10_0_OUT = {&MODULE_ADC, {&MODULE_P10, 0}, IfxPort_OutputIdx_alt5};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT3_P13_6_OUT = {&MODULE_ADC, {&MODULE_P13, 6}, IfxPort_OutputIdx_alt10};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT4_P00_0_OUT = {&MODULE_ADC, {&MODULE_P00, 0}, IfxPort_OutputIdx_alt7};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT4_P01_14_OUT = {&MODULE_ADC, {&MODULE_P01, 14}, IfxPort_OutputIdx_alt3};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT5_P10_6_OUT = {&MODULE_ADC, {&MODULE_P10, 6}, IfxPort_OutputIdx_alt15};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT6_P01_12_OUT = {&MODULE_ADC, {&MODULE_P01, 12}, IfxPort_OutputIdx_alt3};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT6_P01_7_OUT = {&MODULE_ADC, {&MODULE_P01, 7}, IfxPort_OutputIdx_alt6};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT7_P01_3_OUT = {&MODULE_ADC, {&MODULE_P01, 3}, IfxPort_OutputIdx_alt3};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT7_P01_6_OUT = {&MODULE_ADC, {&MODULE_P01, 6}, IfxPort_OutputIdx_alt6};

IfxAdc_Clkout_Out   IfxAdc_CLKOUT7_P02_15_OUT = {&MODULE_ADC, {&MODULE_P02, 15}, IfxPort_OutputIdx_alt7};

IfxAdc_Data_In      IfxAdc_DATA0_P33_4_IN = {&MODULE_ADC, {&MODULE_P33, 4}, Ifx_RxSel_a};

IfxAdc_Data_In      IfxAdc_DATA1_P33_7_IN = {&MODULE_ADC, {&MODULE_P33, 7}, Ifx_RxSel_a};

IfxAdc_Data_In      IfxAdc_DATA2_P32_6_IN = {&MODULE_ADC, {&MODULE_P32, 6}, Ifx_RxSel_a};

IfxAdc_Data_In      IfxAdc_DATA3_P10_1_IN = {&MODULE_ADC, {&MODULE_P10, 1}, Ifx_RxSel_a};

IfxAdc_Data_In      IfxAdc_DATA4_P00_3_IN = {&MODULE_ADC, {&MODULE_P00, 3}, Ifx_RxSel_a};

IfxAdc_Data_In      IfxAdc_DATA5_P10_5_IN = {&MODULE_ADC, {&MODULE_P10, 5}, Ifx_RxSel_a};

IfxAdc_Data_In      IfxAdc_DATA6_P01_5_IN = {&MODULE_ADC, {&MODULE_P01, 5}, Ifx_RxSel_a};

IfxAdc_Data_In      IfxAdc_DATA7_P01_4_IN = {&MODULE_ADC, {&MODULE_P01, 4}, Ifx_RxSel_a};
...
IfxAdc_Dsadcn_In    IfxAdc_DSADCNC_AN57_IN = {&MODULE_ADC, {NULL_PTR, 57}, Ifx_RxSel_c};

IfxAdc_Dsadcn_In    IfxAdc_DSADCNC_AN59_IN = {&MODULE_ADC, {NULL_PTR, 59}, Ifx_RxSel_c};
...
IfxAdc_Dsadcn_In    IfxAdc_DSADCNC_P41_0_IN = {&MODULE_ADC, {&MODULE_P41, 0}, Ifx_RxSel_c};
...
IfxAdc_Dsadcn_In    IfxAdc_DSADCND_AN49_IN = {&MODULE_ADC, {NULL_PTR, 49}, Ifx_RxSel_d};

IfxAdc_Dsadcn_In    IfxAdc_DSADCND_AN65_IN = {&MODULE_ADC, {NULL_PTR, 65}, Ifx_RxSel_d};

IfxAdc_Dsadcn_In    IfxAdc_DSADCND_P41_4_IN = {&MODULE_ADC, {&MODULE_P41, 4}, Ifx_RxSel_d};
...
IfxAdc_Dsadcp_In    IfxAdc_DSADCPC_AN56_IN = {&MODULE_ADC, {NULL_PTR, 56}, Ifx_RxSel_c};

IfxAdc_Dsadcp_In    IfxAdc_DSADCPC_AN58_IN = {&MODULE_ADC, {NULL_PTR, 58}, Ifx_RxSel_c};

IfxAdc_Dsadcp_In    IfxAdc_DSADCPC_AN66_IN = {&MODULE_ADC, {NULL_PTR, 66}, Ifx_RxSel_c};
...
IfxAdc_Dsadcp_In    IfxAdc_DSADCPD_AN48_IN = {&MODULE_ADC, {NULL_PTR, 48}, Ifx_RxSel_d};

IfxAdc_Dsadcp_In    IfxAdc_DSADCPD_AN64_IN = {&MODULE_ADC, {NULL_PTR, 64}, Ifx_RxSel_d};

IfxAdc_Dsadcp_In    IfxAdc_DSADCPD_P41_3_IN = {&MODULE_ADC, {&MODULE_P41, 3}, Ifx_RxSel_d};
...
IfxAdc_Fcc_In       IfxAdc_Fcc_FCC1_AN0_IN = {&MODULE_ADC, {NULL_PTR, 0}, Ifx_RxSel_a};

IfxAdc_Fcc_In       IfxAdc_Fcc_FCC2_AN20_IN = {&MODULE_ADC, {NULL_PTR, 20}, Ifx_RxSel_a};

IfxAdc_Fcc_In       IfxAdc_Fcc_FCC3_AN12_IN = {&MODULE_ADC, {NULL_PTR, 12}, Ifx_RxSel_a};
...
IfxAdc_Fcc_In       IfxAdc_Fcc_FCC6_AN16_IN = {&MODULE_ADC, {NULL_PTR, 16}, Ifx_RxSel_a};

IfxAdc_Fcc_In       IfxAdc_Fcc_FCC7_P40_11_IN = {&MODULE_ADC, {&MODULE_P40, 11}, Ifx_RxSel_a};

IfxAdc_Fcc_In       IfxAdc_Fcc_FCC8_P40_6_IN = {&MODULE_ADC, {&MODULE_P40, 6}, Ifx_RxSel_a};
...
IFX_CONST IfxAdc_Clkin_In     *IfxAdc_Clkin_In_pinTable[IFXADC_PINMAP_NUM_MODULES][IFXADC_PINMAP_CLKIN_IN_NUM_ITEMS] = {
    {
        &IfxAdc_CLKIN4_P00_0_IN,
        &IfxAdc_CLKIN7_P01_6_IN,
        &IfxAdc_CLKIN6_P01_7_IN,
        &IfxAdc_CLKIN3_P10_0_IN,
        &IfxAdc_CLKIN5_P10_6_IN,
        &IfxAdc_CLKIN2_P32_5_IN,
        &IfxAdc_CLKIN0_P33_11_IN,
        &IfxAdc_CLKIN1_P33_13_IN,
    },
};

IFX_CONST IfxAdc_Clkout_Out   *IfxAdc_Clkout_Out_pinTable[IFXADC_PINMAP_NUM_MODULES][IFXADC_PINMAP_CLKOUT_OUT_NUM_ITEMS] = {
    {
        &IfxAdc_CLKOUT4_P00_0_OUT,
        &IfxAdc_CLKOUT7_P01_3_OUT,
        &IfxAdc_CLKOUT7_P01_6_OUT,
        &IfxAdc_CLKOUT6_P01_7_OUT,
        &IfxAdc_CLKOUT6_P01_12_OUT,
        &IfxAdc_CLKOUT4_P01_14_OUT,
        &IfxAdc_CLKOUT7_P02_15_OUT,
        &IfxAdc_CLKOUT3_P10_0_OUT,
        &IfxAdc_CLKOUT5_P10_6_OUT,
        &IfxAdc_CLKOUT3_P13_6_OUT,
        &IfxAdc_CLKOUT0_P32_2_OUT,
        &IfxAdc_CLKOUT2_P32_4_OUT,
        &IfxAdc_CLKOUT2_P32_5_OUT,
        &IfxAdc_CLKOUT1_P33_1_OUT,
        &IfxAdc_CLKOUT2_P33_3_OUT,
        &IfxAdc_CLKOUT0_P33_5_OUT,
        &IfxAdc_CLKOUT0_P33_11_OUT,
        &IfxAdc_CLKOUT1_P33_13_OUT,
    },
};

IFX_CONST IfxAdc_Data_In      *IfxAdc_Data_In_pinTable[IFXADC_PINMAP_NUM_MODULES][IFXADC_PINMAP_DATA_IN_NUM_ITEMS] = {
    {
        &IfxAdc_DATA4_P00_3_IN,
        &IfxAdc_DATA7_P01_4_IN,
        &IfxAdc_DATA6_P01_5_IN,
        &IfxAdc_DATA3_P10_1_IN,
        &IfxAdc_DATA5_P10_5_IN,
        &IfxAdc_DATA2_P32_6_IN,
        &IfxAdc_DATA0_P33_4_IN,
        &IfxAdc_DATA1_P33_7_IN,
    },
};
...
IFX_CONST IfxAdc_Dsadcn_In    *IfxAdc_Dsadcn_In_pinTable[IFXADC_PINMAP_NUM_MODULES][IFXADC_PINMAP_DSADCN_IN_NUM_ITEMS] = {
    {
        ...
        &IfxAdc_DSADCNC_AN57_IN,
        &IfxAdc_DSADCNC_AN59_IN,
        &IfxAdc_DSADCNC_P40_10_IN,
        &IfxAdc_DSADCNC_P40_12_IN,
        &IfxAdc_DSADCNC_P41_0_IN,
        &IfxAdc_DSADCND_AN35_IN,
        &IfxAdc_DSADCND_AN47_IN,
        &IfxAdc_DSADCND_AN49_IN,
        &IfxAdc_DSADCND_AN65_IN,
        &IfxAdc_DSADCND_P41_4_IN,
    },
};
...
IFX_CONST IfxAdc_Dsadcp_In    *IfxAdc_Dsadcp_In_pinTable[IFXADC_PINMAP_NUM_MODULES][IFXADC_PINMAP_DSADCP_IN_NUM_ITEMS] = {
    {
        ...
        &IfxAdc_DSADCPC_AN56_IN,
        &IfxAdc_DSADCPC_AN58_IN,
        &IfxAdc_DSADCPC_AN66_IN,
        &IfxAdc_DSADCPC_P40_11_IN,
        &IfxAdc_DSADCPD_AN34_IN,
        &IfxAdc_DSADCPD_AN46_IN,
        &IfxAdc_DSADCPD_AN48_IN,
        &IfxAdc_DSADCPD_AN64_IN,
        &IfxAdc_DSADCPD_P41_3_IN,
    },
};
...
IFX_CONST IfxAdc_Fcc_In       *IfxAdc_Fcc_In_pinTable[IFXADC_FCC_PINMAP_NUM_MODULES][IFXADC_PINMAP_FCC_IN_NUM_ITEMS] = {
    {
        ...
        &IfxAdc_Fcc_FCC1_AN0_IN,
        &IfxAdc_Fcc_FCC0_AN2_IN,
        &IfxAdc_Fcc_FCC3_AN12_IN,
        &IfxAdc_Fcc_FCC9_AN14_IN,
        &IfxAdc_Fcc_FCC6_AN16_IN,
        &IfxAdc_Fcc_FCC2_AN20_IN,
        &IfxAdc_Fcc_FCC8_P40_6_IN,
