...
# iLLD_TC467_LK_ADS_ASCLIN_Shell_UART
...
## Board  
The board used for testing is the TriBoard TC467 lite Kit (KIT_A3G_TC467_LITE)
## Scope of work   
...
- Type "toggle [0/1/2]" to respectively: turn on all LEDs, toggle LED P22.7, P22.6
