 ...
 * IN THE SOFTWARE.
 *********************************************************************************************************************/
/*\title GTM TOM 3-Phase Inverter PWM generation
 * \abstract The GTM TOM is configured to generate a PWM signals for two-level three phase inverter.
 ...
 *
 * \name iLLD_TC387_ADS_GTM_TOM_3_Phase_Inverter_PWM_1
 * \version V1.0.0
 * \board APPLICATION KIT TC3X7 V2.0, KIT_A2G_TC387_5V_TFT, TC38xQP_A-Step
 * \keywords AURIX, GTM, TOM, 3_Phase_Inverter, Inverter, PWM, general timer, timer, xEV
...
void core0_main(void)
{
    ...
    while(1)
    {
        updateGtmTom3phInvDuty();   /* Update duty cycles */
