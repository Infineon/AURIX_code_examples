...
#define PHASE_U_HS              &IfxGtm_TOM1_0_TOUT0_P02_0_OUT         /* Pin which will be driven by the PWM, P02.0 */
#define PHASE_U_LS              &IfxGtm_TOM1_0N_TOUT7_P02_7_OUT        /* Pin which will be driven by the PWM, P02.7 */
#define PHASE_V_HS              &IfxGtm_TOM1_1_TOUT1_P02_1_OUT         /* Pin which will be driven by the PWM, P02.1 */
#define PHASE_V_LS              &IfxGtm_TOM1_1N_TOUT4_P02_4_OUT        /* Pin which will be driven by the PWM, P02.4 */
#define PHASE_W_HS              &IfxGtm_TOM1_2_TOUT2_P02_2_OUT         /* Pin which will be driven by the PWM, P02.2 */
#define PHASE_W_LS              &IfxGtm_TOM1_2N_TOUT5_P02_5_OUT        /* Pin which will be driven by the PWM, P02.5 */
...
void initGtmTom3phInv(void)
{
    ...
    config.clockSource.atom       = IfxGtm_Cmu_Fxclk_0;                /* Clock source for tom                       */
...
{
    if((g_gtmTom3phInv.dutyCycles[0] + PHASE_DUTY_STEP) >= 100)
    {
        g_gtmTom3phInv.dutyCycles[0] = 0;                                  /* Set duty to zero                       */
    }
    if((g_gtmTom3phInv.dutyCycles[1] + PHASE_DUTY_STEP) >= 100)
    {
        g_gtmTom3phInv.dutyCycles[1] = 0;                                  /* Set duty to zero                       */
    }
    if((g_gtmTom3phInv.dutyCycles[2] + PHASE_DUTY_STEP) >= 100)
    {
        g_gtmTom3phInv.dutyCycles[2] = 0;                                   /* Set duty to zero                      */
    }

    g_gtmTom3phInv.dutyCycles[0] += PHASE_DUTY_STEP;                        /* Increment PWM duty cycle of phase U   */
    g_gtmTom3phInv.dutyCycles[1] += PHASE_DUTY_STEP;                        /* Increment PWM duty cycle of phase V   */
    g_gtmTom3phInv.dutyCycles[2] += PHASE_DUTY_STEP;                        /* Increment PWM duty cycle of phase W   */
