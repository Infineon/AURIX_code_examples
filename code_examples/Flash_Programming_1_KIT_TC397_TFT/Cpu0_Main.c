 ...
 *              memory is turned ON.
 *
 * \name Flash_Programming_1_KIT_TC397_TFT
 * \version V1.0.1
 ...
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_Flash_Programming_1_KIT_TC397_TFT-TR-v01_00_01-EN.pdf
