...
#ifndef IFXNVMR_CFG_TC4ZX_H
#define IFXNVMR_CFG_TC4ZX_H 1
 ...
 */
#define IFXNVMR_DNVM_EEPROM_SIZE          (0x100000u)
 ...
 */
#define IFXNVMR_CFG_FLASH_WAITSTATE       (10u)
...
typedef enum
{
    ...
    IfxNvmr_Pnvm_4A = 0x08,   /**< \brief PRRAM A for CPU4 */
    IfxNvmr_Pnvm_4B = 0x09,   /**< \brief PRRAM B for CPU4 */
    IfxNvmr_Pnvm_5A = 0x0a,   /**< \brief PRRAM A for CPU4 */
    IfxNvmr_Pnvm_5B = 0x0b   /**< \brief PRRAM B for CPU4 */
} IfxNvmr_Pnvm;
...
{ 
    ...
    IfxNvmr_PmurSegment_p40 = 8u,            /**< \brief PFlash40 */ 
    IfxNvmr_PmurSegment_p41 = 9u,            /**< \brief PFlash41 */ 
    IfxNvmr_PmurSegment_p50 = 10u,            /**< \brief PFlash50 */ 
    IfxNvmr_PmurSegment_p51 = 11u,            /**< \brief PFlash51 */ 
    IfxNvmr_PmurSegment_invalid = 0xFFu     /**< \brief Invalid Flash */
} IfxNvmr_PmurSegment;

/** \} */

#endif /* IFXNVMR_CFG_TC4ZX_H */
