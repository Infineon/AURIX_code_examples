...
#ifndef IFXPCIE_CFG_TC45X_H
#define IFXPCIE_CFG_TC45X_H 1
...
/** \brief Max Number of PCIE Modules across family
 */
#define IFXPCIE_CFG_MAX_NUM_MODULES            (((uint32)(2)))

/** \brief Number of PCIE Modules
 */
#define IFXPCIE_CFG_NUM_MODULES                (1)
...
/******************************************************************************/
IFX_EXTERN IFX_CONST IfxPcie_MemoryLimits IfxPcie_cfg_memoryMap[IFXPCIE_CFG_MAX_NUM_MODULES];

IFX_EXTERN IFX_CONST IfxModule_IndexMap   IfxPcie_cfg_pcieIndexMap[IFXPCIE_CFG_NUM_MODULES];

/** \} */

#endif /* IFXPCIE_CFG_TC45X_H */
