...
#ifndef IFXEGTM_CFG_TC4ZX_H
#define IFXEGTM_CFG_TC4ZX_H 1
 ...
 */
#define IFXEGTM_PWM_START_STOP_CHANNEL_OUTPUT_ENABLE       (FALSE)

/** \brief Availability of the PWM output status
 */
#define IFXEGTM_PWM_OUTPUT_STATUS                          (FALSE)
