...
#ifndef IFXSRC_CFG_TC45X_H
#define IFXSRC_CFG_TC45X_H 1
...
typedef enum
{
    ...
    IfxSrc_Tos_rdma = 11  /**< \brief RDMA interrupt service provider, which handles the interrupt service request. */
} IfxSrc_Tos;
