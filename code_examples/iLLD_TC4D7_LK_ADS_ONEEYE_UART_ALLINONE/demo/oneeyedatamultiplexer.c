...
} IFX_OE_PACK_STRUCT_END DataStreaming_Data_0;
...
} IFX_OE_PACK_STRUCT_END DataStreaming_Data_1;
...
void OneEyeDataMultiplexer_init(Ifx_Oe_SyncProtocol* bb)
{
    /* Initialize the sync protocol channel assigned to the data multiplexer / multiplexer */
    Ifx_Oe_SyncProtocol_addClient(bb, &g_dataMultiplexer, BB_LOCAL_PORT_DEMUX, BB_REMOTE_PORT_DEMUX, IFX_CFG_OE_SYNCPROTOCOL_MESSAGE_PAYLOAD_MAX_LENGTH, 10);
