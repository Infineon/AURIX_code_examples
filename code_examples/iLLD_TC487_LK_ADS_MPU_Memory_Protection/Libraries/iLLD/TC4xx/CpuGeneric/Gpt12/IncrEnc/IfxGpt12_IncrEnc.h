...
/** \brief Initializes the Incremental interface.
 *
 * \param[inout] driver Incremental encoder interface Handle.
 * \param[in]    config Configuration structure for incremental encoder.
 *
 ...
 *
 * \param[inout] config Configuration structure for incremental encoder.
 ...
 *
 * \retval float32 Absolute position.
 */
 ...
 * \param[in] driver Driver handle.
 *
 * \retval IfxGpt12_IncrEnc_Direction Direction. Range: \ref IfxGpt12_IncrEnc_Direction.
 */
 ...
 * \param[in] driver Driver handle.
 *
 * \retval sint32 Position in ticks.
 */
 ...
 * \param[in] driver Driver handle.
 *
 * \retval sint32 The number of turns.
 */
 ...
 *
 * \param[inout] driver       Driver handle.
 * \param[in]    updatePeriod Update period.
 *
 * \retval None
 */
