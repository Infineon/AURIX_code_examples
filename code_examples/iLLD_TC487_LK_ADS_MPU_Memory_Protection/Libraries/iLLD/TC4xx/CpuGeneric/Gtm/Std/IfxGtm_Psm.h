...
/** \brief Enumeration listing the enabled/disabled state of the F2A channel streams.
 */
typedef enum
{
 ...
 *
 * \param[in] clsIndex  Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] channel   Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 * \param[in] mode Fifo Channel mode. Range: \ref IfxGtm_Psm_FifoChannelMode.
 *
 * \retval None
 */
 ...
 *
 * \param[in] clsIndex Fifo object. Range: \ref IfxGtm_Cluster.
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 *
 * \retval Ifx_GTM_CLS_PSM_FIFO_CH* Pointer to the FIFO channel SFR.
 */
 ...
 * \param[in] clsIndex Fifo object. Range: \ref IfxGtm_Cluster.
 *
 * \retval Ifx_GTM_CLS_PSM_FIFO* Pointer to the FIFO SFR.
 */
 ...
 * \param[in] clsIndex Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 * \param[in] address  End address of Fifo Channel. Range: 0x3FF.
 *
 * \retval None
 */
 ...
 * \param[in] channel Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 *
 * \retval uint32 Start address of fifo channel. Range: 0x3FF.
 */
 ...
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 *
 * \retval uint32 End address of the fifo channel. Range: 0x3FF.
 */
 ...
 * \param[in] clsIndex Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 * \param[in] address  Start address of Fifo Channel. Range: 0x3FF.
 *
 * \retval None
 */
 ...
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 *
 * \retval uint32 Size of the Fifo Channel. Range: 0x3FF.
 */
 ...
 * \param[in] clsIndex Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 * \param[in] size     Size of Fifo Channel. Range: 0x3FF.
 *
 * \retval None
 */
 ...
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 *
 * \retval uint32 Fill level of the Fifo channel. Range: 0x7FF.
 */
 ...
 * \param[in] clsIndex Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 * \param[in] upperWm  Upper Watermark level. Range: 0x3FF.
 *
 * \retval None
 */
 ...
 * \param[in] clsIndex Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 * \param[in] lowerWm  Lower Watermark level. Range: 0x3FF.
 *
 * \retval None
 */
 ...
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 *
 * \retval uint32 Upper Watermark. Range: 0x3FF.
 */
 ...
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 *
 * \retval uint32 Lower Watermark. Range: 0x3FF.
 */
 ...
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 *
 * \retval uint32 Write Pointer. Range: 0x3FF.
 */
 ...
 *
 * \param[in] clsIndex Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] channel  Fifo Channel.IfxGtm_Psm_FifoChannel. Range: \ref IfxGtm_Psm_FifoChannel.
 *
 * \retval uint32 Read Pointer. Range: 0x3FF.
 */
 ...
 * \param[in] clsIndex  Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] channel   Fifo Channel.IfxGtm_Psm_FifoChannel. Range: \ref IfxGtm_Psm_FifoChannel.
 * \param[in] interrupt Interrupt type. Range: \ref IfxGtm_Psm_FifoChannelInterrupt.
 *
 ...
 * \param[in] clsIndex Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 * \param[in] irqmode  Interrupt Mode. Range: \ref IfxGtm_Psm_InterruptMode.
 *
 * \retval None
 */
 ...
 * \param[in] clsIndex Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 * \param[in] enabled  DMA hysteresis enable.
 * \param[in] dir      Direction. Range: \ref IfxGtm_Psm_FifoChannelDmaHystDir.
 *
 * \retval None
 */
 ...
 *
 * \param[in] clsIndex f2a object. Range: \ref IfxGtm_Cluster.
 *
 * \retval Ifx_GTM_CLS_PSM_F2A* Pointer to f2a object sfr.
 */
 ...
 *
 * \param[in] clsIndex  Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] f2aStream F2a stream number. Range: \ref IfxGtm_Psm_F2aStream.
 *
 * \retval None
 */
 ...
 * \param[in] clsIndex  Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] f2aStream F2a stream number. Range: \ref IfxGtm_Psm_F2aStream.
 * \param[in] address   ARU read address. Range: 0x3FF.
 *
 * \retval None
 */
 ...
 * \param[in] clsIndex  Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] f2aStream F2a stream number. Range: \ref IfxGtm_Psm_F2aStream.
 * \param[in] mode      Transfer mode. Range: \ref IfxGtm_Psm_F2aTransferMode.
 *
 * \retval None
 */
 ...
 * \param[in] f2aStream F2a stream number. Range: \ref IfxGtm_Psm_F2aStream.
 *
 * \retval IfxGtm_Psm_F2aTransferMode Transfer mode. Range: \ref IfxGtm_Psm_F2aTransferMode.
 */
 ...
 * \param[in] clsIndex     Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] f2aStream    F2a stream number. Range: \ref IfxGtm_Psm_F2aStream.
 * \param[in] dir transfer Direction. Range: \ref IfxGtm_Psm_F2aTransferDirection.
 *
 * \retval None
 */
 ...
 * \param[in] f2aStream F2a stream number. Range: \ref IfxGtm_Psm_F2aStream.
 *
 * \retval IfxGtm_Psm_F2aTransferDirection transfer direction. Range: \ref IfxGtm_Psm_F2aTransferDirection.
 */
 ...
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 *
 * \retval volatile Ifx_SRC_SRCR* SRC pointer.
 */
 ...
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 *
 * \retval Ifx_GTM_CLS_PSM_AFD_CH* Afd channel pointer.
 */
 ...
 * \param[in] clsIndex Index of the CLS object used. Range: \ref IfxGtm_Cluster.
 * \param[in] channel  Fifo Channel. Range: \ref IfxGtm_Psm_FifoChannel.
 * \param[in] data     Data to be written. Range: 0x1FFFFFFF.
 *
 * \retval None
 */
