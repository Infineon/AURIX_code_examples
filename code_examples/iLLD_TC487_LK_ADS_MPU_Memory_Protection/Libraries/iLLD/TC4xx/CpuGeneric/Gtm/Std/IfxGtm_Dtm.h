...
/** \brief DTM CTRL2 UPD_MODE_x value for self-reset: SHUTOFF_SYNC_x is set when PSU_SHUT_OFF=1 and cleared when PSU_SHUT_OFF=0
 */
 ...
 * \param[in]    clockSource Clock source for DTM object. Range: \ref IfxGtm_Dtm_ClockSource.
 *
 * \retval None
 */
 ...
 * \param[inout] dtm          Pointer to the DTM object.
 * \param[in]    channel      Channel index. Range: \ref IfxGtm_Dtm_Ch.
 * \param[in]    deadTimePath Dead Time Path for Dtm chhannel output. Range: \ref IfxGtm_Dtm_DeadTimePath.
 *
 * \retval None
 */
 ...
 * \param[inout] dtm             Pointer to the DTM object.
 * \param[in]    channel         Channel index. Range: \ref IfxGtm_Dtm_Ch.
 * \param[in]    output1Function Output 1 function. Range: \ref IfxGtm_Dtm_Output1Function.
 *
 * \retval None
 */
 ...
 *
 * \param[inout] dtm     Pointer to the DTM object.
 * \param[in]    channel DTM Channel. Range: \ref IfxGtm_Dtm_Ch.
 * \param[in]    relrise Relative rise value in ticks. Range: 0 to 0x1FFF.
 *
 * \retval None
 */
 ...
 * \param[inout] dtm     Pointer to the DTM object.
 * \param[in]    channel DTM Channel. Range: \ref IfxGtm_Dtm_Ch.
 * \param[in]    relfall Relative fall value in ticks. Range: 0 to 0x1FFF.
 *
 * \retval None
 */
 ...
 * \param[inout] dtm     Pointer to the DTM object.
 * \param[in]    channel DTM Channel. Range: \ref IfxGtm_Dtm_Ch.
 * \param[in]    input   Input source. Range: \ref IfxGtm_Dtm_ShutoffInput.
 *
 * \retval None
 */
 ...
 * \param[inout] dtm     Pointer to the DTM object.
 * \param[in]    channel DTM Channel. Range: \ref IfxGtm_Dtm_Ch.
 * \param[in]    enabled TRUE: invert the signal.
 *
 * \retval None
 */
 ...
 * \param[inout] dtm     Pointer to the DTM object.
 * \param[in]    channel DTM Channel. Range: \ref IfxGtm_Dtm_Ch.
 * \param[in]    mode    Shutoff mode. Range: 0 to 0xFF.
 *
 * \retval None
 */
 ...
 * \param[inout] dtm     Pointer to the DTM object.
 * \param[in]    channel DTM Channel. Range: \ref IfxGtm_Dtm_Ch.
 * \param[in]    level   signal level. Range: \ref IfxGtm_Dtm_SignalLevel.
 *
 * \retval None
 */
 ...
 * \param[inout] dtm     Pointer to the DTM object.
 * \param[in]    channel DTM Channel. Range: \ref IfxGtm_Dtm_Ch.
 * \param[in]    control Channel control. Range: \ref IfxGtm_Dtm_ChannelControl.
 *
 * \retval None
 */
