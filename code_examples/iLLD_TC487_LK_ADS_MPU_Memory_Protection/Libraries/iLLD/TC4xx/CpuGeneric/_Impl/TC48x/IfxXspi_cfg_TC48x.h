...
#ifndef IFXXSPI_CFG_TC48X_H
#define IFXXSPI_CFG_TC48X_H 1
...
#define IFXXSPI_XIPDATAWRITE_SUPPORT      (TRUE)

#define IFXXSPI_IS_PORT_11_AVAILABLE      (TRUE)
