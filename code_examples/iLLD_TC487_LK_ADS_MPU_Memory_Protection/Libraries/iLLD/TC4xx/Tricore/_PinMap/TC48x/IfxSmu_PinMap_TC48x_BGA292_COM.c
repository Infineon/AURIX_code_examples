/**
 * \file IfxSmu_PinMap_TC48x_BGA292_COM.c
 * \brief SMU  details
 *
...
#include "IfxSmu_PinMap_TC48x_BGA292_COM.h"

/******************************************************************************/
/*-----------------------Exported Variables/Constants-------------------------*/
/******************************************************************************/
IfxSmu_Ext_In IfxSmu_EXT_EMERGENCYSTOP_A_REQ_P33_8_IN = {&MODULE_SMU, {&MODULE_P33, 8}, Ifx_RxSel_a};
...
/*-----------------------Exported Variables/Constants-------------------------*/
/******************************************************************************/
IFX_CONST IfxSmu_Ext_In* IfxSmu_Ext_In_pinTable[IFXSMU_PINMAP_NUM_MODULES][IFXSMU_PINMAP_EXT_IN_NUM_ITEMS] =     {
	{
			&IfxSmu_EXT_EMERGENCYSTOP_A_REQ_P33_8_IN,
	},
};
