/**
 * \file IfxPms_PinMap_TC48x_BGA292_COM.c
 * \brief PMS  details
 *
...
#include "IfxPms_PinMap_TC48x_BGA292_COM.h"
...
IfxPms_Esr_Out IfxPms_ESR2PORST_P33_11_OUT = {&MODULE_PMS, {&MODULE_P33, 11}, IfxPort_OutputIdx_general};
...
IFX_CONST IfxPms_Esr_Out* IfxPms_Esr_Out_pinTable[IFXPMS_PINMAP_NUM_MODULES][IFXPMS_PINMAP_ESR_OUT_NUM_ITEMS] =     {
	{
			&IfxPms_ESR2PORST_P33_11_OUT,
	},
};
