/**
 * \file IfxCanxl_PinMap_TC48x_BGA292_STD.c
 * \brief CANXL  details
 *
...
#include "IfxCanxl_PinMap_TC48x_BGA292_STD.h"
...
IfxCanxl_Rxd_In  IfxCanxl_RXD00D_P11_9_IN = {&MODULE_CANXL0, (IfxCanxl_NodeId)0, {&MODULE_P11, 9}, Ifx_RxSel_d};
...
IfxCanxl_Rxd_In  IfxCanxl_RXD01B_P11_10_IN = {&MODULE_CANXL0, (IfxCanxl_NodeId)1, {&MODULE_P11, 10}, Ifx_RxSel_b};
...
IfxCanxl_Txd_Out IfxCanxl_TXD00_P11_3_OUT = {&MODULE_CANXL0, (IfxCanxl_NodeId)0, {&MODULE_P11, 3}, IfxPort_OutputIdx_alt5};
...
IfxCanxl_Txd_Out IfxCanxl_TXD01_P11_12_OUT = {&MODULE_CANXL0, (IfxCanxl_NodeId)1, {&MODULE_P11, 12}, IfxPort_OutputIdx_alt12};
