...
#ifndef IFXCPU_CFG_TC48X_H
#define IFXCPU_CFG_TC48X_H 1
 ...
 */
#define IFXCPU_NUM_MODULES            (5)

/** \brief SAFE CPU count
 */
#define IFXCPU_NUM_SAFE_MODULES       (4)
