 ...
 * \ingroup IfxLld
 * \defgroup IfxLld_Dre_Impl Implementation
 * \ingroup IfxLld_Dre
 * \defgroup IfxLld_Dre_Std Standard Driver
 * \ingroup IfxLld_Dre
 */

#ifndef IFXDRE_CFG_TC48X_H
#define IFXDRE_CFG_TC48X_H 1
