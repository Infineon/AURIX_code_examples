 ...
 *
 *
 * Version: MC_ACE_A3G_HSI_XSPI/V0.3.2.1.1
...
{
    __I  Ifx_UReg_32Bit AXIECR:1;          /**< \brief [0:0] Clear AXI Error Interrupt (rch) */
...
typedef struct _Ifx_XSPI_CTRLR0_Bits
{
    ...
    __I  Ifx_UReg_32Bit SSI_IS_MST:1;      /**< \brief [31:31] Reserved bits - read as zero (r) */
...
{
    __IO Ifx_UReg_32Bit PORTSEL:2;         /**< \brief [1:0] Port selection (rw) */
...
{
    __I  Ifx_UReg_32Bit RDMAE:1;           /**< \brief [0:0] Reserved bits - read as zero (r) */
    __I  Ifx_UReg_32Bit TDMAE:1;           /**< \brief [1:1] Reserved bits - read as zero (r) */
...
{
    __I  Ifx_UReg_32Bit DONECR:1;          /**< \brief [0:0] Clear Transfer Done Interrupt (rch) */
    __I  Ifx_UReg_32Bit :31;               /**< \brief [31:1] \internal Reserved */
...
{
    __IO Ifx_UReg_32Bit DR:32;             /**< \brief [31:0] Data Register (rwh) */
} Ifx_XSPI_DR_Bits;

/** \brief Interrupt Clear Register */
typedef struct _Ifx_XSPI_ICR_Bits
{
    __I  Ifx_UReg_32Bit ICR:1;             /**< \brief [0:0] Clear Interrupts (rch) */
    __I  Ifx_UReg_32Bit :31;               /**< \brief [31:1] \internal Reserved */
} Ifx_XSPI_ICR_Bits;
...
typedef struct _Ifx_XSPI_IMR_Bits
{
    ...
    __I  Ifx_UReg_32Bit XRXOIM:1;          /**< \brief [6:6] Reserved bits - read as zero (r) */
    ...
    __I  Ifx_UReg_32Bit SPITEM:1;          /**< \brief [10:10] Reserved bits - read as zero (r) */
...
{
    __I  Ifx_UReg_32Bit TXEIS:1;           /**< \brief [0:0] Transmit FIFO Empty Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit TXOIS:1;           /**< \brief [1:1] Transmit FIFO Overflow Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit RXUIS:1;           /**< \brief [2:2] Receive FIFO Underflow Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit RXOIS:1;           /**< \brief [3:3] Receive FIFO Overflow Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit RXFIS:1;           /**< \brief [4:4] Receive FIFO Full Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit MSTIS:1;           /**< \brief [5:5] Multi-Master Contention Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit XRXOIS:1;          /**< \brief [6:6] XIP Receive FIFO Overflow Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit TXUIS:1;           /**< \brief [7:7] Transmit FIFO Underflow Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit AXIES:1;           /**< \brief [8:8] AXI Error Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit :2;                /**< \brief [10:9] \internal Reserved */
    __I  Ifx_UReg_32Bit DONES:1;           /**< \brief [11:11] SSI Done Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit :20;               /**< \brief [31:12] \internal Reserved */
} Ifx_XSPI_ISR_Bits;
...
{
    __I  Ifx_UReg_32Bit MSTICR:1;          /**< \brief [0:0] Clear Multi-Master Contention Interrupt (rch) */
    __I  Ifx_UReg_32Bit :31;               /**< \brief [31:1] \internal Reserved */
...
{
    __I  Ifx_UReg_32Bit TXEIR:1;           /**< \brief [0:0] Transmit FIFO Empty Raw Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit TXOIR:1;           /**< \brief [1:1] Transmit FIFO Overflow Raw Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit RXUIR:1;           /**< \brief [2:2] Receive FIFO Underflow Raw Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit RXOIR:1;           /**< \brief [3:3] Receive FIFO Overflow Raw Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit RXFIR:1;           /**< \brief [4:4] Receive FIFO Full Raw Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit MSTIR:1;           /**< \brief [5:5] Multi-Master Contention Raw Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit XRXOIR:1;          /**< \brief [6:6] XIP Receive FIFO Overflow Raw Interrupt Status (rh) */
    __I  Ifx_UReg_32Bit TXUIR:1;           /**< \brief [7:7] Transmit FIFO Underflow Interrupt Raw Status (rh) */
    __I  Ifx_UReg_32Bit AXIER:1;           /**< \brief [8:8] AXI Error Interrupt Raw Status (rh) */
    __I  Ifx_UReg_32Bit :2;                /**< \brief [10:9] \internal Reserved */
    __I  Ifx_UReg_32Bit DONER:1;           /**< \brief [11:11] SSI Done Interrupt Raw Status (rh) */
    __I  Ifx_UReg_32Bit :20;               /**< \brief [31:12] \internal Reserved */
} Ifx_XSPI_RISR_Bits;
...
{
    __I  Ifx_UReg_32Bit RXTFL:5;           /**< \brief [4:0] Receive FIFO Level (rh) */
...
{
    __I  Ifx_UReg_32Bit RXOICR:1;          /**< \brief [0:0] Clear Receive FIFO Overflow Interrupt (rch) */
    __I  Ifx_UReg_32Bit :31;               /**< \brief [31:1] \internal Reserved */
...
{
    __I  Ifx_UReg_32Bit RXUICR:1;          /**< \brief [0:0] Clear Receive FIFO Underflow Interrupt (rch) */
    __I  Ifx_UReg_32Bit :31;               /**< \brief [31:1] \internal Reserved */
...
typedef struct _Ifx_XSPI_SAFETYCR_Bits
{
    ...
    __IO Ifx_UReg_32Bit FSM_PROT_EN:1;     /**< \brief [2:2] FSM One-hot encoding check Enable (rw) */
    __IO Ifx_UReg_32Bit EI_EN:1;           /**< \brief [3:3] Error Insertion Enable (rwh) */
    __IO Ifx_UReg_32Bit EI_TYPE:2;         /**< \brief [5:4] Error Insertion Type (rw) */
    __I  Ifx_UReg_32Bit :2;                /**< \brief [7:6] \internal Reserved */
    __IO Ifx_UReg_32Bit EI_SEL:6;          /**< \brief [13:8] Error Injection Selection (rw) */
    __I  Ifx_UReg_32Bit :2;                /**< \brief [15:14] \internal Reserved */
    __IO Ifx_UReg_32Bit LRD_EI_TYPE:1;     /**< \brief [16:16] Logic/Register Duplication Error type (rw) */
    __I  Ifx_UReg_32Bit ECC_EI_TYPE:1;     /**< \brief [17:17] Reserved bits - read as zero (r) */
    __IO Ifx_UReg_32Bit AXI_EI_SEL:1;      /**< \brief [18:18] Error injection selection for AXI data path (rw) */
    __I  Ifx_UReg_32Bit :13;               /**< \brief [31:19] \internal Reserved */
...
{
    __O  Ifx_UReg_32Bit FSMPEC:1;          /**< \brief [0:0] FSM One-hot Error status clear register (w) */
    ...
    __O  Ifx_UReg_32Bit AXICEC:1;          /**< \brief [11:11] AXI master Interface ECC correctable error status clear register (w) */
...
{
    __I  Ifx_UReg_32Bit FSMPES:1;          /**< \brief [0:0] FSM One-hot Error status (r) */
...
typedef struct _Ifx_XSPI_SPI_CTRLR0_Bits
{
    ...
    __IO Ifx_UReg_32Bit INST_L:2;          /**< \brief [9:8] Enhanced SPI mode instruction length in bits (rw) */
    __I  Ifx_UReg_32Bit :1;                /**< \brief [10:10] \internal Reserved */
    __IO Ifx_UReg_32Bit WAIT_CYCLES:5;     /**< \brief [15:11] Wait cycles in SPI mode (rw) */
    ...
    __IO Ifx_UReg_32Bit RXDS_VL_EN:1;      /**< \brief [23:23] RXDS variable latency enable bit (rw) */
    __IO Ifx_UReg_32Bit SPI_DM_EN:1;       /**< \brief [24:24] SPI data mask enable bit (rw) */
    __IO Ifx_UReg_32Bit SPI_RXDS_SIG_EN:1;    /**< \brief [25:25] Enable rxds signaling during address and command phase of Hyperbus transfer (rw) */
    __IO Ifx_UReg_32Bit XIP_MBL:2;         /**< \brief [27:26] XIP Mode bits length (rw) */
    __I  Ifx_UReg_32Bit :1;                /**< \brief [28:28] \internal Reserved */
    __I  Ifx_UReg_32Bit XIP_PREFETCH_EN:1;    /**< \brief [29:29] Reserved bits - read as zero (r) */
...
/** \brief SPI Control 1 register */
typedef struct _Ifx_XSPI_SPI_CTRLR1_Bits
{
    __I  Ifx_UReg_32Bit DYN_WS:3;          /**< \brief [2:0] Reserved bits - read as zero (r) */
    __I  Ifx_UReg_32Bit :5;                /**< \brief [7:3] \internal Reserved */
    __I  Ifx_UReg_32Bit MAX_WS:4;          /**< \brief [11:8] Reserved bits - read as zero (r) */
    __I  Ifx_UReg_32Bit :4;                /**< \brief [15:12] \internal Reserved */
    __IO Ifx_UReg_32Bit CS_MIN_HIGH:4;     /**< \brief [19:16] Chip-Select Minimum HIGH period (rw) */
    __I  Ifx_UReg_32Bit :12;               /**< \brief [31:20] \internal Reserved */
} Ifx_XSPI_SPI_CTRLR1_Bits;

/** \brief Status Register */
typedef struct _Ifx_XSPI_SR_Bits
{
    __I  Ifx_UReg_32Bit BUSY:1;            /**< \brief [0:0] SSI Busy Flag (rh) */
    __I  Ifx_UReg_32Bit TFNF:1;            /**< \brief [1:1] Transmit FIFO Not Full (rh) */
    __I  Ifx_UReg_32Bit TFE:1;             /**< \brief [2:2] Transmit FIFO Empty (rh) */
    __I  Ifx_UReg_32Bit RFNE:1;            /**< \brief [3:3] Receive FIFO Not Empty (rh) */
    __I  Ifx_UReg_32Bit RFF:1;             /**< \brief [4:4] Receive FIFO Full (rh) */
    __I  Ifx_UReg_32Bit TXE:1;             /**< \brief [5:5] Transmission Error (rh) */
    __I  Ifx_UReg_32Bit DCOL:1;            /**< \brief [6:6] Data Collision Error (rh) */
    __I  Ifx_UReg_32Bit :8;                /**< \brief [14:7] \internal Reserved */
    __I  Ifx_UReg_32Bit CMPLTD_DF:17;      /**< \brief [31:15] Completed Data frames (rh) */
} Ifx_XSPI_SR_Bits;
...
{
    __IO Ifx_UReg_32Bit SSIC_EN:1;         /**< \brief [0:0] xSPI Enable (rwh) */
    __I  Ifx_UReg_32Bit :31;               /**< \brief [31:1] \internal Reserved */
...
/** \brief Transmit FIFO Error Interrupt Clear Register */
typedef struct _Ifx_XSPI_TXEICR_Bits
{
    __I  Ifx_UReg_32Bit TXEICR:1;          /**< \brief [0:0] Clear Transmit FIFO Overflow/Underflow Interrupt (rch) */
    __I  Ifx_UReg_32Bit :31;               /**< \brief [31:1] \internal Reserved */
...
{
    __I  Ifx_UReg_32Bit TXTFL:5;           /**< \brief [4:0] Transmit FIFO Level (rh) */
    __I  Ifx_UReg_32Bit :27;               /**< \brief [31:5] \internal Reserved */
} Ifx_XSPI_TXFLR_Bits;
...
typedef union
{
    __IO Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_XSPI_SPI_CTRLR1_Bits B;            /**< \brief Bitfield access */
} Ifx_XSPI_SPI_CTRLR1;
...
typedef volatile struct _Ifx_XSPI
{
       ...
       __I  Ifx_XSPI_TXEICR                     TXEICR;                 /**< \brief 238, Transmit FIFO Error Interrupt Clear Register*/
       ...
       __IO Ifx_XSPI_SPI_CTRLR1                 SPI_CTRLR1;             /**< \brief 318, SPI Control 1 register*/
       __I  Ifx_UReg_8Bit                       reserved_31C[4];        /**< \brief 31C, \internal Reserved */
