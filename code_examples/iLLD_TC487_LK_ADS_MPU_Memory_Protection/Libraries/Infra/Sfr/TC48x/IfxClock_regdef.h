...
/** \brief Audio-PLL configuration register 0 */
typedef struct _Ifx_CLOCK_APLLCON0_Bits
{
    __IO Ifx_UReg_32Bit PLLPWR:1;          /**< \brief [0:0] Audio-PLL power mode (rw) */
...
} Ifx_CLOCK_APLLCON0_Bits;

/** \brief Audio-PLL configuration register 1 */
typedef struct _Ifx_CLOCK_APLLCON1_Bits
{
    __IO Ifx_UReg_32Bit KDIV:4;            /**< \brief [3:0] K-divider value (rw) */
    __I  Ifx_UReg_32Bit :28;               /**< \brief [31:4] \internal Reserved */
} Ifx_CLOCK_APLLCON1_Bits;

/** \brief Audio-PLL configuration register 2 */
typedef struct _Ifx_CLOCK_APLLCON2_Bits
{
    __IO Ifx_UReg_32Bit NDIV_FRAC:12;      /**< \brief [11:0] Audio-PLL N-Divider Fractional value (rw) */
    __IO Ifx_UReg_32Bit NDIV:7;            /**< \brief [18:12] Audio-PLL N-Divider Integer value (rw) */
    __I  Ifx_UReg_32Bit :13;               /**< \brief [31:19] \internal Reserved */
} Ifx_CLOCK_APLLCON2_Bits;

/** \brief Audio-PLL status register */
typedef struct _Ifx_CLOCK_APLLSTAT_Bits
{
    __I  Ifx_UReg_32Bit PWRSTAT:1;         /**< \brief [0:0] Audio-PLL power mode status (rh) */
    __I  Ifx_UReg_32Bit PLLLOCK:1;         /**< \brief [1:1] Audio-PLL lock status (rh) */
    __I  Ifx_UReg_32Bit :29;               /**< \brief [30:2] \internal Reserved */
    __I  Ifx_UReg_32Bit LCK:1;             /**< \brief [31:31] Register lock status (rh) */
} Ifx_CLOCK_APLLSTAT_Bits;
...
typedef struct _Ifx_CLOCK_CCUCON_Bits
{
    ...
    __IO Ifx_UReg_32Bit CLKSELA:1;         /**< \brief [24:24] Selection for the Audio clock sources (rw) */
...
typedef struct _Ifx_CLOCK_CCUMON_Bits
{
    ...
    __IO Ifx_UReg_32Bit APLLMONEN:1;       /**< \brief [14:14] APLL clock alive monitor enable (rw) */
    __IO Ifx_UReg_32Bit APLLKDVMONEN:1;    /**< \brief [15:15] APLL K-divider monitor enable (rw) */
    ...
    __IO Ifx_UReg_32Bit APLLMONTST:1;      /**< \brief [30:30] APLL clock alive monitor test (rw) */
    __IO Ifx_UReg_32Bit APLLKDVMONTST:1;    /**< \brief [31:31] APLL K-divider monitor test (rw) */
...
typedef struct _Ifx_CLOCK_CCUSTAT_Bits
{
    ...
    __I  Ifx_UReg_32Bit :7;                /**< \brief [23:17] \internal Reserved */
    __I  Ifx_UReg_32Bit CLKSELA:1;         /**< \brief [24:24] Selection for Audio PLL clock sources (rh) */
...
typedef struct _Ifx_CLOCK_MONSTAT_Bits
{
    ...
    __I  Ifx_UReg_32Bit RES3:1;            /**< \brief [3:3] RES3 (rh) */
    __I  Ifx_UReg_32Bit RES4:1;            /**< \brief [4:4] RES4 (rh) */
    __I  Ifx_UReg_32Bit RES5:1;            /**< \brief [5:5] RES5 (rh) */
    ...
    __I  Ifx_UReg_32Bit RES11:1;           /**< \brief [11:11] RES11 (rh) */
    __I  Ifx_UReg_32Bit RES12:1;           /**< \brief [12:12] RES12 (rh) */
    __I  Ifx_UReg_32Bit RES13:1;           /**< \brief [13:13] RES13 (rh) */
...
typedef struct _Ifx_CLOCK_OSCCON_Bits
{
    ...
    __IO Ifx_UReg_32Bit APREN:1;           /**< \brief [4:4] Amplitude calibration enable (rw) */
    ...
    __IO Ifx_UReg_32Bit AMPCALCTL:1;       /**< \brief [31:31] Amplitude calibration control (rw) */
...
typedef struct _Ifx_CLOCK_OSCMON1_Bits
{
    ...
    __I  Ifx_UReg_32Bit :2;                /**< \brief [15:14] \internal Reserved */
    __IO Ifx_UReg_32Bit AMONEN:1;          /**< \brief [16:16] Audio-PLL crystal oscillator monitor enable (rw) */
    __I  Ifx_UReg_32Bit :3;                /**< \brief [19:17] \internal Reserved */
    __IO Ifx_UReg_32Bit AMONTST:2;         /**< \brief [21:20] Audio-PLL crystal oscillator monitor test (rw) */
...
typedef struct _Ifx_CLOCK_OSCSTAT_Bits
{
    ...
    __I  Ifx_UReg_32Bit AOWDS:2;           /**< \brief [25:24] Oscillator watchdog status for Audio-PLL (rh) */
    __I  Ifx_UReg_32Bit :6;                /**< \brief [31:26] \internal Reserved */
...
typedef union
{
    __IO Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_CLOCK_APLLCON0_Bits B;             /**< \brief Bitfield access */
} Ifx_CLOCK_APLLCON0;
...
typedef union
{
    __IO Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_CLOCK_APLLCON1_Bits B;             /**< \brief Bitfield access */
} Ifx_CLOCK_APLLCON1;
...
typedef union
{
    __IO Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_CLOCK_APLLCON2_Bits B;             /**< \brief Bitfield access */
} Ifx_CLOCK_APLLCON2;
...
typedef union
{
    ...
    Ifx_CLOCK_APLLSTAT_Bits B;             /**< \brief Bitfield access */
} Ifx_CLOCK_APLLSTAT;
...
/******************************************************************************/
/******************************************************************************/
/** \addtogroup IfxSfr_Clock_ACCENAPLL_struct
 * \{  */
/******************************************************************************/
/** \name Object L2
 * \{  */
/** \brief ACCENAPLL object */
typedef volatile struct _Ifx_CLOCK_ACCENAPLL
{
       __IO Ifx_CLOCK_ACCEN_WRA                 WRA;                    /**< \brief 0, Write access enable register A*/
       __IO Ifx_CLOCK_ACCEN_WRB_FPI             WRB;                    /**< \brief 4, Write access enable register B*/
       __IO Ifx_CLOCK_ACCEN_RDA                 RDA;                    /**< \brief 8, Read access enable register A*/
...
typedef volatile struct _Ifx_CLOCK
{
       ...
       __IO Ifx_CLOCK_ACCENAPLL                 ACCENAPLL;              /**< \brief 80, Audio PLL APU for real-time updates to NDIV.FRACT*/
       ...
       __I  Ifx_UReg_8Bit                       reserved_51C[496];      /**< \brief 51C, \internal Reserved */
       __IO Ifx_CLOCK_APLLCON0                  APLLCON0;               /**< \brief 70C, Audio-PLL configuration register 0*/
       __IO Ifx_CLOCK_APLLCON1                  APLLCON1;               /**< \brief 710, Audio-PLL configuration register 1*/
       __IO Ifx_CLOCK_APLLCON2                  APLLCON2;               /**< \brief 714, Audio-PLL configuration register 2*/
       __I  Ifx_UReg_8Bit                       reserved_718[4];        /**< \brief 718, \internal Reserved */
       __I  Ifx_CLOCK_APLLSTAT                  APLLSTAT;               /**< \brief 71C, Audio-PLL status register*/
       __I  Ifx_UReg_8Bit                       reserved_720[14560];    /**< \brief 720, \internal Reserved */
} Ifx_CLOCK;
