...
/* LEDs */
#define LED1                        LED_1                                   /* LED P33.0                            */
#define LED2                        LED_2                                   /* LED P33.1                            */
...
boolean toggleLEDsShell(pchar args, void *data, IfxStdIf_DPipe *io)
{
    switch(args[0])
    {
        case '0': /* Turn on all LEDs */
            IfxPort_setPinState(LED1.port, LED_1.pinIndex, IfxPort_State_low);
            IfxPort_setPinState(LED2.port, LED_2.pinIndex, IfxPort_State_low);
            IfxStdIf_DPipe_print(io, "Turned on all LEDs!" ENDLINE ENDLINE);
            break;
        case '1': /* Toggle LED1 */
            IfxPort_setPinState(LED1.port, LED_1.pinIndex, IfxPort_State_toggled);
            IfxStdIf_DPipe_print(io, "Toggled LED1!" ENDLINE ENDLINE);
            break;
        case '2': /* Toggle LED2 */
            IfxPort_setPinState(LED2.port, LED_2.pinIndex, IfxPort_State_toggled);
            IfxStdIf_DPipe_print(io, "Toggled LED2!" ENDLINE ENDLINE);
            break;
        default: /* Turn off all LEDs */
            IfxPort_setPinState(LED1.port, LED_1.pinIndex, IfxPort_State_high);
            IfxPort_setPinState(LED2.port, LED_2.pinIndex, IfxPort_State_high);
...
void initLEDs(void)
{
    ...
    IfxPort_setPinMode(LED1.port, LED_1.pinIndex, IfxPort_Mode_outputPushPullGeneral);
    IfxPort_setPinMode(LED2.port, LED_2.pinIndex, IfxPort_Mode_outputPushPullGeneral);
