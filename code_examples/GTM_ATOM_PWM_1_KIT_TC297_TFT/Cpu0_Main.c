 ...
 *
 * \name GTM_ATOM_PWM_1_KIT_TC297_TFT
 * \version V1.0.0
 * \board APPLICATION KIT TC2X7 V1.1, KIT_AURIX_TC297_TFT_BC-Step, TC29xTA/TX_BC-step
 * \keywords AURIX, GTM, GTM_ATOM_PWM_1, PWM
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_GTM_ATOM_PWM_1_KIT_TC297_TFT-TR-v01_00_00-EN.pdf
...
int core0_main(void)
{
    ...
    initGtmATomPwm();   /* Call the initialization function */
