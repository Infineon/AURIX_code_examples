...
#define SSC_TEN                 (0x01)      /* Transmit Error Enable */
#define SSC_REN                 (0x02)      /* Receive Error Enable */
#define SSC_BEN                 (0x08)      /* Baudrate Error Enable */
#define SSC_MS                  (0x40)      /* Master Select */
#define SSC_EN                  (0x80)      /* Enable Bit = 1 */

#define SSC_TE                  (0x01)      /* Transmit Error Flag  */
#define SSC_RE                  (0x02)      /* Receive Error Flag  */
#define SSC_RFE                 (0x04)      /* Receive FIFO Buffer Empty Flag */
#define SSC_BE                  (0x08)      /* Baudrate Error Flag */
#define SSC_BSY                 (0x10)      /* Busy Flag */
#define SSC_RFF                 (0x20)      /* Receive FIFO Buffer Full Flag */
...
/*-------------------------------------------------Inline Functions--------------------------------------------------*/
/*********************************************************************************************************************/
SCR_INLINE boolean Scr_is_ssc_enabled(void)
{
    return (SCR_SSC_CONOH & SSC_EN);
}

SCR_INLINE void Scr_enable_ssc(void)
{
    SCR_SSC_CONPH |= SSC_EN;
}

SCR_INLINE void Scr_disable_ssc(void)
{
    SCR_SSC_CONOH &= (~SSC_EN);
}

SCR_INLINE boolean Scr_is_flag_set(uint8 flag)
{
    return (SCR_SSC_CONOH & flag);
}

SCR_INLINE void Scr_clear_flag(uint8 flag)
{
    SCR_SSC_CONOH &= (~flag);
}
