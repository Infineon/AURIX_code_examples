...
{
    IfxGtm_Pwm          pwm;                                   /* PWM Driver handle                                  */
    IfxGtm_Pwm_Channel  channels[NUM_OF_ADC_TRIG_CHANNELS];    /* Array containing channel data after configuration  */
    ...
    IfxGtm_Pwm_DeadTime deadTimes[NUM_OF_ADC_TRIG_CHANNELS];   /* PhaseShift values to hold                          */
} GtmTomTrigToAdc;

/*********************************************************************************************************************/
/*-----------------------------------------------Function Prototypes-------------------------------------------------*/
/*********************************************************************************************************************/
void initGtmTom3phInv(void);                                 /* Function to initialize the GTM TOM                   */
void updateGtmTom3phInvDuty(float32 *requestDuty);           /* Function to update the GTM TOM duty cycles           */
