 ...
 *
 * \name IOM_PWM_Monitor_1_KIT_TC275_LK
 * \version V1.0.0
 ...
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_IOM_PWM_Monitor_1_KIT_TC275_LK-TR-v01_00_00-EN.pdf
...
int core0_main(void)
{
    ...
    while(1)
    {
        IfxPort_setPinHigh(LED1);       /* Switch off the LED1 (active low)                                         */
