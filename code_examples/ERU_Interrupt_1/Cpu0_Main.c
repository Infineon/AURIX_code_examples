 ...
 * IN THE SOFTWARE.
 *********************************************************************************************************************/
 /*\name External interrupt generation
 * \brief The ERU is used to generate an interrupt on each rising and falling edge at an input pin.
 ...
 *              will be toggled.
 *
 * \identifier ERU_Interrupt_1
 * \version V1.0.0
 * \board APPLICATION KIT TC2X7 V1.1, KIT_AURIX_TC297_TFT_BC-Step, TC29xTA/TX_BC-step
 * \keywords AURIX, ERU, external request, interrupt
 * \documents Infineon-AURIX_ERU_Interrupt_1-TR-v01_00_00-EN.pdf
 * \date 2019-09-10
 *********************************************************************************************************************/
#include "Ifx_Types.h"
#include "IfxCpu.h"
