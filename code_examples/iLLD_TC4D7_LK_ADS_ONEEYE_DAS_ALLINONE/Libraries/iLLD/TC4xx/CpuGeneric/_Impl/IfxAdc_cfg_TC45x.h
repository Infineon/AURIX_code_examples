...
#ifndef IFXADC_CFG_TC45X_H
#define IFXADC_CFG_TC45X_H 1
 ...
 */
#define IFXADC_NUM_TMADC             (1)

#define IFXADC_NUM_SAR_CORES         (2)

/** \brief Number of TMADC Channels
 */
#define IFXADC_NUM_TMADC_CHANNELS    (8)
 ...
 */
#define IFXADC_IS_CDSP_AVAILABLE   (FALSE)
...
typedef enum
{
    ...
    IfxAdc_TmadcChannel_count = 8  /**< \brief Count */
} IfxAdc_TmadcChannel;
...
typedef enum
{
    ...
    IfxAdc_TmadcModule_count = 1   /**< \brief Count */
} IfxAdc_TmadcModule;

#endif /* IFXADC_CFG_TC45X_H */
