...
#ifndef IFXCLOCK_CFG_TC45X_H
#define IFXCLOCK_CFG_TC45X_H 1
 ...
 */
#define IFXCLOCK_IS_EXTCLK_HSCT_AVAILABLE              (FALSE)
 ...
 */
#define IFXCLOCK_IS_EXTCLK_EGTM_AVAILABLE              (FALSE)

/** \brief Availability of External Clock MCANH
 */
#define IFXCLOCK_IS_EXTCLK_MCANH_AVAILABLE             (FALSE)

/** \brief Availability of External Clock RCB
 */
#define IFXCLOCK_IS_EXTCLK_RCB_AVAILABLE               (TRUE)

/** \brief Availability ofExternal Clock MT0
 */
#define IFXCLOCK_IS_EXTCLK_MT0_AVAILABLE               (FALSE)

/** \brief Availability of External Clock Eray
 */
#define IFXCLOCK_IS_EXTCLK_ERAY_AVAILABLE              (FALSE)

/** \brief Availability of External Clock Xspi
 */
#define IFXCLOCK_IS_EXTCLK_XSPI_AVAILABLE              (FALSE)
...
#if (IFX_CFG_CLOCK_PERPLL3_FREQUENCY == (400000000))
#define IFXCLOCK_CFG_PERPLL3_FREQ 400MHZ
#elif (IFX_CFG_CLOCK_PERPLL3_FREQUENCY == (200000000))
...
#error "Supported PLL3 frequencies are 400MHz and 200MHz."
#endif
...
/************** Fpll1 = 160MHz, Fpll2 = 200MHz, Fpll3 = 400MHz *****************/

#ifndef IFXCLOCK_CFG_PER_PLL_20MHZ_160MHZ_200MHZ_400MHZ
/** \brief Macro for Initial Pll step, for profile with 20MHz Crystal and 160/200MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_PER_PLL_20MHZ_160MHZ_200MHZ_400MHZ                                                                                              \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2Predivider, uint8 k3Divider, uint8 k3Predivider, uint8 k4Divider, uint8 k4Predivider}*/ \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(40 - 1), (IfxClock_K2divider)(5 - 1), (IfxClock_K2PreDivider)0, (IfxClock_K3divider)(2 - 1), (IfxClock_K3PreDivider)10, (IfxClock_K4divider)(2 - 1), (IfxClock_K4PreDivider)0}
#endif /*#ifndef IFXCLOCK_CFG_PER_PLL_20MHZ_160MHZ_400MHZ */
...
#ifndef IFXCLOCK_CFG_PER_PLL_25MHZ_160MHZ_200MHZ_400MHZ
/** \brief Macro for Initial Pll step, for profile with 25MHz Crystal and 160/200MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_PER_PLL_25MHZ_160MHZ_200MHZ_400MHZ                                                                                              \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2Predivider, uint8 k3Divider, uint8 k3Predivider, uint8 k4Divider, uint8 k4Predivider}*/ \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(32 - 1), (IfxClock_K2divider)(5 - 1), (IfxClock_K2PreDivider)0, (IfxClock_K3divider)(2 - 1), (IfxClock_K3PreDivider)10, (IfxClock_K4divider)(2 - 1), (IfxClock_K4PreDivider)0}
#endif /*#ifndef IFXCLOCK_CFG_PER_PLL_25MHZ_160MHZ_400MHZ */
...
#ifndef IFXCLOCK_CFG_PER_PLL_10MHZ_160MHZ_200MHZ_400MHZ
/** \brief Macro for Initial Pll step, for profile with 10MHz Crystal and 160/200MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_PER_PLL_10MHZ_160MHZ_200MHZ_400MHZ                                                                                              \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2Predivider, uint8 k3Divider, uint8 k3Predivider, uint8 k4Divider, uint8 k4Predivider}*/ \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(80 - 1), (IfxClock_K2divider)(5 - 1),(IfxClock_K2PreDivider)0, (IfxClock_K3divider)(2 - 1), (IfxClock_K3PreDivider)10, (IfxClock_K4divider)(2 - 1), (IfxClock_K4PreDivider)0}
#endif /*#ifndef IFXCLOCK_CFG_PER_PLL_10MHZ_160MHZ_400MHZ */
...
/************** SYSCCUCON1 : RCBDIV  (Output : fRCB)**************/
/* Target = 200 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_RCBDIV_400MHZ
#define IFXCLOCK_CFG_RCBDIV_400MHZ    (2)
#endif /*#ifndef IFXCLOCK_CFG_RCBDIV_400MHZ */
...
/************** PERCCUCON1 : LETHPERON  (Output : fLETH)**************/
/* Target = 100 MHz AND Source = Fsource2 */
#ifndef IFXCLOCK_CFG_LETHPERON_160MHZ_200MHZ
#define IFXCLOCK_CFG_LETHPERON_160MHZ_200MHZ    (2)
#endif /*#ifndef IFXCLOCK_CFG_LETHPERON_160MHZ_200MHZ */
...
#define IFXCLOCK_CFG_SYSCCUCON1_MASK \
    (uint32)( \
        (IFX_CLOCK_SYSCCUCON1_RCBDIV_MSK << IFX_CLOCK_SYSCCUCON1_RCBDIV_OFF) | \
...
#define IFXCLOCK_CFG_SYSCCUCON1_BASIC_(pll0Freq, pll1Freq, pll2Freq) \
    (uint32)( \
		(IFXCLOCK_CFG_RCBDIV_##pll0Freq << IFX_CLOCK_SYSCCUCON1_RCBDIV_OFF) | \
