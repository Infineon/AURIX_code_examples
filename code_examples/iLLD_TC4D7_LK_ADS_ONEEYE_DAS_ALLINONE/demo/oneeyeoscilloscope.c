...
void OneEyeOscilloscope_init(float32 samplePeriodMs)
{
    ...
    Ifx_Oe_Osci_addSignal(&g_osciDas, "Signal A (V)", Ifx_Oe_Osci_DataType_Float32, &g_signalGenerator.output.signalA, 0);
