...
Each MCMCAN module consists of M_CAN as CAN nodes (in case of AURIX&trade; TC33x device, 4 nodes) which are CAN FD capable. Each CAN node communicates over two pins (TXD and RXD). Additionally, there is an internal Loop-Back Mode functionality available for test purposes.
...
<img src="./Images/TC334_Lite_Kit.png" width="400" />  
...
<img src="./Images/TC334_Lite_Kit_Run_and_Test.png" width="400" />  
