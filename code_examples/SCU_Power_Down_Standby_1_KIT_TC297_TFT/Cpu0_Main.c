 ...
 *              program.
 *
 * \name SCU_Power_Down_Standby_1_KIT_TC297_TFT
 * \version V1.0.1
 * \board APPLICATION KIT TC2X7 V1.1, KIT_AURIX_TC297_TFT_BC-Step, TC29xTA/TX_B-Step
 * \keywords AURIX, SCU, SCU_Power_Down_Standby_1, power down, power modes, standby
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_SCU_Power_Down_Standby_1_KIT_TC297_TFT-TR-v01_00_01-EN.pdf
